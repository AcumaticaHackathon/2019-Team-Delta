...
namespace AcumaticaRequest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomLongField : CustomField,  IEquatable<CustomLongField>
    {
        /// <summary>
        ...
        public CustomLongField(long? value = default(long?), string type = "CustomLongField") : base(type)
        {
            this.Value = value;
        }
