...
namespace AcumaticaRequest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomDateTimeField : CustomField,  IEquatable<CustomDateTimeField>
    {
        /// <summary>
        ...
        public CustomDateTimeField(DateTime? value = default(DateTime?), string type = "CustomDateTimeField") : base(type)
        {
            this.Value = value;
        }
