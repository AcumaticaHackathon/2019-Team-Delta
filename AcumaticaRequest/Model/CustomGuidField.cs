...
namespace AcumaticaRequest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomGuidField : CustomField,  IEquatable<CustomGuidField>
    {
        /// <summary>
        ...
        public CustomGuidField(Guid? value = default(Guid?), string type = "CustomGuidField") : base(type)
        {
            this.Value = value;
        }
