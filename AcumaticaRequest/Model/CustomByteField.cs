...
namespace AcumaticaRequest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomByteField : CustomField,  IEquatable<CustomByteField>
    {
        /// <summary>
        ...
        public CustomByteField(int? value = default(int?), string type = "CustomByteField") : base(type)
        {
            this.Value = value;
        }
