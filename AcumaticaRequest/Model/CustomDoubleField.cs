...
namespace AcumaticaRequest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomDoubleField : CustomField,  IEquatable<CustomDoubleField>
    {
        /// <summary>
        ...
        public CustomDoubleField(double? value = default(double?), string type = "CustomDoubleField") : base(type)
        {
            this.Value = value;
        }
