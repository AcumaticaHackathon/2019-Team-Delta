...
namespace AcumaticaRequest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomIntField : CustomField,  IEquatable<CustomIntField>
    {
        /// <summary>
        ...
        public CustomIntField(int? value = default(int?), string type = "CustomIntField") : base(type)
        {
            this.Value = value;
        }
