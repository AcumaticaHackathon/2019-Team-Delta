...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.KitAssemblyEntry" PrimaryView="Document">
        <CallbackCommands>
                    ...
                    <px:PXGrid runat="server" ID="serialNumbersGrid" DataSourceID="ds" BorderStyle="None" Width="100%" SkinID="DetailsInTab"> 
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="MasterSplits" DataKeyNames="DocType,RefNbr,LineNbr,SplitLineNbr">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="SubItemID" DisplayFormat="&gt;AA-A-&gt;AA" Width="63px" />
                                    <px:PXGridColumn DataField="LocationID" DisplayFormat="&gt;CCCCCC-CCCC" Width="81px" />
                                    <px:PXGridColumn DataField="LotSerialNbr" Width="198px" />
