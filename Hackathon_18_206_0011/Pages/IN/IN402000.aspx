...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds"
        ...
        <Template>
            ...
            <px:PXNumberEdit ID="edQtyPOFixedFSSrvOrdPrepared" runat="server" DataField="QtyPOFixedFSSrvOrdPrepared" Enabled="False" />
            <px:PXNumberEdit ID="edQtyPOFixedFSSrvOrd" runat="server" DataField="QtyPOFixedFSSrvOrd" Enabled="False" />
            <px:PXNumberEdit ID="edQtyPOFixedFSSrvOrdReceipts" runat="server" DataField="QtyPOFixedFSSrvOrdReceipts" Enabled="False" />
            ...
            <px:PXNumberEdit ID="edQtyFSSrvOrdPrepared" runat="server" DataField="QtyFSSrvOrdPrepared" Enabled="False" />
            <px:PXCheckBox ID="chkInclQtyFSSrvOrdPrepared" runat="server" Enabled="False" DataField="InclQtyFSSrvOrdPrepared" FalseValue="False" TrueValue="True" />
            <px:PXLayoutRule runat="server" />

            <px:PXLayoutRule runat="server" Merge="True" />

            <px:PXNumberEdit ID="edQtyFSSrvOrdBooked" runat="server" DataField="QtyFSSrvOrdBooked" Enabled="False" />
            <px:PXCheckBox ID="chkInclQtyFSSrvOrdBooked" runat="server" Enabled="False" DataField="InclQtyFSSrvOrdBooked" FalseValue="False" TrueValue="True" />
            <px:PXLayoutRule runat="server" />


            <px:PXLayoutRule runat="server" Merge="True" />

            <px:PXNumberEdit ID="edQtyFSSrvOrdAllocated" runat="server" DataField="QtyFSSrvOrdAllocated" Enabled="False" />
            <px:PXCheckBox ID="chkInclQtyFSSrvOrdAllocated" runat="server" Enabled="False" DataField="InclQtyFSSrvOrdAllocated" FalseValue="False" TrueValue="True" />
            <px:PXLayoutRule runat="server" />
            ...
            <px:PXNumberEdit ID="QtyFixedFSSrvOrd" runat="server" DataField="QtyFixedFSSrvOrd" Enabled="False" />
