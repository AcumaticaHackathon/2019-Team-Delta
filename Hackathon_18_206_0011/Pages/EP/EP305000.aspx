                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Summary">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="CertifiedJob" Width="63px" Type="CheckBox" />
                                    <px:PXGridColumn DataField="CostCodeID" AutoCallBack="true" Width="108px" />
                                    <px:PXGridColumn DataField="UnionID" AutoCallBack="true" Width="108px" />
                                    <px:PXGridColumn DataField="LabourItemID" AutoCallBack="true" Width="108px" />
                                    <px:PXGridColumn DataField="WorkCodeID" AutoCallBack="true" Width="108px" />
