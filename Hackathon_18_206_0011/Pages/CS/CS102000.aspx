		...
		<Items>
			<px:PXTabItem Text="Branch Details" RepaintOnDemand="false">
				<Template>
					...
					<px:PXSelector ID="edDefaultPrinter" runat="server" DataField="DefaultPrinter" TabIndex="50"/>					
				...
				<Template>
					<px:PXFormView ID="frmLogo" runat="server" DataMember="CurrentBAccount" Width="100%" CaptionVisible="False" TemplateContainer="" DataSourceID="ds" SkinID="Transparent">
						<Template>
                            ...
                            <px:PXImageUploader ID="logoReportImgUploader" runat="server" DataField="BranchLogoNameReport" Height="120px" Width="420px" AllowUpload="True" SuppressLabel="True"/>
