		...
		<Items>
			<px:PXTabItem Text="Company Details" RepaintOnDemand="false">
				<Template>
				    ...
				    <px:PXSelector ID="edRolename" runat="server" DataField="OrganizationView.RoleName" CommitChanges="True"/>
				    <px:PXSelector ID="edCountryID" runat="server" AllowEdit="True" DataField="OrganizationView.CountryID" />
                    <px:PXSelector ID="edDefaultPrinter" runat="server" DataField="OrganizationView.DefaultPrinter" />
				...
				<Template>
					<px:PXFormView ID="frmLogo" runat="server" DataMember="OrganizationView" Width="100%" CaptionVisible="False" TemplateContainer="" DataSourceID="ds" SkinID="Transparent">
						<Template>
						    ...
						    <px:PXImageUploader ID="reportLogoImgUploader" DataMember="OrganizationView" runat="server" DataField="LogoNameReport" Height="120px" Width="420px" AllowUpload="True" SuppressLabel="True"/>
