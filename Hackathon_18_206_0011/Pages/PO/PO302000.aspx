...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Height="353px" Style="z-index: 100;" Width="100%" DataMember="CurrentDocument" DataSourceID="ds">
        ...
        <Items>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="transactions">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="Selected" Type="CheckBox" CommitChanges="true" Width="40px" AllowCheckAll="True" TextAlign="Center" />
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="ReturnedQty" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn AutoCallBack="True" DataField="ReasonCode" DisplayFormat="&gt;aaaaaaaaaa" Width="81px" Label="Reason Code" />
                                    <px:PXGridColumn AllowNull="False" DataField="UnitCost" TextAlign="Right" Width="81px" Label="Unit Cost" CommitChanges="true" />
                                    <px:PXGridColumn AllowNull="False" DataField="TranCost" TextAlign="Right" Width="90px" CommitChanges="true" />
                                    <px:PXGridColumn AllowNull="False" DataField="TranCostFinal" TextAlign="Right" Width="90px" />
                                </Columns>
                                <RowTemplate>
                                    <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XM" />
            ...
            <px:PXTabItem Text="Purchase Orders" VisibleExp="DataControls[&quot;edReceiptType&quot;].Value!=RX" BindingContext="form">
                <Template>
                    <px:PXGrid ID="formOrders" runat="server" DataSourceID="ds" Width="100%" SkinID="Details" BorderStyle="None">
                        <Levels>
                            <px:PXGridLevel DataMember="ReceiptOrdersLink" >
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="POType" RenderEditorText="True" Width="90px" />
                                    <px:PXGridColumn DataField="PONbr" RenderEditorText="True" Width="120px" />
                                    <px:PXGridColumn DataField="CuryID" RenderEditorText="True" Width="90px" />
                                    <px:PXGridColumn DataField="TaxZoneID" RenderEditorText="True" Width="120px" />
                                    <px:PXGridColumn DataField="PayToVendorID" RenderEditorText="True" Width="120px" />
			...
			<px:PXTabItem Text="PR History" BindingContext="form">
                <Template>
                    <px:PXGrid ID="formPRHistory" runat="server" DataSourceID="ds" Width="100%" SkinID="DetailsInTab" BorderStyle="None">
                        <Levels>
                            <px:PXGridLevel DataMember="ReceiptHistory" >
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="ReceiptType" RenderEditorText="True" Width="90px" />
                                    <px:PXGridColumn DataField="ReceiptNbr" RenderEditorText="True" Width="120px" />
                                    <px:PXGridColumn DataField="DocDate" RenderEditorText="True" Width="90px" />
                                    <px:PXGridColumn DataField="FinPeriodID" RenderEditorText="True" Width="90px" />
                                    <px:PXGridColumn DataField="Status" RenderEditorText="True" Width="120px" />
                                    <px:PXGridColumn DataField="TotalQty" RenderEditorText="True" Width="120px" />
	                                <px:PXGridColumn DataField="InvtDocType" RenderEditorText="True" Width="90px" />
	                                <px:PXGridColumn DataField="InvtRefNbr" RenderEditorText="True" Width="120px" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="150" />
			...
			<px:PXTabItem Text="Billing History" BindingContext="form">
                <Template>
                    <px:PXGrid ID="formBillingHistory" runat="server" DataSourceID="ds" Width="100%" SkinID="DetailsInTab" BorderStyle="None" StatusField="StatusText">
                        <Levels>
                            <px:PXGridLevel DataMember="ApDocs" >
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="DocType" RenderEditorText="True" Width="90px" />
                                    <px:PXGridColumn DataField="RefNbr" RenderEditorText="True" Width="120px" />
                                    <px:PXGridColumn DataField="DocDate" RenderEditorText="True" Width="90px" />
                                    <px:PXGridColumn DataField="Status" RenderEditorText="True" Width="120px" />
                                    <px:PXGridColumn DataField="TotalQty" RenderEditorText="True" Width="120px" />
                                    <px:PXGridColumn DataField="TotalAmt" RenderEditorText="True" Width="90px" />
	                                <px:PXGridColumn DataField="AccruedQty" RenderEditorText="True" Width="90px" />
	                                <px:PXGridColumn DataField="AccruedAmt" RenderEditorText="True" Width="90px" />
                                    <px:PXGridColumn DataField="TotalPPVAmt" RenderEditorText="True" Width="90px" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="150" />
			...
			<px:PXTabItem Text="Landed Costs" VisibleExp="DataControls[&quot;edReceiptType&quot;].Value!=RN" BindingContext="form">
                <Template>
                    <px:PXGrid ID="gridLandedCosts" runat="server" DataSourceID="ds" Width="100%" SkinID="Details" BorderStyle="None">
                        <Levels>
                            <px:PXGridLevel DataMember="landedCosts" >
                                <RowTemplate>
                                </RowTemplate>
                                <Columns>
	                                <px:PXGridColumn DataField="LCDocType" RenderEditorText="True" Width="90px" />
	                                <px:PXGridColumn DataField="LCRefNbr" RenderEditorText="True" Width="120px" LinkCommand="ViewItem"/>
                                    <px:PXGridColumn DataField="DocDate" RenderEditorText="True" Width="90px" />
                                    <px:PXGridColumn DataField="Status" RenderEditorText="True" Width="120px" />
                                    <px:PXGridColumn DataField="VendorID" RenderEditorText="True" Width="120px" />
                                    <px:PXGridColumn DataField="LandedCostCodeID" RenderEditorText="True" Width="120px" />
	                                <px:PXGridColumn DataField="CuryLineAmt" RenderEditorText="True" Width="120px" />
                                    <px:PXGridColumn DataField="CuryID" RenderEditorText="True" Width="120px" />
                                    <px:PXGridColumn DataField="APRefNbr" RenderEditorText="True" Width="120px" LinkCommand="ViewItem"/>
	                                <px:PXGridColumn DataField="INRefNbr" RenderEditorText="True" Width="120px" LinkCommand="ViewItem"/>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="150" />
    ...
    <px:PXSmartPanel ID="panelAddReceiptReturn" runat="server" Style="z-index: 108; height: 396px;" Width="960px" Caption="Add Receipt"
        ...
        <px:PXGrid ID="grdReceiptReturn" runat="server" Height="304px" Width="100%" DataSourceID="ds" Style="border-width: 1px 0px;" AutoAdjustColumns="true" AdjustPageSize="Auto" SkinID="Inquire">
            <AutoSize Enabled="true" />
            <Levels>
    ...
    <px:PXSmartPanel ID="panelAddReceiptLineReturn" runat="server" Style="z-index: 108; height: 396px;" Width="960px" Caption="Add Receipt Line"
        ...
        <px:PXGrid ID="grdReceiptLineReturn" runat="server" Height="304px" Width="100%" DataSourceID="ds" Style="border-width: 1px 0px;" AutoAdjustColumns="true" AdjustPageSize="Auto" SkinID="Inquire">
            <AutoSize Enabled="true" />
            <Levels>
