					...
					<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100"
						...
						<Levels>
							<px:PXGridLevel DataMember="Details">
								...
								<Columns>
									<px:PXGridColumn DataField="BranchID" Width="100px" AutoCallBack="True" AllowShowHide="Server" DisplayFormat="&gt;AAAAAAAAAA" RenderEditorText="True"/>
									...
									<px:PXGridColumn DataField="AllocationMethod" Width="220px" />
									<px:PXGridColumn DataField="CuryLineAmt" TextAlign="Right" Width="81px" CommitChanges="True"/>
									<px:PXGridColumn DataField="TaxCategoryID" CommitChanges="True" />
									<px:PXGridColumn DataField="InventoryID" Width="100px" AutoCallBack="True" LinkCommand="ViewItem" CommitChanges="True" />
									<px:PXGridColumn DataField="APDocType" Width="100px" />
									<px:PXGridColumn DataField="APRefNbr" Width="100px" LinkCommand="ViewItem"/>
									<px:PXGridColumn DataField="INDocType" Width="100px" />
									<px:PXGridColumn DataField="INRefNbr" Width="100px" LinkCommand="ViewItem"/>
								</Columns>
							</px:PXGridLevel>
						</Levels>
					...
					<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="DetailsInTab" ActionsPosition="Top">
						<Levels>
							<px:PXGridLevel DataMember="ReceiptLines">
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="XM" />
									<px:PXSelector SuppressLabel="True" ID="edRlBranchID" runat="server" DataField="BranchID" Enabled="False"/>
									<px:PXSelector SuppressLabel="True" ID="edRlInventoryID" runat="server" DataField="InventoryID" Enabled="False"/>
									<px:PXSelector SuppressLabel="True" ID="edRlSiteID" runat="server" DataField="SiteID" Enabled="False"/>
								...
								<Columns>
									...
									<px:PXGridColumn DataField="ReceiptQty" Width="100px" DataType="Decimal" TextAlign="Right" DefValueText="0.0" />
									<px:PXGridColumn AllowNull="False" DataField="ExtWeight" TextAlign="Right" Width="108px" />
									<px:PXGridColumn AllowNull="False" DataField="ExtVolume" TextAlign="Right" Width="108px" />
									<px:PXGridColumn DataField="LineAmt" TextAlign="Right" Width="81px" />
									<px:PXGridColumn DataField="POReceiptBaseCuryID" TextAlign="Right" Width="81px" />
									<px:PXGridColumn DataField="CuryAllocatedLCAmt" TextAlign="Right" Width="81px" />
									<px:PXGridColumn DataField="POReceiptNbr" Width="100px" LinkCommand="ViewItem"/>
									<px:PXGridColumn DataField="POReceiptLineNbr" Width="100px" TextAlign="Right"/>
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Container="Window" Enabled="True" MinHeight="150" />
            ...
            <Levels>
                <px:PXGridLevel DataMember="poReceiptSelection">
                    <Columns>
	                    ...
	                    <px:PXGridColumn DataField="OrderQty"  Width="100px"/>
                    </Columns>
                </px:PXGridLevel>
            </Levels>
        </px:PXGrid>
            ...
            <Levels>
                <px:PXGridLevel DataMember="poReceiptLinesSelection">
                    <Columns>
	                    ...
	                    <px:PXGridColumn DataField="ReceiptQty"  Width="100px"/>
	                    <px:PXGridColumn DataField="UOM" />
	                    <px:PXGridColumn DataField="TranCostFinal"  Width="100px"/>
                    </Columns>
                </px:PXGridLevel>
            </Levels>
        </px:PXGrid>
