    ...
    <px:PXTab ID="tab" runat="server" Height="504px" Style="z-index: 100;" Width="100%" DataSourceID="ds" DataMember="CurrentDocument">
        ...
        <Items>
                    ...
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100; left: 0px; top: 0px; height: 384px;" Width="100%"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Transactions">
                                <Columns>
                                    <px:PXGridColumn DataField="BranchID" DisplayFormat="&gt;AAAAAAAAAA" Width="81px" RenderEditorText="True" CommitChanges="True" />
                                    ...
                                    <px:PXGridColumn DataField="DiscountID" RenderEditorText="True" TextAlign="Left" Width="90px" CommitChanges="True" />
                                    <px:PXGridColumn DataField="DiscountSequenceID" TextAlign="Left" Width="90px" />
                                    <px:PXGridColumn AllowNull="False" DataField="RetainagePct" TextAlign="Right" Width="81px" CommitChanges="true" />
                                    <px:PXGridColumn AllowNull="False" DataField="CuryRetainageAmt" TextAlign="Right" Width="81px" CommitChanges="true" />
                                    ...
                                    <px:PXGridColumn DataField="CostCodeID" Width="81px" CommitChanges="True"/>
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="Closed" TextAlign="Center" Type="CheckBox" Width="60px" />
                                    <px:PXGridColumn DataField="BilledQty" Width="81px" />
                                    <px:PXGridColumn DataField="CuryBilledAmt" Width="81px" />
                                    <px:PXGridColumn DataField="UnbilledQty" Width="81px" />
                                    <px:PXGridColumn DataField="CuryUnbilledAmt" Width="81px" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Taxes">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="CuryRetainedTaxableAmt" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn AllowNull="False" DataField="CuryRetainedTaxAmt" TextAlign="Right" Width="81px" />
			...
			<px:PXTabItem Text="PO History" RepaintOnDemand="False" >
				<Template>
                    <px:PXSplitContainer runat="server" ID="sp1" SplitterPosition="500" SkinID="Transparent" Height="500px" DisabledPanel="Panel1">
					<AutoSize Enabled="true" />
					<Template1>
						<px:PXGrid ID="formReceipts" runat="server" DataSourceID="ds" Width="100%" SkinID="DetailsInTab" BorderStyle="None" StatusField="StatusText">
							<Levels>
								<px:PXGridLevel DataMember="Receipts">
									...
									<Columns>
										...
										<px:PXGridColumn DataField="TotalQty" Width="90px" />
									</Columns>
								</px:PXGridLevel>
							</Levels>
							<AutoSize Enabled="True" MinHeight="150" />
					...
					<Template2>
						<px:PXGrid ID="formAPDocs" runat="server" DataSourceID="ds" Width="100%" SkinID="DetailsInTab" BorderStyle="None" StatusField="StatusText">
							<Levels>
								<px:PXGridLevel DataMember="APDocs" >
									...
									<Columns>
										...
										<px:PXGridColumn DataField="TotalQty" Width="90px" />
										<px:PXGridColumn DataField="TotalAmt" Width="90px" />
										<px:PXGridColumn DataField="TotalPPVAmt" Width="90px" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ChangeOrders">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="PMChangeOrder__ClassID" Width="99px" />
                                    <px:PXGridColumn DataField="PMChangeOrder__ProjectNbr" Width="99px" />
                                    <px:PXGridColumn DataField="PMChangeOrder__Status" Width="99px" />
                                    <px:PXGridColumn DataField="PMChangeOrder__Description" Width="120px" />
                                    <px:PXGridColumn DataField="PMChangeOrder__Date" Width="63px" />
                                    <px:PXGridColumn DataField="PMChangeOrder__CompletionDate" Width="80px" />
                                    <px:PXGridColumn DataField="PMChangeOrder__DelayDays" Width="80px" />
                                    <px:PXGridColumn DataField="PMChangeOrder__ReverseStatus" Width="80px" />
                                    <px:PXGridColumn DataField="PMChangeOrder__OrigRefNbr" Width="100px" LinkCommand="ViewOrigChangeOrder" />
                                    <px:PXGridColumn DataField="PMChangeOrder__ExtRefNbr" Width="80px" />
                                    ...
                                    <px:PXGridColumn DataField="UnitCost" TextAlign="Right" Width="81px" />
