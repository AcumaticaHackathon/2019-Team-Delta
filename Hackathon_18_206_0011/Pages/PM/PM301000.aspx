                ...
                <Template>
                    <px:PXFormView ID="RevenueFilter" runat="server" DataMember="RevenueFilter" RenderStyle="Normal" >
                        <Template>
                           ...
                           <px:PXNumberEdit ID="edAmountToInvoiceTotal" runat="server" DataField="AmountToInvoiceTotal" Enabled="false" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="CostBudget">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="CommittedOrigAmount" TextAlign="Right" Width="81px" />
                                    ...
                                    <px:PXGridColumn DataField="UnitPrice" TextAlign="Right" Width="99px" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="BalanceRecords" DataKeyNames="RecordID">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="BudgetedCOAmount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="RevisedAmount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="OriginalCommittedAmount" TextAlign="Right" Width="85px" />
                                    <px:PXGridColumn DataField="CommittedCOAmount" TextAlign="Right" Width="85px" />
                                    <px:PXGridColumn DataField="CommittedAmount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="CommittedInvoicedAmount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="ActualAmount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="CommittedOpenAmount" TextAlign="Right" Width="81px" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="PurchaseOrders">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="OrderTotal" TextAlign="Right" Width="81px" />
