...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.PM.PMQuoteMaint" PrimaryView="Quote" PageLoadBehavior="InsertRecord">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Quote Summary" DataMember="Quote" FilesIndicator="True"
		...
		<Template>
			...
			<px:PXSelector ID="edOpportunityID" runat="server" DataField="OpportunityID" CommitChanges="True" Enabled="true" AutoRefresh="true" AllowEdit="true"/>
			...
			<px:PXSelector ID="edOwnerID" runat="server" DataField="OwnerID" TextMode="Search" DisplayMode="Text" />
		     ...
		     <pxa:PXCurrencyRate ID="edCury" runat="server" DataMember="_Currency_" DataField="CuryID" RateTypeView="_PMQuote_CurrencyInfo_" DataSourceID="ds"></pxa:PXCurrencyRate>
			<px:PXLayoutRule runat="server"  Merge="true" />
			<px:PXSelector ID="edProjectID" runat="server" DataField="QuoteProjectID" Enabled="False" AllowEdit="True"/>
			<px:PXTextEdit ID="edProjectCD" runat="server" DataField="QuoteProjectCD" CommitChanges="True" />			
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Width="100%" Height="280px" DataSourceID="ds" DataMember="QuoteCurrent">
		<Items>
				    ...
				    <px:PXGrid ID="ProductsGrid" SkinID="Details" runat="server" Width="100%" Height="500px" DataSourceID="ds" ActionsPosition="Top" BorderWidth="0px" SyncPosition="true">
					   ...
					   <Levels>
						  <px:PXGridLevel DataMember="Products">
							 ...
							 <Columns>
								<px:PXGridColumn DataField="InventoryID" DisplayFormat="CCCCCCCCCCCCCCCCCCCC" Width="135px" AutoCallBack="True" AllowDragDrop="true"/>
								<px:PXGridColumn DataField="Descr" Width="150px" AllowDragDrop="true"/>
								<px:PXGridColumn DataField="Quantity" TextAlign="Right" Width="108px" AutoCallBack="True" AllowDragDrop="true"/>
								<px:PXGridColumn DataField="UOM" DisplayFormat="&gt;aaaaaa" Width="63px" AutoCallBack="True" AllowDragDrop="true"/>
								<px:PXGridColumn AllowNull="False" DataField="CuryUnitCost" TextAlign="Right" Width="99px" AutoCallBack="True" />
								<px:PXGridColumn AllowNull="False" DataField="CuryExtCost" TextAlign="Right" Width="81px" AutoCallBack="True" />
								...
								<px:PXGridColumn DataField="DiscountID" TextAlign="Left" Width="90px" />
								...
								<px:PXGridColumn DataField="TaskCD" Width="108px" AutoCallBack="True" />
								<px:PXGridColumn DataField="CostCodeID" Width="90px" AutoCallBack="True" AllowDragDrop="true"/>
								<px:PXGridColumn DataField="ExpenseAccountGroupID" Width="135px" AutoCallBack="True" AllowDragDrop="true"/>
								<px:PXGridColumn DataField="RevenueAccountGroupID" Width="135px" AutoCallBack="True" />
								<px:PXGridColumn DataField="TaxCategoryID" DisplayFormat="&gt;aaaaaaaaaa" Width="81px" />
								<px:PXGridColumn DataField="EmployeeID" Width="90px" AutoCallBack="True" />
							 </Columns>
						  </px:PXGridLevel>
					   </Levels>
					   <ActionBar>
					...
					<px:PXGrid ID="TasksGrid" SkinID="Details" runat="server" Width="100%" Height="500px" DataSourceID="ds" ActionsPosition="Top" BorderWidth="0px" SyncPosition="true">
						...
						<Levels>
							<px:PXGridLevel DataMember="Tasks">
								...
								<Columns>
									<px:PXGridColumn DataField="TaskCD" Width="135px" AutoCallBack="True" />
									<px:PXGridColumn DataField="Description" Width="200px" />
									<px:PXGridColumn DataField="PlannedStartDate" Width="135px" />
                                             <px:PXGridColumn DataField="PlannedEndDate" Width="135px" />                                            
                                            <px:PXGridColumn DataField="TaxCategoryID" Width="135px" />
								    <px:PXGridColumn DataField="isDefault" Type="CheckBox" Width="65px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
					</px:PXGrid>
			...
			<px:PXTabItem Text="Billing information">
				<Template>
...
<asp:Content ID="Dialogs" ContentPlaceHolderID="phDialogs" runat="Server">
    ...
    <px:PXSmartPanel ID="PanelConvertQuote" runat="server" Style="z-index: 108; position: absolute; left: 27px; top: 99px;" Caption="Convert to Project"
		CaptionVisible="True" LoadOnDemand="true" ShowAfterLoad="true" Key="ConvertQuoteInfo" AutoCallBack-Enabled="true" AutoCallBack-Target="formCopyQuote" AutoCallBack-Command="Refresh"
		CallBackMode-CommitChanges="True" CallBackMode-PostData="Page" AcceptButtonID="PXButtonOK" CancelButtonID="PXButtonCancel">
