            ...
            <Levels>
                <px:PXGridLevel DataMember="AvailablePOLines">
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="UnitCost" TextAlign="Right" Width="99px" />
                        <px:PXGridColumn DataField="ReceivedQty" TextAlign="Right" Width="81px" />
                        <px:PXGridColumn DataField="ExtCost" TextAlign="Right" Width="81px" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="RevenueBudget">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="PMBudget__Amount" TextAlign="Right" Width="81px"  />
                                    ...
                                    <px:PXGridColumn DataField="PMBudget__InvoicedAmount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="PMBudget__ActualQty" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="PMBudget__ActualAmount" TextAlign="Right" Width="81px" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="CostBudget">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="PMBudget__CommittedAmount" TextAlign="Right" Width="81px" />
                                    ...
                                    <px:PXGridColumn DataField="PMBudget__CommittedInvoicedAmount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="PMBudget__CommittedOpenQty" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="PMBudget__CommittedOpenAmount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="PMBudget__CommittedCOQty" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="PMBudget__CommittedCOAmount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="PMBudget__ActualQty" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="PMBudget__ActualAmount" TextAlign="Right" Width="81px" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Details">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="POLinePM__CuryExtCost" TextAlign="Right" Width="81px" />
                                    ...
                                    <px:PXGridColumn CommitChanges="true" DataField="AmountInBaseCury" TextAlign="Right" Width="81px" />
