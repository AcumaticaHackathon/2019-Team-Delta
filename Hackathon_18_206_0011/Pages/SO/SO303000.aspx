	...
	<px:PXTab ID="tab" runat="server" Height="363px" Style="z-index: 100;" Width="100%" TabIndex="23">
		...
		<Items>
						...
						<Levels>
							<px:PXGridLevel DataMember="Transactions" DataKeyNames="RefNbr,LineNbr">
								<Columns>
                                    ...
                                    <px:PXGridColumn DataField="LocationID" DisplayFormat="&gt;AAAAAAAAAA" Width="81px" CommitChanges="True" NullText="<SPLIT>" />
                                    ...
                                    <px:PXGridColumn DataField="LotSerialNbr" Width="180px" CommitChanges="True" NullText="<SPLIT>" />
                                    ...
                                    <px:PXGridColumn DataField="OrigInvoiceType" Width="72px" AllowUpdate="False" />
                                    <px:PXGridColumn DataField="OrigInvoiceNbr" Width="90px" AllowUpdate="False" />
                                    <px:PXGridColumn DataField="OrigInvoiceLineNbr" Width="72px" AllowUpdate="False" />
                                    <px:PXGridColumn DataField="InvtDocType" Width="75px" AllowUpdate="False" />
                                    <px:PXGridColumn DataField="InvtRefNbr" Width="90px" AllowUpdate="False" />
								</Columns>
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="S" />
						...
						<Levels>
							<px:PXGridLevel DataMember="FreightDetails">
								...
								<Columns>
									...
									<px:PXGridColumn AllowUpdate="False" DataField="ShipmentNbr" Width="90px" />
									...
									<px:PXGridColumn DataField="CuryFreightAmt" TextAlign="Right" Width="72px" CommitChanges="true" />
									<px:PXGridColumn DataField="CuryPremiumFreightAmt" TextAlign="Right" Width="118px" CommitChanges="true" />
						...
						<Levels>
							<px:PXGridLevel DataMember="DiscountDetails">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="CuryDiscountAmt" TextAlign="Right" Width="90px" CommitChanges="true" />
									<px:PXGridColumn DataField="DiscountPct" TextAlign="Right" Width="90px" CommitChanges="true" />
						...
						<Levels>
							<px:PXGridLevel DataMember="Adjustments">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="AdjgRefNbr" Width="108px" AutoCallBack="True" LinkCommand="ViewPayment"/>
			...
			<px:PXTabItem Text="Totals">
				<Template>
					<px:PXLayoutRule runat="server" StartColumn="True" SuppressLabel="True" />
					<px:PXFormView ID="formG" runat="server" DataSourceID="ds" Width="100%" DataMember="CurrentDocument"
						CaptionVisible="False" SkinID="Transparent">
						<Template>
							...
							<px:PXPanel ID="PXPanel1" runat="server" RenderStyle="Simple">
								<px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="S" StartColumn="True" />
								<px:PXNumberEdit ID="edCuryGoodsTotal" runat="server" DataField="CuryGoodsTotal" Enabled="False" />
					...
					<px:PXFormView ID="PXFormView1" runat="server" DataSourceID="ds" Style="top: -18px;" Width="100%" DataMember="SODocument"
						CaptionVisible="False" SkinID="Transparent">
						<Template>
							<px:PXPanel ID="PXPanel1" runat="server" RenderStyle="Simple">
								<px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="S" StartColumn="True" />
