                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Transactions" DataKeyNames="ShipmentNbr,LineNbr">
                                <Columns>
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="PackedQty" TextAlign="Right" Width="81px" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Packages">
                                ...
                                <Columns>
									...
									<px:PXGridColumn AllowNull="False" DataField="Weight" TextAlign="Right" Width="91px" CommitChanges="True" />
                                    ...
                                    <px:PXGridColumn DataField="StampsAddOns" Width="200" />
                                    ...
                                    <px:PXGridColumn DataField="ContentType" Width="120" CommitChanges="True" />
                                    <px:PXGridColumn DataField="ContentTypeDesc" Width="200" Multiline="True" />
                                    <px:PXGridColumn DataField="CertificateNumber" Width="70" />
                                    <px:PXGridColumn DataField="InvoiceNumber" Width="70" />
                                    <px:PXGridColumn DataField="LicenseNumber" Width="70" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="150" />
						...
						<Levels>
							<px:PXGridLevel DataMember="PackageDetailSplit">
								<RowTemplate>
									...
									<px:PXNumberEdit ID="edQtySplit" runat="server" DataField="Qty"/>
									<px:PXTextEdit ID="edUOMSplit" runat="server" DataField="UOM"/>
									<px:PXSelector ID="edShipmentLineNbr" runat="server" DataField="ShipmentLineNbr" AutoRefresh="True"/>
								</RowTemplate>
								<Columns>
									<px:PXGridColumn DataField="ShipmentLineNbr" Width="70px" CommitChanges="True"/>
            ...
            <Levels>
                <px:PXGridLevel DataMember="splits">
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="LocationID" Width="108px" CommitChanges="true" />
                        <px:PXGridColumn DataField="LotSerialNbr" Width="108px" CommitChanges="true" />
