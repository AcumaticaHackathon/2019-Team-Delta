...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100"
        ...
        <Template>
            <px:PXLayoutRule runat="server" StartRow="True" StartColumn="True" LabelsWidth="SM" ControlSize="M">
            </px:PXLayoutRule>
            ...
            <px:PXLayoutRule runat="server" GroupCaption="Generation options" 
                StartGroup="True" LabelsWidth="SM" ControlSize="M">
            </px:PXLayoutRule>
            <px:PXLayoutRule runat="server">
            </px:PXLayoutRule>
            ...
            <px:PXTabItem Text="Schedules">
                <Template>
                    <px:PXGrid ID="gridServiceContracts" runat="server" AllowPaging="True" AllowSearch="true"
                        ...
                        AdjustPageSize="Auto" AutoAdjustColumns="True" SyncPosition="True" KeepPosition="True" BatchUpdate="True">
                        <Levels>
