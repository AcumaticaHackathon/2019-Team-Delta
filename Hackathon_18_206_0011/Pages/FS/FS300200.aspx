...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    ...
    <CallbackCommands>
      ...
      <px:PXDSCallbackCommand Name="CloneAppointment" CommitChanges="True"/>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    ActivityIndicator="True" Width="100%" DataMember="AppointmentRecords" TabIndex="29900" AllowCollapse="True" MarkRequired="Dynamic">
        <Template>
            ...
            <px:PXDateTimeEdit ID="ScheduledDateTimeBegin_Date" runat="server" CommitChanges="True"
                DataField="ScheduledDateTimeBegin_Date" Enabled="False">
            </px:PXDateTimeEdit>
            ...
            <px:PXFormView ID="ServiceOrderHeader" runat="server"
                ...
                <Template>
                    ...
                    <px:PXSelector ID="edBillServiceContractID" runat="server" AutoRefresh="True"
                        CommitChanges="True" DataField="AppointmentSelected.BillServiceContractID" AllowEdit="True">
                    </px:PXSelector>
            ...
            <px:PXMaskEdit ID="edEstimatedDurationTotal" runat="server" 
                DataField="EstimatedDurationTotal" Enabled="False" TextAlign="Right">
            </px:PXMaskEdit>
			...
			<px:PXCheckBox ID="WaitingForParts" runat="server" 
                DataField="WaitingForParts" Text="Waiting for Parts">
            </px:PXCheckBox>
        </Template>
  </px:PXFormView>
</asp:Content>
    ...
    <Items>
      <px:PXTabItem Text="Summary">
          <Template>
                    ...
                    <px:PXLayoutRule runat="server" GroupCaption="Appointment Contact"
                        StartGroup="True">
                    </px:PXLayoutRule>
					<px:PXFormView ID="ServiceOrderTabSummary" runat="server"
						Caption="ServiceOrder Contact Summary" DataMember="ServiceOrderRelated" MarkRequired="Dynamic"
						DataSourceID="ds" RenderStyle="Simple" TabIndex="1500" DefaultControlID="edCustomerID">
						<Template>
							<px:PXLayoutRule runat="server" StartColumn="True" ControlSize="M" LabelsWidth="SM">
							</px:PXLayoutRule>
							<px:PXSelector ID="edContactID2" runat="server" DataField="ContactID"
                    ...
                    <px:PXFormView ID="AppointmentAddress" runat="server"
                    Caption="Appointment Address" DataMember="ServiceOrderRelated" MarkRequired="Dynamic"
                    DataSourceID="ds" RenderStyle="Simple">
                      <Template>
                        <px:PXLayoutRule runat="server" StartColumn="True" ControlSize="M" LabelsWidth="SM">
                        </px:PXLayoutRule>
                        <px:PXSelector ID="edRoomID" runat="server" DataField="RoomID" AllowEdit="True" 
                            DataSourceID="ds" AutoRefresh="True" CommitChanges="True">
                        </px:PXSelector>
					...
					<px:PXFormView ID="ServiceOrderContactTabSummary" runat="server"
						Caption="ServiceOrder Contact Summary" DataMember="ServiceOrderRelated" MarkRequired="Dynamic"
						DataSourceID="ds" RenderStyle="Simple" TabIndex="1500" DefaultControlID="edCustomerID">
						<Template>
							<px:PXLayoutRule runat="server" StartColumn="True" ControlSize="M" LabelsWidth="SM">
                    ...
                    <px:PXButton ID="btnViewDirectionOnMap" runat="server" Height="24px"
                        Text="View on Map" Width="124px">
...
<%-- BILLABLE FIELDS --%>                                    
                                    ...
                                    <px:PXGridColumn DataField="FSSODet__EnablePO" TextAlign="Center" Type="CheckBox" Width="65px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="FSSODet__PONbr" TextAlign="Left">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="FSSODet__POStatus" TextAlign="Left">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="FSSODet__POCompleted" TextAlign="Center" Type="CheckBox" Width="65px">
                                    </px:PXGridColumn>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
...
<%-- BILLABLE FIELDS --%>
      ...
      <px:PXTabItem Text="Resource Equipment">
                ...
                <Template>
                    ...
                    <px:PXFormView runat="server" Caption="Location"
                        ...
                        <Template>
                            ...
                            <px:PXLayoutRule StartGroup="True" GroupCaption="Completion Location" runat="server">
                            </px:PXLayoutRule>
        ...
        <px:PXTabItem Text="Attendees" BindingContext="mainForm" LoadOnDemand="True" RepaintOnDemand="False">
            ...
            <px:PXTabItem Text="Invoice Info">
                <Template>
                    <px:PXGrid ID="PXGridPostInfo" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="130px" SkinID="Inquire" AdjustPageSize="Auto" TabIndex="2300" SyncPosition="True">
                        <Levels>
      ...
      <px:PXTabItem Text="Prepayments" BindingContext="mainForm" VisibleExp="DataControls[&quot;edIsPrepaymentEnable&quot;].Value == true">
            <Template>
