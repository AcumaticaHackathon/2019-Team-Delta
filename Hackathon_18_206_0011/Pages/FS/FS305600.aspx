...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" 
        ...
        TabIndex="5300" DefaultControlID="edSrvOrdType" NotifyIndicator="True" FilesIndicator="True" AllowCollapse="True">
        <Template>
                ...
                <px:PXSelector ID="edEntityID" runat="server" DataField="EntityID" AutoRefresh="True">
                </px:PXSelector>
                <px:PXLayoutRule runat="server" Merge="True">
                </px:PXLayoutRule>
                <px:PXSelector ID="edRefNbr" runat="server" DataField="RefNbr" AutoRefresh="True" NullText=" <NEW>" DataSourceID="ds">
                </px:PXSelector>
    ...
    <px:PXTab ID="tab" runat="server" Width="100%" Height="550px" DataSourceID="ds" 
        ...
        <px:PXTabItem Text="Recurrence">
                <Template>
                    ...
                    <px:PXTextEdit ID="edRecurrenceDescription" runat="server" CommitChanges="True" DataField="RecurrenceDescription" Enabled="False" Width="200px" Height="125px" SuppressLabel="True" TextAlign="Left" TextMode="MultiLine">
                    </px:PXTextEdit>
                    ...
                    <px:PXLayoutRule runat="server" Merge="True" LabelsWidth="SM" ControlSize="XS" ></px:PXLayoutRule>
