...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100"
        ...
        <Template>
            <px:PXLayoutRule runat="server" GroupCaption="Filters Options"  StartRow="True" ControlSize="SM" 
                LabelsWidth="S" StartColumn="True" StartGroup="True">
            </px:PXLayoutRule>
            <px:PXSelector runat="server" DataField="RouteID" 
                ID="edRouteID" CommitChanges="True" AutoRefresh="True">
            </px:PXSelector>
            <px:PXLayoutRule runat="server" ControlSize="SM" LabelsWidth="S" 
            ...
            <px:PXTabItem Text="Schedules">
                <Template>
                    <px:PXGrid ID="gridServiceContracts" runat="server" AllowPaging="True" AllowSearch="true"
                        ...
                        AdjustPageSize="Auto" AutoAdjustColumns="True" SyncPosition="True" KeepPosition="True" BatchUpdate="True" TabIndex="1700">
		                <Levels>
