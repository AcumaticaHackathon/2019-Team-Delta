...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
            ...
            <Levels>
                <px:PXGridLevel DataMember="ActiveScheduleRecords" DataKeyNames="RefNbr">
                    ...
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="RecurrenceDescription" Width="180px"></px:PXGridColumn>
                        <px:PXGridColumn DataField="ChangeRecurrence" TextAlign="Center" Type="CheckBox" Width="80px" CommitChanges="True"></px:PXGridColumn>
                        <px:PXGridColumn DataField="EffectiveRecurrenceStartDate" Width="120px" CommitChanges="True"></px:PXGridColumn>
                        <px:PXGridColumn DataField="NextExecution" Width="120px"></px:PXGridColumn>
                    </Columns>
                </px:PXGridLevel>
            </Levels>
            <AutoSize Enabled="True" MinHeight="350" />
            <ActionBar PagerVisible="Bottom" ActionsText="False"></ActionBar>
    ...
    <px:PXSmartPanel
        ...
        <px:PXFormView ID="PXFormCancelationDate" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="80px" DataMember="TerminateContractFilter" TabIndex="700" SkinID="Transparent">
            <Template>
                ...
                <px:PXLabel Size="XXL" Height="30px" ID="lblMessage" runat="server">Cancelling a contract will delete the associated appointments and service orders with date major or equal than the effective date</px:PXLabel>
            </Template>
        </px:PXFormView>
    ...
    <px:PXSmartPanel
        ...
        <px:PXFormView ID="PXFormSuspensionDate" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="80px" DataMember="SuspendContractFilter" TabIndex="700" SkinID="Transparent">
            <Template>
                ...
                <px:PXLabel Height="10px" runat="server"></px:PXLabel>
                <px:PXLabel Size="XXL" Height="30px" ID="lblMessage2" runat="server">Suspending a contract will delete the associated appointments and service orders with date major or equal than the effective date</px:PXLabel>
            </Template>
        </px:PXFormView>
    ...
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100"
        Width="100%" Caption="Service Contract" NotifyIndicator="True" FilesIndicator="True"
        ActivityIndicator="True" DataMember="ServiceContractRecords" DefaultControlID="edCustomerID" AllowColapse="True" AllowCollapse="True">
        <Template>
    ...
    <px:PXTab ID="tab" runat="server" Width="100%" Height="100%" DataSourceID="ds" 
		...
		<Items>
			    ...
			    <Template>
					...
					<px:PXFormView runat="server" Caption="Location"
                        ...
                        <Template>
                            ...
                            <px:PXLayoutRule runat="server" GroupCaption="Contract Billing Settings" StartGroup="True">
                            </px:PXLayoutRule>
                            ...
                            <px:PXLayoutRule runat="server" GroupCaption="Stardandized Billing Settings" StartGroup="True">
                            </px:PXLayoutRule>
            ...
            <px:PXTabItem Text="Schedules" BindingContext="form" visibleExp="DataControls[&quot;edShowScheduleTab&quot;].Value == false">
                <Template>
					<px:PXFormView ID="PXFormSchedule" runat="server" DataMember="ServiceContractSelected" RenderStyle="Simple" SkinID="Transparent">
                        <Template>
							<px:PXLayoutRule runat="server" StartColumn="True" ControlSize="M" StartRow="True" LabelsWidth="XS"/>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ContractPeriodDetRecords" DataKeyNames="ContractPeriodDetID,InventoryID,SMEquipmentID">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="Amount" CommitChanges="True" Width="100px" TextAlign="Right"/>
                                    <px:PXGridColumn DataField="Time" CommitChanges="True" />
                                    <px:PXGridColumn DataField="Qty" CommitChanges="True" />
									<px:PXGridColumn DataField="RegularPrice"  Width="100px" />
                                    <px:PXGridColumn DataField="RecurringUnitPrice"  Width="100px" CommitChanges="True" />
                                    <px:PXGridColumn DataField="RecurringTotalPrice"  Width="120px" CommitChanges="True" />
                                    <px:PXGridColumn DataField="OverageItemPrice"  Width="100px" CommitChanges="True" />
                                    <px:PXGridColumn DataField="RemainingAmount" Width="140px" CommitChanges="True" TextAlign="Right"/>
                                    <px:PXGridColumn DataField="RemainingTime"  Width="140px" CommitChanges="True" />
                                    <px:PXGridColumn DataField="RemainingQty"  Width="140px" CommitChanges="True" />
                                    <px:PXGridColumn DataField="UsedAmount"  Width="100px" CommitChanges="True" TextAlign="Right"/>
                                    <px:PXGridColumn DataField="UsedTime"  Width="100px" CommitChanges="True" />
                                    <px:PXGridColumn DataField="UsedQty"  Width="100px" CommitChanges="True" />
                                    <px:PXGridColumn DataField="ScheduledAmount"  Width="100px" CommitChanges="True" TextAlign="Right"/>
                                    <px:PXGridColumn DataField="ScheduledTime"  Width="100px" CommitChanges="True" />
                                    <px:PXGridColumn DataField="ScheduledQty"  Width="100px" CommitChanges="True" />
									<px:PXGridColumn DataField="Rollover"  CommitChanges="True" TextAlign="Center"  Type="CheckBox" />
                                </Columns>
                                <RowTemplate>
									...
									<px:PXCheckBox ID="edSBP_Rollover" runat="server" DataField="Rollover"></px:PXCheckBox>
                                </RowTemplate>
                            </px:PXGridLevel>
                        </Levels>
            ...
            <px:PXTabItem Text="Service Prices" BindingContext="form" VisibleExp="DataControls[&quot;edShowPriceTab&quot;].Value == true">
                <Template>
            ...
            <px:PXTabItem Text="Inventory Item Prices" BindingContext="form" VisibleExp="DataControls[&quot;edShowPriceTab&quot;].Value == true">
                <Template>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ContractHistoryItems">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ActionBusinessDate" Width="120px" TextAlign="Right" />
                                    <px:PXGridColumn DataField="EffectiveDate" Width="120px" TextAlign="Right" />
                                    <px:PXGridColumn DataField="ScheduleRefNbr" Width="120px" />
                                    <px:PXGridColumn DataField="ScheduleChangeRecurrence" TextAlign="Center" Type="CheckBox" Width="140px" />
                                    <px:PXGridColumn DataField="ScheduleNextExecutionDate" Width="120px" TextAlign="Right" />
                                    <px:PXGridColumn DataField="ScheduleRecurrenceDescr"  Width="180px" />
                                </Columns>
                                <RowTemplate>
