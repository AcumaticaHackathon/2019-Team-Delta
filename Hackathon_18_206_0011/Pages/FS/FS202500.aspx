...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    ...
    Width="100%" DataMember="BranchLocationRecords"
        ...
        <Template>
            ...
            <px:PXLayoutRule runat="server" GroupCaption="Main Address" StartGroup="True" ControlSize="XM" LabelsWidth="S">
            </px:PXLayoutRule>
            <px:PXLayoutRule runat="server" Merge="True" LabelsWidth="S">
            </px:PXLayoutRule>
            <px:PXCheckBox ID="edIsValidated" runat="server" DataField="IsValidated" 
                Text="Is Validated">
            </px:PXCheckBox>
            <px:PXButton ID="btnValidateAddress" runat="server" Width="115px">
            ...
            <px:PXButton ID="btnViewMainOnMap" runat="server" CommandName="ViewMainOnMap" 
                CommandSourceID="ds" Height="23px" Width="144px">
            </px:PXButton>
            <px:PXLayoutRule runat="server" EndGroup="True">
            </px:PXLayoutRule>
            <px:PXLayoutRule runat="server" StartColumn="True">
            </px:PXLayoutRule>
            <px:PXLayoutRule runat="server" GroupCaption="Financial Settings" ControlSize="XM" LabelsWidth="S" StartGroup="True">
            </px:PXLayoutRule>
            ...
            <px:PXLayoutRule runat="server" GroupCaption="Inventory Defaults" 
                StartGroup="True" ControlSize="XM" LabelsWidth="S">
            </px:PXLayoutRule>
