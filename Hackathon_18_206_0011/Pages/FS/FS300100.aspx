...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <px:PXFormView ID="mainForm" runat="server" DataSourceID="ds" Style="z-index: 100"
        ...
        ActivityIndicator="True" DataMember="ServiceOrderRecords" TabIndex="3700" DefaultControlID="edCustomerID" AllowCollapse="True">
        <Template>
            ...
            <px:PXDateTimeEdit ID="edOrderDate" runat="server" DataField="OrderDate" CommitChanges="True" Enabled="False">
            </px:PXDateTimeEdit>
			...
			<px:PXSelector ID="edBillServiceContractID" runat="server" AutoRefresh="True"
                CommitChanges="True" DataField="BillServiceContractID" AllowEdit="True">
            </px:PXSelector>
            ...
            <px:PXCheckBox ID="AppointmentsNeeded" runat="server" 
                DataField="AppointmentsNeeded" Text="Appointments Needed">
            </px:PXCheckBox>
        ...
        <Items>
            <px:PXTabItem Text="Summary">
                <Template>
                    ...
                    <px:PXSelector ID="edRoomID" runat="server" AllowEdit="True" 
                        DataField="RoomID" AutoRefresh="True" >
                    </px:PXSelector>
                    ...
                    <px:PXMaskEdit ID="edPostalCode" runat="server" DataField="PostalCode" Size="XS" CommitChanges="True">
                    </px:PXMaskEdit>
...
<%-- ESTIMATED FIELDS --%>                                    
                                    ...
                                    <px:PXGridColumn DataField="CuryUnitCost" Width="100px" TextAlign="Right" CommitChanges="True">
                                    </px:PXGridColumn>
...
<%-- BILLABLE FIELDS --%>
                                    ...
                                    <px:PXGridColumn DataField="POCompleted" TextAlign="Center" Type="CheckBox" Width="65px">
                                    </px:PXGridColumn>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
...
<%-- PURCHASE ORDER FIELDS --%>
            ...
            <px:PXTabItem Text="Appointments" BindingContext="mainForm" LoadOnDemand="True" RepaintOnDemand="False">
                <Template>
                    <px:PXGrid ID="PXGridAppointments" runat="server" DataSourceID="ds" FilesIndicator="False"
                        ...
                        <ActionBar ActionsText="False" PagerVisible="False">
                            <CustomItems>
                                <px:PXToolBarButton Key="cmdOpenAppointmentScreen">
                                    ...
                                    <PopupCommand Target="PXGridAppointments" Command="Refresh"></PopupCommand>
                                </px:PXToolBarButton>
                            </CustomItems>
                        </ActionBar>
                    </px:PXGrid>
            ...
            <px:PXTabItem Text="Invoice Info" BindingContext="mainForm" LoadOnDemand="True" RepaintOnDemand="False">
                <Template>
                    <px:PXFormView ID="InvoiceFlags" runat="server" DataMember="CurrentServiceOrder"
