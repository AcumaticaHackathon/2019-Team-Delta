            ...
            TabIndex="2300" SyncPosition="True" KeepPosition="True">
                <Levels>
                    <px:PXGridLevel DataMember="ContractPostDocRecords">
                        ...
                        <Columns>
                            <px:PXGridColumn DataField="PostDocType" Width="50px">
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="PostRefNbr" Width="100px" LinkCommand="OpenDocument">
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="ContractRefNbr" Width="120px" LinkCommand="OpenContract">
                            </px:PXGridColumn>
							<px:PXGridColumn DataField="BillCustomerID" Width="120px">
                            </px:PXGridColumn>
							...
							<px:PXGridColumn DataField="NextBillingInvoiceDate" Width="90px">
                            </px:PXGridColumn>
