...
namespace PX.Data
{
    ...
    /// <summary>Provides data to set up the <tt>string</tt> DAC
    ...
    /// <summary>Provides data to set up the <tt>long</tt> DAC field input control or cell presentation.</summary>
