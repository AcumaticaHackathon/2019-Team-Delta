...
namespace PX.Objects.FS
{
    public class ProcessServiceContracts : PXGraph<ProcessServiceContracts>
    {
        ...
        private void processServiceContract(ProcessServiceContracts graphServiceContractStatusProcess, FSServiceContract fsServiceContractRow)
        {
        ...
        private void ProcessContractPeriod(ProcessServiceContracts graphServiceContractStatusProcess, FSServiceContract fsServiceContractRow)
        {
            if (fsServiceContractRow.RecordType == ID.RecordType_ServiceContract.SERVICE_CONTRACT)
            {
                graphServiceContractStatusProcess.graphServiceContractEntry.ServiceContractRecords.Current =
        ...
        [PXFilterable]
        public PXFilteredProcessing<FSServiceContract, ServiceContractFilter> ServiceContracts;
        #endregion
        #region Delegates
        public virtual IEnumerable serviceContracts()
        {
            ...
            int totalRows = 0;
            var list = serviceContractView.Select(
                                                PXView.Currents,
                                                PXView.Parameters,
                                                PXView.Searches,
                                                PXView.SortColumns,
