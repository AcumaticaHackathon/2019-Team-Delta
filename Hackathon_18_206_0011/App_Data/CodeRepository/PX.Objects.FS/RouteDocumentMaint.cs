...
namespace PX.Objects.FS
{
    public class RouteDocumentMaint : PXGraph<RouteDocumentMaint, FSRouteDocument>, IGraphWithInitialization
    {
        ...
        [PXUIField(DisplayName = "Schedule Nbr.", Enabled = false)]
        ...
        public virtual void ReassignAppointment()
        {
            if (AppointmentsInRoute.Current != null && RouteRecords.Current != null)
            {
                var appointmentSelected = PXSelectReadonly2<FSAppointment,
                                            ...
                                            Where<
                                                FSAppointment.appointmentID, Equal<Required<FSAppointment.appointmentID>>>>.Select(this, AppointmentsInRoute.Current.AppointmentID);

                PXResult<FSAppointment, FSServiceOrder> bqlResult = (PXResult<FSAppointment, FSServiceOrder>)appointmentSelected;
                ...
                RouteAppAssignmentFilter.Current.AddressLine1 = fsServiceOrderRow.AddressLine1;
                RouteAppAssignmentFilter.Current.AddressLine2 = fsServiceOrderRow.AddressLine2;
                RouteAppAssignmentFilter.Current.City = fsServiceOrderRow.City;
                RouteAppAssignmentFilter.Current.State = fsServiceOrderRow.State;
        ...
        {
            return RouteAppointmentAssignmentHelper.RouteRecordsDelegate(
                                                                        RouteAppAssignmentFilter,
        ...
        public virtual void UnassignAppointment()
        {
            ...
            if (WebDialogResult.Yes == RouteAppUnassignmentFilter.Ask(
                                                                    TX.WebDialogTitles.CONFIRM_UNASSIGN_APPOINTMENT,
        ...
        public virtual void Up()
        {
            if (AppointmentsInRoute.Current != null && AppointmentsInRoute.Current.RouteDocumentID != null)
            {
                using (var ts = new PXTransactionScope())
                {
                    SharedFunctions.MoveAppointmentInRoute(
                                                        this,
        ...
        public virtual IEnumerable StartRoute(PXAdapter adapter)
        {
            ...
            if (RouteRecords.Cache.GetStatus(fsRouteDocumentRow) != PXEntryStatus.Inserted)
            {
                ...
                if (fsRouteDocumentRow.DriverID == null || fsRouteDocumentRow.VehicleID == null)
                {
                    ...
                    if (RouteRecords.Ask(PXMessages.LocalizeFormat(TX.Warning.ROUTE_MISSING_DRIVER_OR_AND_VEHICLE, displayMessage), MessageButtons.YesNo) == WebDialogResult.No)
                    {
                        return adapter.Get();
                    }
                }
                ...
                DateTime? currentDate = new DateTime(
                                                    ...
                                                    fsRouteDocumentRow.Mem_BusinessDateTime.Value.Hour,
                                                    fsRouteDocumentRow.Mem_BusinessDateTime.Value.Minute,
                                                    fsRouteDocumentRow.Mem_BusinessDateTime.Value.Second);
        ...
        public virtual IEnumerable CompleteRoute(PXAdapter adapter)
        {
            ...
            if (RouteRecords.Cache.GetStatus(fsRouteDocumentRow) != PXEntryStatus.Inserted)
            {
                ...
                else
                {
                    ...
                    DateTime? currentDate = SharedFunctions.GetCustomDateTime(Accessinfo.BusinessDate.Value, fsRouteDocumentRow.Mem_BusinessDateTime.Value);
        ...
        public virtual IEnumerable UncloseRoute(PXAdapter adapter)
        {
            ...
            if (fsRouteDocumentRow != null)
            {
                if (AutomaticallyUncloseRoute || WebDialogResult.Yes == RouteRecords.Ask(
                                                            TX.WebDialogTitles.CONFIRM_ROUTE_UNCLOSING,
        ...
        public void openAppointmentScreen(FSRouteDocument fsRouteDocumentRow, string srvOrdType)
        {
            AppointmentEntry graphAppointmentEntry = PXGraph.CreateInstance<AppointmentEntry>();
            ...
            graphAppointmentEntry.AppointmentRecords.SetValueExt<FSAppointment.scheduledDateTimeBegin>
                (fsAppointmentRow, SharedFunctions.GetCustomDateTime(fsRouteDocumentRow.Date, appointmentScheduleStartTime));
            fsAppointmentRow = graphAppointmentEntry.AppointmentRecords.Update(fsAppointmentRow);
        ...
        private bool CompleteAppointmentsInRoute(ref string errorMessage)
        {
            ...
            if (bqlResultSet.Count > 0)
            {
                ...
                if (appWithErrors.Count > 0)
                {
                    ...
                    {
                        AppointmentsInRoute.Cache.RaiseExceptionHandling<FSAppointment.refNbr>(
                                                                                           kvp.Key,
                                                                                           kvp.Key.RefNbr,
                    ...
                    errorMessage = PXMessages.LocalizeFormat(TX.Error.ROUTE_CANT_BE_COMPLETED_APPOINTMENTS_IN_ROUTE_HAVE_ISSUES);
                }
            }
        ...
        private void EnableDisableCalcRouteStatsButton(bool routeHasAppointments, FSRouteDocument fsRouteDocumentRow)
        {
        ...
        /// </summary>
        private void EnableDisableDocument(PXCache cache, FSRouteDocument fsRouteDocumentRow)
        {
            ...
            PXUIFieldAttribute.SetEnabled<FSRouteDocument.branchID>(
                                                                    cache,
                                                                    fsRouteDocumentRow,
        ...
        /// </summary>
        private void AllowUpdateRouteDocument(FSRouteDocument fsRouteDocumentRow)
        {
        ...
        /// </summary>
        private void AllowDeleteRouteDocument(FSRouteDocument fsRouteDocumentRow) 
        {
        ...
        /// </summary>
        private void EnableDisable_ActionButtons(PXCache cache, FSRouteDocument fsRouteDocumentRow)
        {
        ...
        private void SetRouteStartTimeByRouteID(FSRouteDocument fsRouteDocumentRow)
        {
            ...
            switch (fsRouteDocumentRow.Date.Value.DayOfWeek)
            {
                case DayOfWeek.Monday:
                    ...
                    {
                        fsRouteDocumentRow.TimeBegin = SharedFunctions.GetCustomDateTime(fsRouteDocumentRow.TimeBegin, fsRouteRow.BeginTimeOnMonday);
                    }
                ...
                case DayOfWeek.Tuesday:
                    ...
                    {
                        fsRouteDocumentRow.TimeBegin = SharedFunctions.GetCustomDateTime(fsRouteDocumentRow.TimeBegin, fsRouteRow.BeginTimeOnTuesday);
                    }
                ...
                case DayOfWeek.Wednesday:
                    ...
                    {
                        fsRouteDocumentRow.TimeBegin = SharedFunctions.GetCustomDateTime(fsRouteDocumentRow.TimeBegin, fsRouteRow.BeginTimeOnWednesday);
                    }
                ...
                case DayOfWeek.Thursday:
                    ...
                    {
                        fsRouteDocumentRow.TimeBegin = SharedFunctions.GetCustomDateTime(fsRouteDocumentRow.TimeBegin, fsRouteRow.BeginTimeOnThursday);
                    }
                ...
                case DayOfWeek.Friday:
                    ...
                    {
                        fsRouteDocumentRow.TimeBegin = SharedFunctions.GetCustomDateTime(fsRouteDocumentRow.TimeBegin, fsRouteRow.BeginTimeOnFriday);
                    }
                ...
                case DayOfWeek.Saturday:
                    ...
                    {
                        fsRouteDocumentRow.TimeBegin = SharedFunctions.GetCustomDateTime(fsRouteDocumentRow.TimeBegin, fsRouteRow.BeginTimeOnSaturday);
                    }
                ...
                case DayOfWeek.Sunday:
                    ...
                    {
                        fsRouteDocumentRow.TimeBegin = SharedFunctions.GetCustomDateTime(fsRouteDocumentRow.TimeBegin, fsRouteRow.BeginTimeOnSunday);
                    }
            ...
            RouteRecords.Cache.SetValueExt<FSRouteDocument.actualStartTime>(
                fsRouteDocumentRow,
                timeStart);
        }
        ...
        /// </summary>
        private bool AreThereAnyAppointmentsInThisRoute(string routeStatus, ref string errorMessage)
        {
            ...
            if (AppointmentsInRoute.Select().Count == 0)
            {
                ...
                { 
                    case ID.Status_Route.IN_PROCESS:
                        errorMessage = PXMessages.LocalizeFormat(TX.Error.ROUTE_NEED_APPOINTMENTS_TO_CHANGE_STATUS, "started");
                        break;
                    case ID.Status_Route.COMPLETED:
                        errorMessage = PXMessages.LocalizeFormat(TX.Error.ROUTE_NEED_APPOINTMENTS_TO_CHANGE_STATUS, "completed");
                        break;
                    default:
                        break;
                }
        ...
        /// </summary>
        private void CheckAppointmentsAddress(PXCache cache, FSAppointment fsAppointmentRow)
        {
            FSServiceOrder fsServiceOrderRow = PXSelect<
                                                   FSServiceOrder, 
                                               Where<FSServiceOrder.sOID, 
                                                   Equal<Required<FSAppointment.sOID>>>>
                                               .Select(this, fsAppointmentRow.SOID);

            if (fsServiceOrderRow != null)
            {
                if ((string.IsNullOrEmpty(fsServiceOrderRow.AddressLine1)
                        && string.IsNullOrEmpty(fsServiceOrderRow.AddressLine2))
                    || string.IsNullOrEmpty(fsServiceOrderRow.City)
                        || string.IsNullOrEmpty(fsServiceOrderRow.State)
                            || string.IsNullOrEmpty(fsServiceOrderRow.PostalCode))
                {
                    cache.RaiseExceptionHandling<FSAppointment.refNbr>(
                                            fsAppointmentRow,
                                            fsAppointmentRow.RefNbr,
                                            new PXSetPropertyException(
                                                TX.Warning.INCOMPLETE_APPOINTMENT_ADDRESS,
        ...
        private void UpdateAppointmentsTimeBegin(FSRouteDocument fsRouteDocumentRow)
        {
            if (minutesToAdd == 0)
            {
                return;
            ...
            foreach (FSAppointment fsAppointmentRow in AppointmentsInRoute.Select())
            {
                        ...
                        && fsAppointmentRow.Status != ID.Status_Appointment.CANCELED)
                {
                    ...
                    fsAppointmentRow.ScheduledDateTimeBegin = SharedFunctions.GetCustomDateTime(fsRouteDocumentRow.Date, fsAppointmentRow.ScheduledDateTimeBegin.Value.AddMinutes(minutesToAdd));
                    fsAppointmentRow.ScheduledDateTimeEnd = SharedFunctions.GetCustomDateTime(fsRouteDocumentRow.Date, fsAppointmentRow.ScheduledDateTimeEnd.Value.AddMinutes(minutesToAdd));
        ...
        /// <param name="fsRouteDocumentRow">FSRouteDocument Row.</param>
        private void ValidateDrivers(PXCache cache, FSRouteDocument fsRouteDocumentRow)
        {
            if (fsRouteDocumentRow.DriverID != null
                && fsRouteDocumentRow.DriverID == fsRouteDocumentRow.AdditionalDriverID)
            {
                cache.RaiseExceptionHandling<FSRouteDocument.additionalDriverID>(
                    fsRouteDocumentRow, 
        ...
        /// <param name="cache">FSRouteDocument cache.</param>
        /// <param name="fsRouteDocumentRow">FSRouteDocument Row.</param>
        private void ValidateVehicles(PXCache cache, FSRouteDocument fsRouteDocumentRow)
        {
        ...
        private string InvalidDayTrip(FSRoute fsRouteRow) 
        {
        ...
        private bool TripIDAlreadyExist(FSRouteDocument fsRouteDocumentRow, int? tripNbr) 
        {
            FSRouteDocument fsRouterDocumentResult = (FSRouteDocument)PXSelectReadonly<FSRouteDocument,
                                                                           Where<
        ...
        /// </summary>
        private void SetRouteFuelType(FSRouteDocument fsRouteDocumentRow, int? vechicleID)
        {
        ...
        private void UpdateAppointmentInRoute(FSRouteDocument fsRouteDocumentRow, bool dateTimeChanged, bool vehicleChanged, bool driverChanged, bool additionalDriverChanged)
        {
            ...
            foreach (FSAppointment fsAppointmentRow in fsAppointmentResultSet)
            {
                ...
                {
                    graphAppointmentMaint.AppointmentRecords.Current.ScheduledDateTimeBegin = SharedFunctions.GetCustomDateTime(fsRouteDocumentRow.Date, fsAppointmentRow.ScheduledDateTimeBegin.Value.AddMinutes(minutesToAdd));
                    graphAppointmentMaint.AppointmentRecords.Current.ScheduledDateTimeEnd = SharedFunctions.GetCustomDateTime(fsRouteDocumentRow.Date, fsAppointmentRow.ScheduledDateTimeEnd.Value.AddMinutes(minutesToAdd));
                }
        ...
        /// </summary>
        private void AssignDriverToAppointmentsInRoute(AppointmentEntry graphAppointmentMaint, FSAppointment fsAppointmentRow, int? localNewDriverID, int? localOldDriverID)
        {
            PXResultset<FSAppointmentEmployee> fsAppointmentEmployeeOldResultSet = graphAppointmentMaint.AppointmentEmployees.Search<FSAppointmentEmployee.employeeID, FSAppointmentEmployee.serviceLineRef>(localOldDriverID, null);

            PXResultset<FSAppointmentEmployee> fsAppointmentEmployeeNewResultSet = graphAppointmentMaint.AppointmentEmployees.Search<FSAppointmentEmployee.employeeID, FSAppointmentEmployee.serviceLineRef>(localNewDriverID, null);
            ...
            if (localNewDriverID != null && fsAppointmentEmployeeNewResultSet.Count > 0)
            {
                ...
                {
                    fsAppointmentEmployeeRow.IsDriver = true;
                    graphAppointmentMaint.AppointmentEmployees.Update(fsAppointmentEmployeeRow);
                }
            }
            ...
            if (localNewDriverID != null && fsAppointmentEmployeeNewResultSet.Count == 0)
            {
                ...
                fsAppointmentEmployeeRow.IsDriver = true;
                graphAppointmentMaint.AppointmentEmployees.Insert(fsAppointmentEmployeeRow);
            }
            ...
            if (localOldDriverID != null && localOldDriverID != localNewDriverID && fsAppointmentEmployeeOldResultSet.Count > 0)
            {
                foreach (FSAppointmentEmployee fsAppointmentEmployeeRow in fsAppointmentEmployeeOldResultSet)
                {
                    ...
                    {
                        graphAppointmentMaint.AppointmentEmployees.Delete(fsAppointmentEmployeeRow);
                    }
                }
            }
        }
        ...
        /// </summary>
        public static bool IsThisStatusTransitionAllowed(FSRouteDocument fsRouteDocumentRow, string newRouteStatus, ref string errorMessage)
        {
            errorMessage = string.Empty;
        ...
        /// </summary>
        public void NormalizeAppointmentPosition()
        {
        ...
        public void calculateSimpleRouteStatistic()
        {
            FSRouteDocument fsRouteDocumentRow = RouteRecords.Current;
        ...
        protected virtual void FSRouteDocument_TimeBegin_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
        ...
        protected virtual void FSRouteDocument_TimeBegin_FieldUpdating(PXCache cache, PXFieldUpdatingEventArgs e)
        {
            ...
            {
                e.NewValue = SharedFunctions.GetCustomDateTime(fsRouteDocumentRow.Date, aux);
            }
        }

        protected virtual void FSRouteDocument_VehicleID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSRouteDocument_AdditionalVehicleID1_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSRouteDocument_AdditionalVehicleID2_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSRouteDocument_ActualStartTime_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            e.NewValue = SharedFunctions.GetCustomDateTime(Accessinfo.BusinessDate.Value, PXTimeZoneInfo.Now);
        }
        ...
        protected virtual void FSRouteDocument_ActualStartTime_FieldUpdating(PXCache cache, PXFieldUpdatingEventArgs e)
        {
            ...
            {
                DateTime auxActualDateTimeBegin = new DateTime(
        ...
        protected virtual void FSRouteDocument_RouteID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            cache.SetDefaultExt<FSRouteDocument.routeCD>(fsRouteDocumentRow);
        }

        protected virtual void FSRouteDocument_Date_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if (fsRouteDocumentRow.TimeBegin != null) 
            { 
                fsRouteDocumentRow.TimeBegin = SharedFunctions.GetCustomDateTime(fsRouteDocumentRow.Date, fsRouteDocumentRow.TimeBegin);
            } 
            else 
            {
                fsRouteDocumentRow.TimeBegin = SharedFunctions.GetCustomDateTime(fsRouteDocumentRow.Date, new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 0, 0, 0));
            }
        ...
        protected virtual void FSRouteDocument_TripNbr_FieldUpdating(PXCache cache, PXFieldUpdatingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSRouteDocument_TripNbr_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            if (RouteRecords.Current == null) 
            {
                return;
        ...
        protected virtual void FSRouteDocument_RowPersisting(PXCache cache, PXRowPersistingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSRouteDocument_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSRouteDocument_RowPersisted(PXCache cache, PXRowPersistedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSAppointment_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            ...
            CheckAppointmentsAddress(cache, fsAppointmentRow);
        }
        #endregion
    }
}