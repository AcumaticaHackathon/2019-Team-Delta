...
namespace PX.Objects.FS
{
    ...
    {        
        ...
        public class SourceType_ServiceOrder
        {
            ...
            public readonly string[] ID_LIST = { ID.SourceType_ServiceOrder.CASE, ID.SourceType_ServiceOrder.OPPORTUNITY, ID.SourceType_ServiceOrder.SALES_ORDER, ID.SourceType_ServiceOrder.SERVICE_DISPATCH, ID.SourceType_ServiceOrder.QUOTE };
            public readonly string[] TX_LIST = { TX.SourceType_ServiceOrder.CASE, TX.SourceType_ServiceOrder.OPPORTUNITY, TX.SourceType_ServiceOrder.SALES_ORDER, TX.SourceType_ServiceOrder.SERVICE_DISPATCH, TX.SourceType_ServiceOrder.QUOTE };            
        }
        ...
        public class Status_AppointmentDet : Status_Parts
        {
            ...
            {
                if (serviceStatus == Status_AppointmentDet.OPEN || serviceStatus == Status_AppointmentDet.IN_PROCESS)
                {
                    return true;
                }
                else
        ...
        public class Contract_PostTo
        {
            ...
            public readonly string[] ID_LIST = { ID.Contract_PostTo.ACCOUNTS_RECEIVABLE_MODULE, ID.Contract_PostTo.SALES_ORDER_MODULE };
            public readonly string[] TX_LIST = { TX.Contract_PostTo.ACCOUNTS_RECEIVABLE_MODULE, TX.Contract_PostTo.SALES_ORDER_MODULE };
        }
        ...
        public class Contract_SalesAcctSource
        {
            ...
            public readonly string[] ID_LIST = { ID.Contract_SalesAcctSource.INVENTORY_ITEM, ID.Contract_SalesAcctSource.CUSTOMER_LOCATION};
            public readonly string[] TX_LIST = { TX.Contract_SalesAcctSource.INVENTORY_ITEM, TX.Contract_SalesAcctSource.CUSTOMER_LOCATION};
        }
        ...
        public class SrvOrdType_StartAppointmentActionBehavior
        {
            public const string HEADER_ONLY             = "HO";
            public const string HEADER_SERVICE_LINES    = "HS";
            public const string NOTHING                 = "NO";

            public readonly string[] ID_LIST = { ID.SrvOrdType_StartAppointmentActionBehavior.HEADER_ONLY, ID.SrvOrdType_StartAppointmentActionBehavior.HEADER_SERVICE_LINES, ID.SrvOrdType_StartAppointmentActionBehavior.NOTHING };
            public readonly string[] TX_LIST = { TX.SrvOrdType_StartAppointmentActionBehavior.HEADER_ONLY, TX.SrvOrdType_StartAppointmentActionBehavior.HEADER_SERVICE_LINES, TX.SrvOrdType_StartAppointmentActionBehavior.NOTHING };
        }

        public class SrvOrdType_CompleteAppointmentActionBehavior
        {
            public const string HEADER_ONLY             = "HO";
            public const string HEADER_SERVICE_LINES    = "HS";
            public const string NOTHING                 = "NO";

            public readonly string[] ID_LIST = { ID.SrvOrdType_CompleteAppointmentActionBehavior.HEADER_ONLY, ID.SrvOrdType_CompleteAppointmentActionBehavior.HEADER_SERVICE_LINES, ID.SrvOrdType_CompleteAppointmentActionBehavior.NOTHING };
            public readonly string[] TX_LIST = { TX.SrvOrdType_CompleteAppointmentActionBehavior.HEADER_ONLY, TX.SrvOrdType_CompleteAppointmentActionBehavior.HEADER_SERVICE_LINES, TX.SrvOrdType_CompleteAppointmentActionBehavior.NOTHING };
        }
        ...
        public class Billing_By
        {
            ...
            public readonly string[] ID_LIST =
            {
                ID.Billing_By.APPOINTMENT, ID.Billing_By.SERVICE_ORDER, ID.Billing_By.CONTRACT
            };

            public readonly string[] TX_LIST =
            {
                TX.Billing_By.APPOINTMENT, TX.Billing_By.SERVICE_ORDER, TX.Billing_By.CONTRACT
            };
        }
