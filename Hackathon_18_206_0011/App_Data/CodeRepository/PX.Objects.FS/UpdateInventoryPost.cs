...
namespace PX.Objects.FS
{
    public class UpdateInventoryPost : PXGraph<UpdateInventoryPost>
    {
        ...
        public PXFilteredProcessingJoin<FSAppointmentInventoryItem, UpdateInventoryFilter,
                                    ...
                                    Where<
                                        ...
                                        And<FSSrvOrdType.enableINPosting, Equal<True>>>>> Appointments;
        ...
        public UpdateInventoryPost()
        {
            ...
            Appointments.SetProcessDelegate(
                delegate(List<FSAppointmentInventoryItem> fsAppointmentInventoryItem)
                {
        ...
        /// </summary>
        public void CreateDocuments(List<FSAppointmentInventoryItem> fsAppointmentInventoryItemRows, UpdateInventoryFilter filter)
        {
        ...
        private void CreateDocumentByGroup(List<FSAppointmentInventoryItem> fsAppointmentInventoryItemRows, List<SharedClasses.AppointmentInventoryItemGroup> listGroupToInvoice, UpdateInventoryFilter filter)
        {
        ...
        /// </summary>
        private int CreateDocumentsInIN(FSPostBatch fsPostBatchRow, List<FSAppointmentInventoryItem> fsAppointmentInventoryItemRows, List<SharedClasses.AppointmentInventoryItemGroup> listGroupToUpdateInInventory, UpdateInventoryFilter filter)
        {
                ...
                foreach (SharedClasses.AppointmentInventoryItemInfo appointmentInventoryItemInfoRow in groupToUpdateInInventory.AppointmentInventoryItems)
                {
                    using (var ts_GroupToUpdateInInventory = new PXTransactionScope())
                    {
                        try
                        {
                            ...
                            {
                                PXProcessing<FSAppointmentInventoryItem>.SetError(appointmentInventoryItemInfoRow.Index, TX.Error.APPOINTMENT_ITEM_CANNOT_BE_POSTED_TO_IN_NO_ITEMS_RELATED);
                            }

                            PXProcessing<FSAppointmentInventoryItem>.SetInfo(appointmentInventoryItemInfoRow.Index, TX.Messages.RECORD_PROCESSED_SUCCESSFULLY);
                            linesPosted++;
                        ...
                        catch (Exception e)
                        {
                            ...
                            PXProcessing<FSAppointmentInventoryItem>.SetError(appointmentInventoryItemInfoRow.Index, latestException);
        ...
        /// </summary>
        private FSPostBatch CreateFSPostBatch(int qtyDoc, string postTo, DateTime? cutOffDate, string invoicePeriodID = null, DateTime? invoiceDate = null, int? billingCycleID = null, DateTime? upToDate = null)
        {
        ...
        /// </summary>
        private FSPostBatch UpdateFSPostBatch(FSPostBatch fsPostBatchRow)
        {
        ...
        /// </summary>
        private void DeleteFSPostBatch(FSPostBatch fsPostBatchRow)
        {
            graphUpdatePostBatchMaint.BatchRecords.Current = graphUpdatePostBatchMaint.BatchRecords.Search<FSPostBatch.batchID>(fsPostBatchRow.BatchID);
        ...
        /// </summary>
        protected void CreateDocumentReceipt(INReceiptEntry graphINReceiptEntry, SharedClasses.AppointmentInventoryItemInfo appointmentInventoryItemInfoRow, FSAppointmentInventoryItem fsAppointmentInventoryItemRow, DateTime? documentDate, string documentPeriod, FSPostBatch fsPostBatchRow, ref string inRefNbr, ref string inDocType)
        {
