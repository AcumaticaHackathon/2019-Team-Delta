...
namespace PX.Objects.FS
{
    public class StaffContractScheduleEntry : PXGraph<StaffContractScheduleEntry, FSStaffSchedule>
    {
        ...
        protected virtual void FSStaffSchedule_EmployeeID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            Branch branchRow = PXSelectJoin<Branch,
                                    InnerJoin<BAccount,
                                        On<BAccount.parentBAccountID, Equal<Branch.bAccountID>>,
                                    InnerJoin<EPEmployee,
                                        On<EPEmployee.bAccountID, Equal<BAccount.bAccountID>>>>,
                                    Where<EPEmployee.bAccountID, Equal<Required<FSStaffSchedule.employeeID>>>>
        ...
        protected virtual void FSStaffSchedule_StartTime_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
        ...
        protected virtual void FSStaffSchedule_EndTime_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            DateTime? bussinessDatePlusCurrentHours = new DateTime(
                                                                Accessinfo.BusinessDate.Value.Year,
                                                                Accessinfo.BusinessDate.Value.Month,
        ...
        private void CheckDates(PXCache cache, FSStaffSchedule fsStaffScheduleRow)
        { 
        ...
        /// <param name="cache">FSStaffSchedule cache.</param>
        /// <param name="fsStaffScheduleRow">FSStaffSchedule Row.</param>
        private void CheckTimes(PXCache cache, FSStaffSchedule fsStaffScheduleRow)
        {
