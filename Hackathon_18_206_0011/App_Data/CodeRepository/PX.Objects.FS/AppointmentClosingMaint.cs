...
namespace PX.Objects.FS
{
    public class AppointmentClosingMaint : AppointmentEntry
    {
        ...
        public PXSelect<FSAppointment,
                            ...
                            And<
                                FSAppointment.routeDocumentID, Equal<Optional<FSAppointment.routeDocumentID>>>>> ClosingAppointmentRecords;
        #endregion
        ...
        /// </summary>
        private bool AreServicesDBActionsAllowed(FSAppointment fsAppointmentRow)
        {
        ...
        /// </summary>
        private void AllowOrForbidServicesDBactions(FSAppointment fsAppointmentRow)
        {
            AppointmentDetServices.AllowInsert = AreServicesDBActionsAllowed(fsAppointmentRow);
            AppointmentDetServices.AllowDelete = AreServicesDBActionsAllowed(fsAppointmentRow);
            AppointmentDetServices.AllowUpdate = AreServicesDBActionsAllowed(fsAppointmentRow);
        }
        #endregion
        ...
        protected override void FSAppointment_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            ...
            AllowOrForbidServicesDBactions(fsAppointmentRow);
