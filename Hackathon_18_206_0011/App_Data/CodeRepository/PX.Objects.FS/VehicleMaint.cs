...
namespace PX.Objects.FS
{
    public class VehicleMaint : PXGraph<VehicleMaint, EPEquipment>
    {
        ...
        #endregion
        #region FSVehicle_SerialNumber
        [PXDBString(60, IsUnicode = true)]
        [PXUIField(DisplayName = "VIN")]
        public virtual void FSVehicle_SerialNumber_CacheAttached(PXCache sender)
        {
        }
        #endregion
        #region FSVehicle_RegistrationNbr
        [PXDBString(30, IsUnicode = true)]
        [PXUIField(DisplayName = "License Nbr.")]
        public virtual void FSVehicle_RegistrationNbr_CacheAttached(PXCache sender)
        {
        }
        #endregion
