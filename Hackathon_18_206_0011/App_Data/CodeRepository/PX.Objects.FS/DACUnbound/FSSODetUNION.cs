...
namespace PX.Objects.FS
{
    ...
    public class FSSODetUNION : FSSODet
    {
        ...
        [SiteAvail(typeof(FSSODetUNION.inventoryID), typeof(FSSODetUNION.subItemID), DisplayName = "Warehouse")]
        [PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
        ...
        [Location(typeof(FSSODetUNION.siteID), DescriptionField = typeof(INLocation.descr), DisplayName = "Location")]
