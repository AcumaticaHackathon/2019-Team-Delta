...
namespace PX.Objects.FS
{
    ...
    public class StaffSelectionFilter : IBqlTable
    {
        ...
        [PXDefault(typeof(Search<FSServiceOrder.postalCode, Where<FSServiceOrder.sOID, Equal<Current<FSServiceOrder.sOID>>>>))]
        ...
        public abstract class existContractEmployees : PX.Data.IBqlField
        {
        }
    ...
    public class SkillGridFilter : FSSkill
    {
        ...
        public abstract class mem_ServicesList : IBqlField
        {
        }
    ...
    public class LicenseTypeGridFilter : FSLicenseType
    {
        ...
        public abstract class mem_FromService : IBqlField
        {
        }
