...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentDetUNION : FSAppointmentDet
    {
        ...
        #endregion
        #region ApptLineNbr
        public new abstract class apptLineNbr : PX.Data.IBqlField
        {
        }
        ...
        [SiteAvail(typeof(FSAppointmentDetUNION.inventoryID), typeof(FSAppointmentDetUNION.subItemID), DisplayName = "Warehouse")]
        [PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
        ...
        [Location(typeof(FSAppointmentDetUNION.siteID), DescriptionField = typeof(INLocation.descr), DisplayName = "Location")]
