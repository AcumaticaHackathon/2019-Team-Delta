...
namespace PX.Objects.FS
{
    public class RouteMaint : PXGraph<RouteMaint, FSRoute>
    {
        ...
        /// </summary>
        private void EnableDisableDocument(PXCache cache, FSRoute fsRouteRow)
        {
        ...
        private bool isThereAnyActiveDay(FSRoute fsRouteRow)
        {
        ...
        private PXPersistingCheck EnableDisableDayPersistingCheck(bool enableForWeekDay)
        {
        ...
        /// </summary>
        private bool isRouteShortDuplicated(FSRoute fsRouteRow)
        {
        ...
        /// </summary>
        private void ValidateWeekCode(PXCache cache, FSRoute fsRouteRow)
        {
            List<object> weekCodeArgs = new List<object>();
                        ...
                        foreach (string charToCompare in charsInWeekCode)
                        {
                            if (SharedFunctions.IsAValidCharForWeekCode(charToCompare) == false)
                            {
                                cache.RaiseExceptionHandling<FSRoute.weekCode>(
                                    fsRouteRow,
                                    fsRouteRow.WeekCode,
                                    new PXSetPropertyException(PXMessages.LocalizeFormat(TX.Error.WEEKCODE_CHAR_NOT_ALLOWED, charToCompare), PXErrorLevel.Error));
                                errorOnWeekCode = true;
                                continue;
                            }
                        }
        ...
        /// </summary>
        private void CleanInactiveDayFields(FSRoute fsRouteRow)
        {
        ...
        protected virtual void FSRoute_ActiveOnMonday_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSRoute_ActiveOnTuesday_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSRoute_ActiveOnWednesday_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSRoute_ActiveOnThursday_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSRoute_ActiveOnFriday_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSRoute_ActiveOnSaturday_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSRoute_ActiveOnSunday_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSRoute_WeekCode_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            FSRoute fsRouteRow = (FSRoute)e.Row;
            ValidateWeekCode(cache, fsRouteRow);
        }

        protected virtual void FSRoute_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            EnableDisableDocument(cache, fsRouteRow);
        ...
        protected virtual void FSRoute_RowPersisting(PXCache cache, PXRowPersistingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            {
                cache.RaiseExceptionHandling<FSRoute.maxAppointmentQty>(
                    fsRouteRow,
                    null,
            ...
            {
                cache.RaiseExceptionHandling<FSRoute.routeShort>(
                    fsRouteRow,
                    null,
        ...
        #region FSRouteEmployeeEventHandlers
        ...
        protected virtual void FSRouteEmployee_RowPersisting(PXCache cache, PXRowPersistingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if (fsRouteEmployeeRow.PriorityPreference < 1)
            {
                ...
                throw new PXException(PXMessages.LocalizeFormat(TX.Error.MINIMUN_VALUE_NAME_FIELD, "Priority Option", 1), PXErrorLevel.Error);
            }
        }
        #endregion
    }
