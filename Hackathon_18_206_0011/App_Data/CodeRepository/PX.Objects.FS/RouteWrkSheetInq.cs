...
namespace PX.Objects.FS
{
    public class RouteWrkSheetInq : PXGraph<RouteWrkSheetInq>
    {
        ...
        public virtual void openRouteDocument()
        {
            if (Routes.Current != null)
            {
                ...
                graphRouteDocumentMaint.RouteRecords.Current = graphRouteDocumentMaint
                                                                .RouteRecords.Search<FSAppointment.refNbr>(
                                                                    Routes.Current.RefNbr);
        ...
        #region Route Document Event Handlers
        ...
        protected virtual void FSRouteDocument_DriverID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        /// </summary>
        public void UpdateRoute(FSRouteDocument fsRouteDocumentRow)
        {
