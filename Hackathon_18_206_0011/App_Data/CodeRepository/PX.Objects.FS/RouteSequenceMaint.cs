...
namespace PX.Objects.FS 
{
    public class RouteSequenceMaint : PXGraph<RouteSequenceMaint>
    {
        ...
        public PXSelectOrderBy<FSScheduleRoute,
                            OrderBy<
                                Asc<FSScheduleRoute.sortingIndex, Asc<FSScheduleRoute.scheduleID>>>>
                                    ServiceContracts;
        #endregion
        ...
        #region Delegate
        public IEnumerable serviceContracts()
        {
            ...
            int totalRows = 0;
            var list = scheduleRouteBase.View.Select(
                                                    PXView.Currents,
        ...
        protected virtual void ServiceContractsByRouteFilter_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
