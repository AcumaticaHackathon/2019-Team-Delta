...
namespace PX.Objects.FS
{
    public class CompleteRouteProcess : PXGraph<CompleteRouteProcess>
    {
        ...
        public partial class RouteFilter : IBqlTable
        {
            ...
            public abstract class showCompletedRoutes : PX.Data.IBqlField
            {
            }
        ...
        public PXFilteredProcessingJoin<FSRouteDocument, RouteFilter,
                             ...
                             Where2<
                                 ...
                                 And<
                                     Where2<
                                         Where<FSRouteDocument.status, Equal<FSRouteDocument.status.Open>,
        ...
        protected virtual void CompleteRoute(RouteDocumentMaint graphRouteDocumentMaint, FSRouteDocument fsRouteDocumentRow)
        {
