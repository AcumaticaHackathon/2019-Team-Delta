...
namespace PX.Objects.FS
{
    public class SMEquipmentMaint : PXGraph<SMEquipmentMaint, FSEquipment>
    {
            ...
            : base()
        {
            ...
            {
                throw new PXSetupNotEnteredException(TX.Error.EQUIPMENT_NUMBERING_SEQUENCE_MISSING_SETUP, typeof(FSSetup), TX.TableName.SETUP);
            }
        ...
        public PXSelect<FSEquipmentComponent,
               ...
               OrderBy<Asc<FSEquipmentComponent.lineNbr>>>
               EquipmentWarranties;
        ...
        public class RComponent : IBqlTable
        {
            ...
            public abstract class installationDate : PX.Data.IBqlField
            {
            }
        ...
        #region Methods
        private EPEquipment GetRelatedEPEquipmentRow(PXGraph graph, int? epEquipmentID)
        {
        ...
        /// </summary>
        private void EnableDisableVehicleControls(PXCache cache, FSEquipment fsEquipmentRow)
        {
        ...
        /// </summary>
        private void EnableDisableCache(PXCache cache, FSEquipment fsEquipmentRow)
        {
        ...
        /// </summary>
        private void EnableDisableEquipment(PXCache cache, FSEquipment fsEquipmentRow)
        {
        ...
        private bool AreThereAnyReplacements()
        {
        ...
        private void SetEquipmentPersistingChecksAndWarnings(PXCache cache, FSEquipment fsEquipmentRow, FSSetup fsSetupRow)
        {
            ...
            PXUIFieldAttribute.SetRequired<FSEquipment.inventoryID>(cache, fsEquipmentRow.OwnerType == ID.OwnerType_Equipment.CUSTOMER);
            ...
            PXDefaultAttribute.SetPersistingCheck<FSEquipment.inventoryID>(cache, fsEquipmentRow, ownerTypePersistingCheck);
        ...
        /// </summary>
        private void SetRequiredEquipmentTypeError(PXCache cache, FSEquipment fsEquipmentRow)
        {
        ...
        private void SetValuesFromInventoryItem(PXCache cache, FSEquipment fsEquipmentRow)
        {
        ...
        private void InsertEquipmentModelComponents(FSEquipment fsEquipmentRow, InventoryItem inventoryItemRow)
        {
            PXResultset<FSModelComponent> bqlResultSet =
        ...
        private void SetComponentPersistingChecksAndWarnings(PXCache cache, FSEquipmentComponent fsEquipmentComponentRow, FSSetup fsSetupRow)
        {
            PXSetPropertyException exception = null;
        ...
        private void VerifySource(PXCache cache, FSEquipment fsEquipmentRow)
        {
        ...
        private void EnableDisable_ActionButtons(PXCache cache, FSEquipment fsEquipmentRow)
        {
        ...
        private void OpenInquiry()
        {
            if (EquipmentRecords.Current != null && EquipmentRecords.Current.RefNbr != null)
            {
                ...
                throw new PXRedirectToGIWithParametersRequiredException(new Guid(TX.GenericInquiries_GUID.APPOINTMENT_DETAILS_HISTORY), parameters, PXBaseRedirectException.WindowMode.New);
            }
        }

        private void CalculateEndWarrantyDate(FSSetup fsSetupRow, FSEquipment fsEquipmentRow, FSEquipmentComponent fsEquipmentComponentRow, string warrantySource)
        {
            if (fsSetupRow == null)
            {
                return;
        ...
        private DateTime? GetComponentSalesDate(FSEquipment fsEquipmentRow, FSEquipmentComponent fsEquipmentComponentRow)
        {
        ...
        private DateTime? GetComponentInstallationDate(FSEquipment fsEquipmentRow, FSEquipmentComponent fsEquipmentComponentRow)
        {
            if (fsEquipmentRow == null && fsEquipmentComponentRow == null)
            {
                return null;
        ...
        private DateTime? GetWarrantyStartDate(
            DateTime? salesDate,
        ...
        private DateTime? GetWarrantyEndDate(DateTime? originalDate, DateTime? startDate, int? duration, string warrantyDurationType)
        {
        ...
        private void SetWarrantyBySource(FSEquipment fsEquipmentRow, FSEquipmentComponent fsEquipmentComponentRow, string warrantySource, DateTime? startDate)
        {
            switch (warrantySource)
            {
                case ID.WarratySource.COMPANY:
                    ...
                    if (fsEquipmentRow != null && fsEquipmentComponentRow == null)
                    {
                            fsEquipmentRow.CpnyWarrantyEndDate
                                                    = this.GetWarrantyEndDate(
                                                            fsEquipmentRow.CpnyWarrantyEndDate,
                                                            startDate,
                    ...
                    if (fsEquipmentComponentRow != null)
                    {
                        fsEquipmentComponentRow.CpnyWarrantyEndDate
                                                = this.GetWarrantyEndDate(
                                                        fsEquipmentComponentRow.CpnyWarrantyEndDate,
                                                        startDate,
                ...
                case ID.WarratySource.VENDOR:
                    if (fsEquipmentRow != null && fsEquipmentComponentRow == null)
                    {
                        fsEquipmentRow.VendorWarrantyEndDate
                                                = this.GetWarrantyEndDate(
                                                        fsEquipmentRow.VendorWarrantyEndDate,
                                                        startDate,
                    ...
                    if (fsEquipmentComponentRow != null)
                    {
                        fsEquipmentComponentRow.VendorWarrantyEndDate
                                                = this.GetWarrantyEndDate(
                                                        fsEquipmentComponentRow.VendorWarrantyEndDate,
                                                        startDate,
        ...
        private bool ItemBelongsToClass(int? inventoryID, int? itemClassID, out int? newItemClassID)
        {
        ...
        private void SetComponentValuesFromInventory(PXCache cache, FSEquipmentComponent fsEquipmentComponentRow)
        {
            if (fsEquipmentComponentRow == null ||
            ...
            if (inventoryItemRow != null)
            {
                ...
                POVendorInventory poVendorInventoryRow =
        ...
        private bool IsTheReplacementInfoValid()
        {
        ...
        public FSEquipmentComponent ApplyComponentReplacement(FSEquipmentComponent replacedCompt, FSEquipmentComponent replacementCompt)
        {
        ...
        private void VerifyQtyEquipmentComponents(PXCache cache, int? modelComponentID)
        {
            ...
            foreach (FSModelComponent fsModelComponentRow in modelComponents)
            {
                ...
                {
                    var EquipmentWarrantiesRows = EquipmentWarranties.Select()
        ...
        protected virtual void FSEquipment_InventoryID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            SetValuesFromInventoryItem(cache, fsEquipmentRow);
        }

        protected virtual void FSEquipment_LocationType_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipment_ManufacturerID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipment_ManufacturerModelID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            var fsManufacturerModelRow = (FSManufacturerModel)PXSelectorAttribute.Select<FSEquipment.manufacturerModelID>(cache, fsEquipmentRow, fsEquipmentRow.ManufacturerModelID);
        ...
        protected virtual void FSEquipment_DateInstalled_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipment_SalesDate_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipment_CpnyWarrantyValue_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipment_CpnyWarrantyType_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipment_VendorWarrantyValue_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipment_VendorWarrantyType_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipment_EquipmentTypeID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            FSEquipment fsEquipmentRow = (FSEquipment)e.Row;
            cache.SetDefaultExt<FSEquipment.equipmentTypeCD>(fsEquipmentRow);
        }

        protected virtual void FSEquipment_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipment_RowPersisting(PXCache cache, PXRowPersistingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected void FSEquipment_RowPersisted(PXCache cache, PXRowPersistedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipmentComponent_RowInserting(PXCache cache, PXRowInsertingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipmentComponent_InstallationDate_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipmentComponent_SalesDate_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipmentComponent_ComponentID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipmentComponent_CpnyWarrantyDuration_FieldVerifying(PXCache cache, PXFieldVerifyingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipmentComponent_CpnyWarrantyDuration_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipmentComponent_CpnyWarrantyType_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipmentComponent_VendorWarrantyDuration_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipmentComponent_VendorWarrantyType_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipmentComponent_ItemClassID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSEquipmentComponent_InventoryID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            this.SetComponentValuesFromInventory(cache, fsEquipmentComponentRow);   
        }

        protected virtual void FSEquipmentComponent_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            FSEquipmentComponent fsEquipmentComponentRow = (FSEquipmentComponent)e.Row;
            PXUIFieldAttribute.SetEnabled<FSEquipmentComponent.itemClassID>(cache, fsEquipmentComponentRow, fsEquipmentComponentRow.ItemClassID == null);
            SetComponentPersistingChecksAndWarnings(cache, fsEquipmentComponentRow, SetupRecord.Current);
        }
        #endregion
        #endregion
    }     
