...
namespace PX.Objects.FS
{
    public class RouteClosingMaint : PXGraph<RouteClosingMaint, FSRouteDocument>
    {
        ...
        /// </summary>
        private void EnableDisable_AdditionalInfoFields(PXCache cache, FSRouteDocument fsRouteDocumentRow)
        {
        ...
        private bool CloseAppointmentsInRoute(ref string errorMessage)
        {
            ...
            if (bqlResultSet.Count > 0)
            {
                ...
                if (appWithErrors.Count > 0)
                {
                    ...
                    errorMessage = PXMessages.LocalizeFormat(TX.Error.ROUTE_CANT_BE_CLOSED_APPOINTMENTS_IN_ROUTE_HAVE_ISSUES);
                }
            }
        ...
        protected virtual void FSRouteDocument_ActualEndTime_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            e.NewValue = SharedFunctions.GetCustomDateTime(Accessinfo.BusinessDate.Value, PXTimeZoneInfo.Now);
        }
