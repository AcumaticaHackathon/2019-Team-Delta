...
namespace PX.Objects.FS
{
    ...
    public class AppointmentInq : PXGraph<AppointmentInq>
    {
        ...
        public class AppointmentInqFilter : IBqlTable
        {
            ...
            [PXUIField(DisplayName = "Contract Nbr.", FieldClass = "FSCONTRACT")]
            [PXFormula(typeof(Default<AppointmentInqFilter.customerID>))]
            ...
            public abstract class staffMemberID : PX.Data.IBqlField
            {
            }
            ...
            public abstract class fromScheduledDate : PX.Data.IBqlField
            {
            }
            ...
            public abstract class toScheduledDate : PX.Data.IBqlField
            {
            }
        ...
        public PXSelectJoinGroupBy<FSAppointmentFSServiceOrder,
                    ...
                    Where2<
                        ...
                        Where<
                            ...
                            Or<
                                Where<Current<AppointmentInqFilter.serviceContractID>, Equal<FSAppointmentFSServiceOrder.serviceContractID>,
