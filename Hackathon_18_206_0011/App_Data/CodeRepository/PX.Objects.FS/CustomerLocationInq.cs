    ...
    public class CustomerLocationInq : PXGraph<CustomerLocationInq>
    {
        ...
        protected virtual IEnumerable Cancel(PXAdapter adapter)
        {
                ...
                && adapter.Searches.Length == 2 && adapter.Searches[0] != null)
            {
                ...
                {
                    PXResult<BAccount, Location> BaccountLocationResultSet = (PXResult < BAccount, Location>)PXSelectJoin<BAccount,
                                                                                                                InnerJoin<Location,
        ...
        public PXSelectReadonly2<FSAppointmentDetService,
                        InnerJoin<FSSODet,
                            On<
                                FSSODet.sODetID, Equal<FSAppointmentDetService.sODetID>>,
                        InnerJoin<FSAppointment,
                            On<
                                FSAppointment.appointmentID, Equal<FSAppointmentDetService.appointmentID>>,
                        InnerJoin<FSServiceOrder,
                            On<
                                FSServiceOrder.refNbr, Equal<FSAppointment.soRefNbr>>,
                        LeftJoin<FSPostDet,
                            On<
                                FSAppointmentDetService.postID, Equal<FSPostDet.postID>>,
        ...
        public PXSelectReadonly2<FSAppointmentInventoryItem,
                    InnerJoin<FSAppointment,
                        On<
                    ...
                    LeftJoin<FSPostDet,
                            On<
                                FSAppointmentInventoryItem.postID, Equal<FSPostDet.postID>>,
                    LeftJoin<FSPostBatch,
                            On<
                                FSPostBatch.batchID, Equal<FSPostDet.batchID>>>>>>,
                    Where<
                        FSAppointmentInventoryItem.lineType, Equal<ListField_LineType_Pickup_Delivery.Pickup_Delivery>,
                        And<FSServiceOrder.locationID, Equal<Current<BAccountLocation.locationID>>>>,
                    OrderBy<
        ...
        public virtual void openRouteServiceContract()
        {
            if (RouteContractSchedules.Current != null)
            {
                ...
                graphRouteServiceContractEntry.ServiceContractRecords.Current = (FSServiceContract)PXSelect<FSServiceContract,
                                                                                        Where<
