...
{	
    ...
    public class FSMasterContract : PX.Data.IBqlTable
	{
		...
		public abstract class masterContractCD : PX.Data.IBqlField
		{
		}
        [PXDBString(15, IsUnicode = true, IsKey = true, InputMask = ">CCCCCCCCCCCCCCC")]
		[PXDefault]
		[PXUIField(DisplayName = "Master Contract ID")]
        [PXSelector(typeof(FSMasterContract.masterContractCD),
                    new Type[]{
        ...
        [FSSelectorBAccountTypeCustomerOrCombinedAttribute]
