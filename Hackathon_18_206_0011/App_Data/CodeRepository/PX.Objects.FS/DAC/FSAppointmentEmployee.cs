...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentEmployee : PX.Data.IBqlTable
    {
        ...
        public abstract class serviceLineRef : PX.Data.IBqlField
        {
        }
        ...
        #endregion
        #region IsDriver
        public abstract class isDriver : PX.Data.IBqlField
        {
        }
        ...
        #region EarningType
        public abstract class earningType : PX.Data.IBqlField
        {
        }

        [PXDBString(2, IsFixed = true, IsUnicode = false, InputMask = ">LL")]
        [PXDefault(typeof(Coalesce<Search2<FSxService.dfltEarningType, 
                            InnerJoin<FSAppointmentDet, On<FSAppointmentDet.lineRef, Equal<Current<FSAppointmentEmployee.serviceLineRef>>>>,
        ...
        #endregion
        #region TrackTime
        public abstract class trackTime : PX.Data.IBqlField
        {
        }
        ...
        #region ApprovedTime
        public abstract class approvedTime : PX.Data.IBqlField
        {
        }
        ...
        #endregion
        #region TimeCardCD
        public abstract class timeCardCD : PX.Data.IBqlField
        {
        }
        ...
        #endregion
        #region LaborItem
        public abstract class laborItemID : PX.Data.IBqlField
        {
        }
        ...
        #region Mem_Selected
        public abstract class mem_Selected : IBqlField
        {
        }
        ...
        public abstract class actualDurationReport : PX.Data.IBqlField
        {
        }
