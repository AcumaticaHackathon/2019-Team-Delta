...
namespace PX.Objects.FS
{
    ...
    public class FSCustomerBillingSetup : PX.Data.IBqlTable
    {
        ...
        [PXDefault(typeof(FSSetup.dfltSrvOrdType), PersistingCheck = PXPersistingCheck.Nothing)]
        [FSSelectorSrvOrdTypeNOTQuoteInternal]
        [PXUIField(DisplayName = "Service Order Type")]
        [PXCheckUnique(Where = typeof(Where<FSCustomerBillingSetup.customerID, Equal<Current<Customer.bAccountID>>,
