...
namespace PX.Objects.FS
{
    ...
    public class FSStaffSchedule : FSSchedule
	{
        ...
        public abstract class staffScheduleDescription : PX.Data.IBqlField
        {
        }
        ...
        public abstract class mem_StartTime_Time : PX.Data.IBqlField
        {
        }
        ...
        public abstract class mem_EndTime_Time : PX.Data.IBqlField
        {
        }
        ...
        #region StartTimeUTC
        public abstract class startTimeUTC : PX.Data.IBqlField
        {
        }
        ...
        #region EndTimeUTC
        public abstract class endTimeUTC : PX.Data.IBqlField
        {
        }

        [PXDBDateAndTime(UseTimeZone = false, PreserveTime = true, DisplayNameTime = "End Time")]
        [PXUIField(DisplayName = "End Time")]
