...
namespace PX.Objects.FS
{
    ...
    public class FSBillingCycle : PX.Data.IBqlTable
    {
        ...
        [PXUIField(DisplayName = "Group Invoices By")]
        ...
        [PXDBBool]
        [PXDefault(false)]
        [PXUIField(DisplayName = "Generate Invoices for Only Completed or Closed Service Orders")]
        ...
        [PXDBString(2, IsFixed = true)]
        [PXUIField(DisplayName = "Generate Invoices From")]
        ...
        [PXDBBool]
        [PXDefault(false)]
        [PXUIField(DisplayName = "Separate Generation of Invoices by Customer Locations")]
