...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentDet : IBqlTable, IFSSODetBase, IDocLine
    {
        ...
        #endregion
        #region ApptLineNbr
        public abstract class apptLineNbr : PX.Data.IBqlField
        {
        }
        ...
        [SiteAvail(typeof(FSAppointmentDet.inventoryID), typeof(FSAppointmentDet.subItemID), DisplayName = "Warehouse")]
        [PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
        ...
        public abstract class expenseEmployeeID : PX.Data.IBqlField
        {
        }
        ...
        public abstract class actualDuration : PX.Data.IBqlField
        {
        }
        ...
        public abstract class sourceSalesOrderRefNbr : PX.Data.IBqlField
        {
        }
        ...
        public abstract class sourceSalesOrderType : PX.Data.IBqlField
        {
        }
        ...
        public abstract class staffActualDuration : PX.Data.IBqlField
        {
        }
        ...
        #endregion
        #region StaffRelated
        public abstract class staffRelated : PX.Data.IBqlField
        {
        }
        ...
        public abstract class auxEstimatedDuration : PX.Data.IBqlField
        {
        }
        ...
        public abstract class auxActualDuration : PX.Data.IBqlField
        {
        }
        ...
        public abstract class inventoryIDReport : PX.Data.IBqlField
        {
        }
        ...
        public abstract class staffRelatedCount : PX.Data.IBqlField
        {
        }
