...
namespace PX.Objects.FS
{
    ...
    [PXProjection(typeof(Select<FSSODet,
                        Where<
                            FSSODet.lineType, Equal<ListField_LineType_ALL.Inventory_Item>,
    ...
    public class FSSODetPart : FSSODet
    {
        ...
        [PXParent(typeof(Select<FSServiceOrder,
                            Where<FSServiceOrder.srvOrdType, Equal<Current<FSSODetPart.srvOrdType>>,
                                And<FSServiceOrder.refNbr, Equal<Current<FSSODetPart.refNbr>>>>>))]
        ...
        [PXFormula(typeof(Selector<FSSODetPart.operation, SOOrderTypeOperation.iNDocType>))]
        ...
        [PXFormula(typeof(Selector<FSSODetPart.inventoryID, Switch<
        ...
        [PXFormula(typeof(Selector<FSSODetPart.inventoryID, InventoryItem.stkItem>))]
        ...
        [PXFormula(typeof(Selector<FSSODetPart.inventoryID, InventoryItem.kitItem>))]
        ...
        [PXDefault(typeof(Search<InventoryItem.defaultSubItemID,
                            Where<
                                InventoryItem.inventoryID, Equal<Current<FSSODetPart.inventoryID>>,
        ...
        [PXUIRequired(typeof(IIf<Where<
                                    lineType, NotEqual<lineType.Comment_Part>,
                                    And<lineType, NotEqual<lineType.Instruction_Part>>>, True, False>))]
        ...
        [SOLocationAvail(typeof(FSSODetPart.inventoryID), typeof(FSSODetPart.subItemID), typeof(FSSODetPart.siteID), typeof(FSSODetPart.tranType), typeof(FSSODetPart.invtMult))]
        ...
        [SOLotSerialNbr(typeof(FSSODetPart.inventoryID), typeof(FSSODetPart.subItemID), typeof(FSSODetPart.siteLocationID), PersistingCheck = PXPersistingCheck.Nothing)]
        ...
        [PXDBBool]
        [PXFormula(typeof(Default<FSSODetPart.billingRule, FSSODetPart.SMequipmentID, FSSODetPart.estimatedQty, FSSODetPart.inventoryID>))]
        ...
        [PXUnboundFormula(typeof(Switch<
                                    Case<Where<
                                            lineType, Equal<ListField_LineType_ALL.Service>,
        ...
        [PXDBQuantity(typeof(FSSODetPart.uOM), typeof(FSSODetPart.baseEstimatedQty))]
        ...
        [PXQuantity(typeof(FSSODetPart.uOM), typeof(FSSODetPart.baseOrderQty))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        [PXDBQuantity(typeof(FSSODetPart.uOM), typeof(FSSODetPart.baseOpenQty), MinValue = 0)]
        ...
        [PXQuantity(typeof(FSSODetPart.uOM), typeof(FSSODetPart.baseClosedQty))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        [PXDBQuantity(typeof(FSSODetPart.uOM), typeof(FSSODetPart.baseShippedQty), MinValue = 0)]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        [PXDBQuantity(typeof(FSSODetPart.uOM), typeof(FSSODetPart.baseBillableQty))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        [PXFormula(typeof(Default<FSSODetPart.isBillable>))]
        [PXFormula(typeof(Switch<
                                Case<
                                    Where<
                                        FSSODetPart.isPrepaid, Equal<True>>,
                                    SharedClasses.decimal_0,
                                Case<
                                    Where<
                                        FSSODetPart.status, Equal<FSSODet.status.Canceled>>,
                                    SharedClasses.decimal_0,
                                Case<Where<
                                        FSSODetPart.contractRelated, Equal<True>>,
                                    FSSODetPart.extraUsageQty>>>,
                            FSSODetPart.estimatedQty>))]
        [PXFormula(typeof(Switch<
                                Case<
                                    Where<
                                        FSSODetPart.isPrepaid, Equal<True>>,
        ...
        [FSSelectorActive_AR_SO_ProjectTask(typeof(Where<PMTask.projectID, Equal<Current<FSSODetPart.projectID>>>))]
        ...
        [PXFormula(typeof(Default<FSSODetPart.acctID>))]
        [PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
        [SubAccount(typeof(FSSODetPart.acctID), Visibility = PXUIVisibility.Visible, DescriptionField = typeof(Sub.description), Visible = false)]
        ...
        [PXDefault(typeof(Search<INItemSiteSettings.preferredVendorID,
            Where<INItemSiteSettings.inventoryID, Equal<Current<FSSODetPart.inventoryID>>, And<INItemSiteSettings.siteID, Equal<Current<FSSODetPart.siteID>>>>>),
            PersistingCheck = PXPersistingCheck.Nothing)]
        [PXFormula(typeof(Default<FSSODetPart.enablePO>))]
        ...
        [PXFormula(typeof(Default<FSSODetPart.poVendorID>))]
        [PXDefault(typeof(Coalesce<
            Search<INItemSiteSettings.preferredVendorLocationID,
            Where<INItemSiteSettings.inventoryID, Equal<Current<FSSODetPart.inventoryID>>,
                    And<INItemSiteSettings.preferredVendorID, Equal<Current<FSSODetPart.poVendorID>>>>>,
            Search2<Vendor.defLocationID,
                ...
                Where<Vendor.bAccountID, Equal<Current<FSSODetPart.poVendorID>>,
                    And<CRLocation.isActive, Equal<True>, And<MatchWithBranch<CRLocation.vBranchID>>>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
        [LocationID(typeof(Where<Location.bAccountID, Equal<Current<FSSODetPart.poVendorID>>,
                            And<MatchWithBranch<Location.vBranchID>>>),
                DescriptionField = typeof(Location.descr), Visibility = PXUIVisibility.SelectorVisible, DisplayName = "Vendor Location ID")]
        ...
        [PXFormula(typeof(Default<FSSODetPart.contractRelated>))]
        ...
        [PXFormula(typeof(Switch<
                                ...
                                Case<
                                    Where<
                                        ...
                                        And<lineType, Equal<ListField_LineType_ALL.Service>,
                                        And<billingRule, Equal<billingRule.None>>>>,
                                    SharedClasses.decimal_0,
                                Case<
                                    Where<
        ...
        [FSSelectorComponentIDServiceOrder(typeof(FSSODetPart), typeof(FSSODetPart))]
        ...
        [PXDefault(typeof(Search<InventoryItem.taxCategoryID,
            Where<InventoryItem.inventoryID, Equal<Current<FSSODetPart.inventoryID>>>>),
            PersistingCheck = PXPersistingCheck.Nothing)]
        [PXFormula(typeof(Default<inventoryID>))]
        ...
        [INExpireDate(typeof(FSSODetPart.inventoryID), PersistingCheck = PXPersistingCheck.Nothing)]
        ...
        [PXDBPriceCost()]
        [PXDefault(TypeCode.Decimal, "0.0", typeof(Search<INItemSite.tranUnitCost, Where<INItemSite.inventoryID, Equal<Current<FSSODetPart.inventoryID>>, And<INItemSite.siteID, Equal<Current<FSSODetPart.siteID>>>>>))]
