...
namespace PX.Objects.FS
{
    ...
    public class FSSODetSplit : PX.Data.IBqlTable, ILSDetail
    {
        ...
        [PXParent(typeof(Select<FSSODetPart, Where<FSSODetPart.srvOrdType, Equal<Current<FSSODetSplit.srvOrdType>>, And<FSSODetPart.refNbr, Equal<Current<FSSODetSplit.refNbr>>, And<FSSODetPart.lineNbr, Equal<Current<FSSODetSplit.lineNbr>>>>>>))]
        ...
        [PXFormula(typeof(Switch<Case<Where<FSSODetSplit.isAllocated, Equal<False>>, Current<FSSODetPart.siteID>>, FSSODetSplit.siteID>))]
        ...
        [SOLotSerialNbr(typeof(FSSODetSplit.inventoryID), typeof(FSSODetSplit.subItemID), typeof(FSSODetSplit.locationID), typeof(FSSODetPart.lotSerialNbr), PersistingCheck = PXPersistingCheck.Nothing, FieldClass = "LotSerial")]
        ...
        //[PXFormula(null, typeof(SumCalc<FSSODetPart.shippedQty>))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        [PXDBBool()]
        [PXDefault()]
        [PXFormula(typeof(Switch<Case<Where<FSSODetSplit.isAllocated, Equal<False>, And<FSSODetSplit.pOReceiptNbr, IsNull>>, Current<FSSODetPart.pOCreate>>, False>))]
        ...
        [PXDBString()]
        [PXFormula(typeof(Switch<Case<Where<FSSODetSplit.isAllocated, Equal<False>>, Current<FSSODetPart.pOSource>>, Null>))]
        ...
        [PXDBInt()]
        [PXFormula(typeof(Switch<Case<Where<FSSODetSplit.isAllocated, Equal<False>>, Current<FSSODetPart.vendorID>>, Null>))]
        ...
        [PXDBInt()]
        [PXFormula(typeof(Switch<Case<Where<FSSODetSplit.isAllocated, Equal<False>>, Current<FSSODetPart.pOSiteID>>, Null>))]
