...
namespace PX.Objects.FS
{
    ...
    public static class Path
    {
        ...
        public static class Messages
        {
            ...
            public const string SUCCESS_SALES_ORDER = "Sales Order <*> is created.";
            ...
            public static class FSOpen
            {
                ...
                public static class Action
                {
                    ...
                    public class AllowInvoiceServiceOrder : PXQuickProcess.Step.IDefinition
                    {
                        ...
                        public String StepID => GroupStepID;
                        public String ActionID => GroupActionID;
                        public String MenuID => "Allow Invoice";
                        public String OnSuccessMessage => "";
                        public String OnFailureMessage => "";
                    }
        ...
        public static class FS300100
        {
            ...
            public static class SrvOrdOpen
            {
                ...
                public class AllowInvoice : PXQuickProcess.Step.IDefinition
                {
                    public Type Graph => GroupGraph;
                    public String StepID => GroupStepID;
                    public String ActionID => nameof(AllowInvoice);
                    public String MenuID => "Allow Invoice";
                ...
                public class InvoiceOrder : PXQuickProcess.Step.IDefinition
                {
                    ...
                    public String MenuID => "Generate Invoice";
                    public String OnSuccessMessage => Messages.SUCCESS_SALES_ORDER;
                    public String OnFailureMessage => Messages.FAILURE;
                }
            }
    ...
    public class FSQuickProcessParameters : PX.Data.IBqlTable
    {
        ...
        public abstract class allowInvoiceServiceOrder : PX.Data.IBqlField
        {
        }
        ...
        public abstract class completeServiceOrder : PX.Data.IBqlField
        {
        }
        ...
        public abstract class closeAppointment : PX.Data.IBqlField
        {
        }
        ...
        public abstract class closeServiceOrder : PX.Data.IBqlField
        {
        }
        ...
        public abstract class emailSignedAppointment : PX.Data.IBqlField
        {
        }
        ...
        public abstract class generateInvoiceFromAppointment : PX.Data.IBqlField
        {
        }
        ...
        [PXUIField(DisplayName = "Generate Invoice")]
        public virtual bool? GenerateInvoiceFromAppointment { get; set; }
        #endregion
        #region GenerateInvoiceFromServiceOrder
        public abstract class generateInvoiceFromServiceOrder : PX.Data.IBqlField
        {
        }
        ...
        public abstract class generateInvoice : PX.Data.IBqlField
        {
        }
    ...
    public class FSSrvOrdQuickProcessParams : SOQuickProcessParameters
    {
        ...
        public abstract class srvOrdType : IBqlField { }
        #endregion
        #region AllowInvoiceServiceOrder
        public abstract class allowInvoiceServiceOrder : PX.Data.IBqlField
        {
        ...
        [PXQuickProcess.Step.IsBoundTo(typeof(Path.FS300100.SrvOrdOpen.AllowInvoice), true)]
        [PXQuickProcess.Step.IsStartPoint(typeof(TrueCondition))]
        ...
        public new abstract class createShipment : IBqlField { }
        ...
        public new abstract class siteCD : IBqlField { }
        #endregion
        #endregion
        #endregion
        ...
        public new abstract class confirmShipment : IBqlField { }
        #endregion
        #region UpdateIN
        ...
        public override bool? UpdateIN { get {
            ...
            set {
                _updateIN = value;  } }
        public new abstract class updateIN : IBqlField { }
        #endregion
        ...
        public new abstract class prepareInvoiceFromShipment : IBqlField { }
        #endregion
        #region PrepareInvoice
        ...
        public new abstract class prepareInvoice : IBqlField { }
        #endregion
        #region EmailInvoice
        ...
        public new abstract class emailInvoice : IBqlField { }
        #endregion
        #region ReleaseInvoice
        ...
        public new abstract class releaseInvoice : IBqlField { }
        #endregion
        #region AutoRedirect
        ...
        public new abstract class autoRedirect : IBqlField { }
        #endregion
        ...
        public new abstract class autoDownloadReports : IBqlField { }
        #endregion
    }
