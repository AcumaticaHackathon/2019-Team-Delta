...
namespace PX.Objects.FS
{
    ...
    [PXProjection(typeof(
            Select2<FSServiceOrder,
                ...
                Where2<
                    Where<
                        FSServiceOrder.status, NotEqual<ListField_Status_ServiceOrder.Canceled>,
                        And<FSServiceOrder.status, NotEqual<ListField_Status_ServiceOrder.Hold>,
                        And<FSServiceOrder.status, NotEqual<ListField_Status_ServiceOrder.Quote>,
                    ...
                    And<
                        Where<
                            FSBillingCycle.invoiceOnlyCompletedServiceOrder, Equal<False>,
                            Or<
                                Where<
                                    FSBillingCycle.invoiceOnlyCompletedServiceOrder, Equal<True>,
                                    And<
                                        Where<
                                            FSServiceOrder.status, Equal<ListField_Status_ServiceOrder.Completed>,
    ...
    public class ServiceOrderToPost : FSServiceOrder, IPostLine
    {
        ...
        public abstract class groupBillByLocations : PX.Data.IBqlField
        {
        }
        ...
        public abstract class billingCycleCD : PX.Data.IBqlField
        {
        }
        ...
        public abstract class invoiceOnlyCompletedServiceOrder : PX.Data.IBqlField
        {
        }
        ...
        public abstract class timeCycleDayOfMonth : PX.Data.IBqlField
        {
        }
        ...
        #endregion
        #region ErrorFlag
        public abstract class errorFlag : PX.Data.IBqlField
        {
        }
