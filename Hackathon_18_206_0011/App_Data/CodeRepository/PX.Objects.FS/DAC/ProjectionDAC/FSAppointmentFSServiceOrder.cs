...
namespace PX.Objects.FS
{
    ...
    public partial class FSAppointmentFSServiceOrder : FSAppointment
    {
        ...
        [PXUIField(DisplayName = "Source Service Contract Nbr.", Enabled = false, Visible = false, FieldClass = "FSCONTRACT")]
        ...
        public new abstract class billServiceContractID : PX.Data.IBqlField
        {
        }
        ...
        [PXSelector(typeof(Search<FSServiceContract.serviceContractID,
                           Where<
                                FSServiceContract.customerID, Equal<Current<FSAppointmentFSServiceOrder.customerID>>>>),
                           SubstituteKey = typeof(FSServiceContract.refNbr))]
        [PXUIField(DisplayName = "Service Contract Nbr.", Enabled = false, Visible = false)]
        public override int? BillServiceContractID { get; set; }
        #endregion
        #region ScheduledDateTimeBegin
        public new abstract class scheduledDateTimeBegin : PX.Data.IBqlField
        {
        }

        [PXDBDateAndTime(UseTimeZone = true, PreserveTime = true, DisplayNameDate = "Scheduled Date", DisplayNameTime = "Scheduled Time", BqlField = typeof(FSAppointment.scheduledDateTimeBegin))]
        ...
        public new abstract class scheduledDateTimeEnd : PX.Data.IBqlField
        {
        }
        ...
        public new abstract class estimatedDurationTotal : PX.Data.IBqlField
        {
        }
        ...
        public new abstract class actualDurationTotal : PX.Data.IBqlField
        {
        }
        ...
        public new abstract class waitingForParts : PX.Data.IBqlField
        {
        }
        ...
        [PXDBBool(BqlField = typeof(FSServiceOrder.addressValidated))]
        ...
        [PXDBInt(BqlField = typeof(FSServiceOrder.causeID))]
        [PXUIField(DisplayName = "Cause ID")]
        ...
        [PXDBString(2, IsUnicode = true, BqlField = typeof(FSServiceOrder.countryID))]
        ...
        #endregion
        #region DocDesc
        public abstract class soDocDesc : PX.Data.IBqlField
        {
        }
        ...
        [PXDBEmail(BqlField = typeof(FSServiceOrder.eMail))]
        ...
        [PXDBString(50, BqlField = typeof(FSServiceOrder.fax))]
        ...
        [PXDBString(50, BqlField = typeof(FSServiceOrder.phone1))]
        ...
        [PXDBString(50, BqlField = typeof(FSServiceOrder.phone2))]
        ...
        [PXDBString(50, BqlField = typeof(FSServiceOrder.phone3))]
        ...
        [PXDBDate(BqlField = typeof(FSServiceOrder.promisedDate))]
        ...
        [PXDBDate(BqlField = typeof(FSServiceOrder.resolutionDate))]
        ...
        [PXDBInt(BqlField = typeof(FSServiceOrder.resolutionID))]
        [PXUIField(DisplayName = "Resolution ID")]
        ...
        #endregion*/
        #region PostedBy
        public abstract class postedBy : PX.Data.IBqlField
        {
        }
