...
namespace PX.Objects.FS
{
    ...
    [PXProjection(typeof(
        Select5<FSServiceContract,
                  ...
                  Where<FSContractPeriod.invoiced, Equal<False>,
                    And2<
    ...
    public partial class ContractPeriodToPost : IBqlTable
    {
        ...
        [PXUIField(DisplayName = "Contract Nbr.", Enabled = true, Visibility = PXUIVisibility.SelectorVisible, Visible = true)]
        ...
        public abstract class endPeriodDate : IBqlField, IBqlOperand
        {
        }
        ...
        public abstract class startPeriodDate : IBqlField, IBqlOperand
        {
        }
        ...
        public abstract class billingPeriod : IBqlField, IBqlOperand
        {
        }
