...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentScheduleBoard : IBqlTable
    {
        ...
        [PXDBString(255, BqlField = typeof(FSBranchLocation.descr))]
        ...
        #region ServiceOrderPhone
        public abstract class serviceOrderPhone : PX.Data.IBqlField
        {
        }

        [PXDBString(50, IsFixed = true, BqlField = typeof(FSServiceOrder.phone1))]
        [PXUIField(DisplayName = "Service Order Phone")]
        public virtual string ServiceOrderPhone { get; set; }
        #endregion
        #region ServiceOrderEmail
        public abstract class serviceOrderEmail : PX.Data.IBqlField
        {
        }

        [PXDBString(50, IsFixed = true, BqlField = typeof(FSServiceOrder.eMail))]
        [PXUIField(DisplayName = "Service Order Email")]
        public virtual string ServiceOrderEmail { get; set; }
        #endregion
        ...
        [PXDBString(50, IsFixed = true, BqlField = typeof(Contact.displayName))]
        ...
        [PXDBString(50, IsFixed = true, BqlField = typeof(Contact.phone1))]
        ...
        [PXDBString(50, IsFixed = true, BqlField = typeof(Contact.eMail))]
        ...
        public abstract class customerLocation : PX.Data.IBqlField
        {
        }
        ...
        #endregion
        #region LocationDesc
        public abstract class locationDesc : PX.Data.IBqlField
        {
        }
        ...
        #endregion
        #region RoomDesc
        public abstract class roomDesc : PX.Data.IBqlField
        {
        }
        ...
        public abstract class firstServiceDesc : PX.Data.IBqlField
        {
        }
        ...
        public abstract class appointmentCustomID : PX.Data.IBqlField
        {
        }
        ...
        public abstract class oldEmployeeID : PX.Data.IBqlField
        {
        }
        ...
        public abstract class employeeCount : PX.Data.IBqlField
        {
        }
        ...
        #region AttendeeCount
        public abstract class attendeeCount : PX.Data.IBqlField
        {
        }
