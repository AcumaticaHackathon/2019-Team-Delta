...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentStaffScheduleBoard : FSAppointmentScheduleBoard
    {
        ...
        {
            FSAppointmentStaffScheduleBoard fsAppointmentClone = (FSAppointmentStaffScheduleBoard)MemberwiseClone();
            return fsAppointmentClone;
        }

        #region EmployeeID
        public new abstract class employeeID : PX.Data.IBqlField
        {
        }
