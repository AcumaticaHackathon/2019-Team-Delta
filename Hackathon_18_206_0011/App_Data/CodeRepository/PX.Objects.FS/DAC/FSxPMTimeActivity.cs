...
namespace PX.Objects.FS
{
    ...
    public class FSxPMTimeActivity : PXCacheExtension<PMTimeActivity>
    {
        ...
        public abstract class appointmentCustomerID : PX.Data.IBqlField
        {
        }

        [PXDBInt]
        [PXUIField(DisplayName = "Customer ID")]
        [FSSelectorCustomerAttribute]
        ...
        #endregion
        #region AppEmpID
        public abstract class appEmpID : PX.Data.IBqlField
        {
        }
        ...
        #region MemoryHelper
        #region LastBillable
        public abstract class lastBillable : PX.Data.IBqlField
        {
        }
