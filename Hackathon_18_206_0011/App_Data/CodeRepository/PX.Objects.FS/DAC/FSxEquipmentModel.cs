...
namespace PX.Objects.FS
{
    ...
    public class FSxEquipmentModel : PXCacheExtension<InventoryItem>
    {
        ...
        #region EQEnabled
        public abstract class eQEnabled : IBqlField
        {
        }
        ...
        public abstract class ChkEquipmentManagement : PX.Data.IBqlField
        {
        }
        ...
        public abstract class mem_ShowComponent : IBqlField
        {
        }
