...
namespace PX.Objects.FS
{
	...
	public class FSContractGenerationHistory : PX.Data.IBqlTable
    {
        ...
        public abstract class contractGenerationHistoryID : PX.Data.IBqlField
		{
		}
        ...
        public abstract class lastProcessedDate : PX.Data.IBqlField
        {
        }
        [PXDBDate]
        ...
        public abstract class previousGeneratedElementDate : PX.Data.IBqlField
        {
        }
        [PXDBDate]
        ...
        public abstract class previousProcessedDate : PX.Data.IBqlField
        {
        }
        [PXDBDate]
