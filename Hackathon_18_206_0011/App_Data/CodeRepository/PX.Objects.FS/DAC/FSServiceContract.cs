...
namespace PX.Objects.FS
 {
     ...
     [PXCacheName(TX.TableName.SERVICE_CONTRACTS)]
     [PXPrimaryGraph(
            new Type[] {
     ...
     public class FSServiceContract : PX.Data.IBqlTable
     {
        ...
        [PXUIField(DisplayName = "Contract Nbr.", Visibility = PXUIVisibility.SelectorVisible, Visible = true, Enabled = true)]
        [FSSelectorServiceContract(typeof(FSServiceContract.refNbr), typeof(ListField_RecordType_ContractSchedule.ServiceContract), typeof(FSServiceContract.customerID))]
