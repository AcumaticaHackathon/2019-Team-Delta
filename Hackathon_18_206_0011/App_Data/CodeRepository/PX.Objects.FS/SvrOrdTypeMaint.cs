...
namespace PX.Objects.FS
{
    public class SvrOrdTypeMaint : PXGraph<SvrOrdTypeMaint, FSSrvOrdType>
    {
        ...
        private void SetPostingSettingVisibility(PXCache cache, FSSrvOrdType fsSrvOrdTypeRow, bool isVisible)
        {
            ...
            PXUIFieldAttribute.SetVisible<FSSrvOrdType.enableINPosting>(cache, fsSrvOrdTypeRow, isVisible);
            ...
            PXUIFieldAttribute.SetVisible<FSSrvOrdType.allocationOrderType>(cache, fsSrvOrdTypeRow, isVisible && isDistributionModuleInstalled && fsSrvOrdTypeRow.PostTo == ID.SrvOrdType_PostTo.SALES_ORDER_MODULE);
            PXUIFieldAttribute.SetVisible<FSSrvOrdType.allowQuickProcess>(cache, fsSrvOrdTypeRow, fsSrvOrdTypeRow.PostTo == ID.SrvOrdType_PostTo.SALES_ORDER_MODULE);
        ...
        public virtual void FSSrvOrdType_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            ...
            PXDefaultAttribute.SetPersistingCheck<FSSrvOrdType.allocationOrderType>(cache, fsSrvOrdTypeRow, fsSrvOrdTypeRow.PostTo == ID.SrvOrdType_PostTo.SALES_ORDER_MODULE ? PXPersistingCheck.NullOrBlank : PXPersistingCheck.Nothing);
        }
