...
namespace PX.Objects.FS
{
    ...
    public class FSSelectorServiceContractAttribute : PXSelectorAttribute
    {
        public FSSelectorServiceContractAttribute(Type serviceContractField, Type serviceContract_RecordType, Type CurrentCustomer)
            : this(serviceContractField, serviceContract_RecordType, CurrentCustomer, typeof(Where<True, Equal<True>>))
        {
        }

        public FSSelectorServiceContractAttribute(Type serviceContractField, Type serviceContract_RecordType, Type CurrentCustomer, Type Where)
            : base(
                    BqlCommand.Compose(
                                        typeof(Search2<,,,>),
    ...
    public class FSSelectorSalesOrderSrvOrdType : PXSelectorAttribute
    {
        public FSSelectorSalesOrderSrvOrdType()
            : base(
                typeof(
                    Search<FSSrvOrdType.srvOrdType,
                    Where<
                        FSSrvOrdType.active, Equal<True>,
                        And<FSSrvOrdType.requireContact, Equal<False>>>>))
        {
            DescriptionField = typeof(FSSrvOrdType.descr);
        }
    }
                            ...
                            typeof(And<>),
                                typeof(Where2<,>),
                                    ...
                                    typeof(Or<>),
                                        typeof(Where2<,>),
                                            typeof(Where<,,>),
                                                /* Begin - Internal Appointments case */
                                                ...
                                                /* End - Internal Appointments case */
                                        typeof(Or<>),
                                            typeof(Where<,,>),
                                                /* Not internal Appointments case */
                                                typeof(FSSrvOrdType.srvOrdType), typeof(NotEqual<FSSrvOrdType.behavior.InternalAppointment>),
                                                typeof(And<>),
                                                    typeof(Where<,,>),
                                                            ...
                                                            typeof(And<>),
                                                                ...
                                                                typeof(And2<,>),
                                                                    typeof(Where2<,>),
                                                                        ...
                                                                        typeof(Or<>),
                                                                            typeof(Where<FSEquipment.customerLocationID, IsNull>),
                                                                typeof(And<>),
                                                                    typeof(Where2<,>),
                                                                        typeof(Where<,,>),
