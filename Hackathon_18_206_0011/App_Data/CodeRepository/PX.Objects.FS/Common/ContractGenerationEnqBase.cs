...
namespace PX.Objects.FS
{
    public class ContractGenerationEnqBase<TGraph, TPrimary, TFiltering, TRecordType> : PXGraph<TGraph>
        ...
        where TRecordType : Constant<string>, new()
    {
        ...
        protected void createServiceOrder(TimeSlot timeSlotServiceOrder, bool createAppointmentFlag = false, bool appointmentsBelongToRoute = false)
        {
            ...
            // therefore their ServiceOrders MUST be created in base currency
            if (PXAccess.FeatureInstalled<FeaturesSet.multicurrency>())
            {
                graphServiceOrderEntry.ServiceOrderRecords.Cache.SetValueExt<FSServiceOrder.curyID>(fsServiceOrderRow, this.Accessinfo.BaseCuryID ?? new PXSetup<PX.Objects.GL.Company>(this).Current?.BaseCuryID);
            }
        ...
        public PXSelectJoin<FSScheduleDetService,
                                ...
                                And<
                                    Where<
                                        ...
                                        Or<FSScheduleDetService.lineType, Equal<ListField_LineType_Service_ServiceContract.NonStockItem>>>>>>>>> ScheduleServicesSelected;
        ...
        public PXSelectJoin<FSScheduleDetPart,
                                ...
                                And<
                                    Where<
                                        ...
                                        Or<FSScheduleDetPart.lineType, Equal<ListField_LineType_Part_ALL.Instruction_Part>>>>>>> SchedulePartsSelected;
