    ...
    public class RouteAppointmentAssignmentHelper
    {
        ...
        public class RouteRecords_View : PXSelectJoin<FSRouteDocument,
                                         ...
                                         Where<
                                                ...
                                                And<
                                                    Where<Current<RouteAppointmentAssignmentFilter.routeID>, IsNull,
                                                    Or<FSRouteDocument.routeID, Equal<Current<RouteAppointmentAssignmentFilter.routeID>>>>>>>
        {
                    ...
                    FSAppointmentEmployee fsAppointmentEmployeeRow = PXSelect<FSAppointmentEmployee,
                                                                     Where<
                                                                        FSAppointmentEmployee.appointmentID, 
                                                                            Equal<Required<FSAppointmentEmployee.appointmentID>>,
                                                                        And<FSAppointmentEmployee.isDriver, Equal<True>>>>
