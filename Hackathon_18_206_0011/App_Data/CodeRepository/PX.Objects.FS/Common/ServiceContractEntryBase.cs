...
namespace PX.Objects.FS
{
        ...
        where Where : class, IBqlWhere, new()
    {
        ...
        public PXSelect<FSServiceContract, 
                    Where<FSServiceContract.serviceContractID,Equal<Current<FSServiceContract.serviceContractID>>>> ServiceContractSelected;
                        ...
                        And<
                            Where2<
                                Where<
                                    ...
                                    And<FSContractPeriod.status, NotEqual<FSContractPeriod.status.Active>>>,
                                Or<
        ...
        public PXSelect<FSContractPeriodDet,
                    Where<FSContractPeriodDet.contractPeriodID, Equal<Current<FSContractPeriodFilter.contractPeriodID>>,
                        And<FSContractPeriodDet.serviceContractID, Equal<Current<FSServiceContract.serviceContractID>>>>> ContractPeriodDetRecords;

        public PXSelectReadonly3<FSScheduleDetService,
                                   InnerJoin<FSSchedule,
                                       On<
                                           FSSchedule.scheduleID, Equal<FSScheduleDetService.scheduleID>>,
        ...
        public PXSelectReadonly2<FSScheduleDetService,
                                    InnerJoin<FSSchedule,
                                       On<
                                           FSSchedule.scheduleID, Equal<FSScheduleDetService.scheduleID>>,
                                    InnerJoin<FSServiceContract,
                                       ...
                                       And<
                                           FSServiceContract.serviceContractID, Equal<Current<FSServiceContract.serviceContractID>>>>>>,
                                    Where<
                                        FSScheduleDetService.lineType, Equal<ListField_LineType_Service_ServiceContract.Service>,
                                        Or<FSScheduleDetService.lineType, Equal<ListField_LineType_Service_ServiceContract.Service_Template>,
                                        Or<FSScheduleDetService.lineType, Equal<ListField_LineType_Service_ServiceContract.Comment_Service>,
                                        Or<FSScheduleDetService.lineType, Equal<ListField_LineType_Service_ServiceContract.Instruction_Service>,
                                        Or<FSScheduleDetService.lineType, Equal<ListField_LineType_Service_ServiceContract.NonStockItem>>>>>>,
                                    OrderBy<
        ...
        public PXSelectReadonly2<FSScheduleDetPart,
                                InnerJoin<FSSchedule,
                                    On<
                                        FSSchedule.scheduleID, Equal<FSScheduleDetService.scheduleID>>,
                                InnerJoin<FSServiceContract,
                                    ...
                                    And<
                                        FSServiceContract.serviceContractID, Equal<Current<FSServiceContract.serviceContractID>>>>>>,
                                Where<
                                    FSScheduleDetPart.lineType, Equal<ListField_LineType_Part_ALL.Inventory_Item>,
                                    Or<FSScheduleDetPart.lineType, Equal<ListField_LineType_Part_ALL.Comment_Part>,
                                    Or<FSScheduleDetPart.lineType, Equal<ListField_LineType_Part_ALL.Instruction_Part>>>>,
                                OrderBy<
        ...
        public PXSelectJoin<FSSalesPrice,
                        ...
                        InnerJoin<FSServiceContract,
                            ...
                            And<
                                FSServiceContract.serviceContractID, Equal<Current<FSServiceContract.serviceContractID>>>>>>, 
                        Where<
                            FSSalesPrice.lineType, NotEqual<ListField_LineType_SalesPrices.Inventory_Item>>> SalesPricesServices;
        ...
        public PXSelectJoin<FSSalesPrice,
                        ...
                        InnerJoin<FSServiceContract,
                            ...
                            And<
                                FSServiceContract.serviceContractID, Equal<Current<FSServiceContract.serviceContractID>>>>>>,
                        Where<
                            FSSalesPrice.lineType, Equal<ListField_LineType_SalesPrices.Inventory_Item>>> SalesPricesInventoryItems;
        ...
        /// </summary>
        private void EnableDisable_Document(PXCache cache, FSServiceContract fsServiceContractRow)
        {
            ...
            this.SalesPricesServices.Cache.AllowInsert = this.SalesPricesServices.Cache.AllowUpdate = enableInsertUpdate;
            this.SalesPricesServices.Cache.AllowDelete = enableDelete;

            this.SalesPricesInventoryItems.Cache.AllowInsert = this.SalesPricesInventoryItems.Cache.AllowUpdate = enableInsertUpdate;
            this.SalesPricesInventoryItems.Cache.AllowDelete = enableDelete;
            ...
            if (enableInsertUpdate)
            {
                ...
                PXDefaultAttribute.SetPersistingCheck<FSServiceContract.startDate>(
                    cache,
                    fsServiceContractRow,
                ...
                PXDefaultAttribute.SetPersistingCheck<FSServiceContract.endDate>(
                    cache,
                    fsServiceContractRow,
        ...
        /// </summary>
        private void EnableDisable_ActionButtons(PXGraph graph, PXCache cache, FSServiceContract fsServiceContractRow)
        {
        ...
        /// </summary>
        private void ValidateDates(PXCache cache, FSServiceContract fsServiceContractRow, PXResultset<FSContractSchedule> contractRows)
        {
            ...
            if (contractRows.Where(y => ((FSContractSchedule)y).StartDate < fsServiceContractRow.StartDate).Count() > 0)
            {
                cache.RaiseExceptionHandling
                   <FSServiceContract.startDate>(
                                               fsServiceContractRow,
                                               fsServiceContractRow.StartDate,
                                               new PXSetPropertyException(
                                                                         TX.Error.CONTRACT_START_DATE_GREATER_THAN_SCHEDULE_START_DATE,
                                                                         PXErrorLevel.Error));
            }

            if (contractRows.Where(y => ((FSContractSchedule)y).EndDate > fsServiceContractRow.EndDate).Count() > 0)
            {
                cache.RaiseExceptionHandling
                   <FSServiceContract.endDate>(
                                               fsServiceContractRow,
                                               fsServiceContractRow.EndDate,
                                               new PXSetPropertyException(
                                                                         TX.Error.CONTRACT_END_DATE_LESSER_THAN_SCHEDULE_END_DATE,
                                                                         PXErrorLevel.Error));
            }
            ...
            {
                cache.RaiseExceptionHandling<FSServiceContract.startDate>(
                    fsServiceContractRow,
                    fsServiceContractRow.StartDate,
                    new PXSetPropertyException(TX.Error.END_DATE_LESSER_THAN_START_DATE, PXErrorLevel.RowError));

                cache.RaiseExceptionHandling<FSServiceContract.endDate>(
                    fsServiceContractRow,
                    fsServiceContractRow.EndDate,
                    new PXSetPropertyException(TX.Error.END_DATE_LESSER_THAN_START_DATE, PXErrorLevel.RowError));
            }
        ...
        /// </summary>
        private decimal? GetSalesPrice(PXCache cache, FSSalesPrice fsSalesPriceRow)
        {
            ...
            switch (salesPriceSet.ErrorCode)
            {
                ...
                case ID.PriceErrorCode.UOM_INCONSISTENCY:
                    ...
                    cache.RaiseExceptionHandling<FSSalesPrice.uOM>(
                        fsSalesPriceRow, 
                        fsSalesPriceRow.UOM, 
                        new PXSetPropertyException(PXMessages.LocalizeFormat(TX.Error.INVENTORY_ITEM_UOM_INCONSISTENCY, inventoryItemRow.InventoryCD), PXErrorLevel.Error));
                    break;
        ...
        private void UpdateSalesPrices(PXCache cache, FSServiceContract fsServiceContractRow)
        {
            foreach (FSSalesPrice fsSalesPriceRow in SalesPricesServices.Select())
            {
                fsSalesPriceRow.Mem_UnitPrice = GetSalesPrice(SalesPricesServices.Cache, fsSalesPriceRow);
                PXUIFieldAttribute.SetEnabled<FSSalesPrice.mem_UnitPrice>(SalesPricesServices.Cache, fsSalesPriceRow, ServiceContractRecords.Current.SourcePrice == ID.SourcePrice.CONTRACT);
            }

            foreach (FSSalesPrice fsSalesPriceRow in SalesPricesInventoryItems.Select())
            {
                fsSalesPriceRow.Mem_UnitPrice = GetSalesPrice(SalesPricesInventoryItems.Cache, fsSalesPriceRow);
                PXUIFieldAttribute.SetEnabled<FSSalesPrice.mem_UnitPrice>(SalesPricesInventoryItems.Cache, fsSalesPriceRow, ServiceContractRecords.Current.SourcePrice == ID.SourcePrice.CONTRACT);
            }
        }
        ...
        /// </summary>
        private void SetUnitPriceForSalesPricesRows(FSServiceContract fsServiceContractRow)
        {
            if (SalesPricesServices.Cache.IsDirty == true)
            {
                foreach (FSSalesPrice fsSalesPriceRow in SalesPricesServices.Select())
                {
                    ...
                    {
                        fsSalesPriceRow.UnitPrice = fsSalesPriceRow.Mem_UnitPrice;
                    }

                    SalesPricesServices.Cache.SetStatus(fsSalesPriceRow, PXEntryStatus.Updated);
                }
            }

            if (SalesPricesInventoryItems.Cache.IsDirty == true)
            {
                foreach (FSSalesPrice fsSalesPriceRow in SalesPricesInventoryItems.Select())
                {
                    if (fsServiceContractRow.SourcePrice == ID.SourcePrice.PRICE_LIST)
                    ...
                    SalesPricesInventoryItems.Cache.SetStatus(fsSalesPriceRow, PXEntryStatus.Updated);
                }
            }
        }

        private void SetVisibleActivatePeriodButton(PXCache cache, FSServiceContract fsServiceContractRow)
        {
            if (fsServiceContractRow == null)
            {
                return;
        ...
        private void SetVisibleContractBillingSettings(PXCache cache, FSServiceContract fsServiceContractRow)
        {
            if(fsServiceContractRow == null)
            {
                return;
        ...
        private void SetContractEndDate(PXCache cache, FSServiceContract fsServiceContractRow)
        {
            if (fsServiceContractRow == null)
            {
                return;
        ...
        private void setUpcommingStatus(FSServiceContract fsServiceContractRow)
        {
            if (fsServiceContractRow == null)
            {
                return;
        ...
        private void SetUsageBillingCycle(FSServiceContract fsServiceContractRow)
        {
        ...
        private void SetBillInfo(PXCache cache, FSServiceContract fsServiceContractRow)
        {
        ...
        private Dictionary<string, string> GetBaseParameters(FSServiceContract fsServiceContractRow, bool loadBranch, bool loadBranchLocation)
        {
            ...
            if (loadBranchLocation == true)
            {
                FSBranchLocation fsBranchLocationRow =
                    ...
                    Where<
                        ...
                        And<FSBranchLocation.branchLocationID, Equal<Required<FSBranchLocation.branchLocationID>>>>>
        ...
        private void SetDefaultBillingRule(PXCache cache, FSContractPeriodDet fsContractPeriodDetRow)
        {
        ...
        private void SetDefaultQtyTime(PXCache cache, FSContractPeriodDet fsContractPeriodDetRow)
        {
                                            ...
                                            FSContractPeriodDet fsContractPeriodDet)
        {
            ...
            {
                throw new PXException(PXMessages.LocalizeFormat(TX.Error.INVENTORY_ITEM_UOM_INCONSISTENCY, inventoryItemRow.InventoryCD), PXErrorLevel.Error);
            }
        ...
        private void InsertContractActionBySchedules(PXDBOperation operation)
        {
        ...
        public ScheduleProjection GetNextExecutionProjection(PXCache cache, FSSchedule fsScheduleRow, DateTime startDate)
        {
        ...
        private bool CheckNewContractStatus(PXGraph graph, FSServiceContract fsServiceContractRow, string newContractStatus, ref string errorMessage)
        {
        ...
        private void ApplyOrScheduleStatusChange(PXGraph graph, PXCache cache, FSServiceContract fsServiceContractRow, DateTime? businessDate, DateTime? effectiveDate, string newStatus)
        {
        ...
        {
            ApplyOrScheduleStatusChange(
                        this,
                        this.ServiceContractRecords.Cache,
                        this.ServiceContractRecords.Current,
        ...
        private string GetActionFromServiceContractStatus(FSServiceContract fsServiceContractRow)
        {
            if (fsServiceContractRow == null)
            {
                return null;
        ...
        private string GetActionFromSchedule(FSSchedule fsScheduleRow)
        {
        ...
        private void ApplyContractPeriodStatusChange(FSServiceContract fsServiceContractRow)
        {
            if (fsServiceContractRow.BillingType == ID.Contract_BillingType.STANDARDIZED_BILLINGS)
            {
                FSContractPeriod fsContractPeriod = PXSelect<FSContractPeriod,
                                                    ...
                                                    OrderBy<Desc<FSContractPeriod.createdDateTime>>>
        ...
        private void UpdateSchedulesByActivateContract()
        {
        ...
        private void UpdateSchedulesByCancelContract(DateTime? cancelDate)
        {
            foreach (ActiveSchedule activeScheduleRow in ActiveScheduleRecords.Select())
            {
        ...
        private void UpdateSchedulesBySuspendContract(DateTime? suspendDate)
        {
            foreach (ActiveSchedule activeScheduleRow in ActiveScheduleRecords.Select())
            {
        ...
        private void setEffectiveUntilDate(PXCache cache, FSServiceContract fsServiceContractRow)
        {
            if (fsServiceContractRow.ExpirationType == ID.Contract_ExpirationType.UNLIMITED
        ...
        private bool CheckDatesApplyOrScheduleStatusChange(PXCache cache, FSServiceContract fsServiceContractRow, DateTime? businessDate, DateTime? effectiveDate)
        {
        ...
        private void DeleteScheduledAppSO(FSServiceContract fsServiceContractRow, DateTime? cancelationDate)
        {
            if (fsServiceContractRow != null && cancelationDate != null)
            {
                ...
                if (fsServiceContractRow.ScheduleGenType == ID.ScheduleGenType_ServiceContract.SERVICE_ORDER)
                {
                    fsServiceOrderRows = PXSelect<FSServiceOrder,
                                                Where<FSServiceOrder.serviceContractID, Equal<Required<FSServiceOrder.serviceContractID>>,
                                                And<FSServiceOrder.orderDate, Greater<Required<FSServiceOrder.orderDate>>,
                ...
                else
                {
                    fsAppointmentRows = PXSelect<FSAppointment,
                                                Where<FSAppointment.serviceContractID, Equal<Required<FSAppointment.serviceContractID>>,
                                                And<FSAppointment.executionDate, Greater<Required<FSAppointment.executionDate>>,
                                                And<FSAppointment.status, Equal<FSAppointment.status.AutomaticScheduled>>>>>
                                                .Select(this, fsServiceContractRow.ServiceContractID, cancelationDate);
                ...
                foreach (FSServiceOrder fsServiceOrderRow in fsServiceOrderRows)
                {
                    ...
                    if (graphServiceOrderEntry.BillingCycleRelated.Current?.BillingBy == ID.Billing_By.SERVICE_ORDER)
                    {
                        graphServiceOrderEntry.ServiceOrderRecords.Cache.SetValueExt<FSServiceOrder.billServiceContractID>
                                                                                                (graphServiceOrderEntry.ServiceOrderRecords.Current, null);
                ...
                foreach (FSAppointment fsAppointmentRow in fsAppointmentRows)
                {
                    ...
                    {
                        graphAppointmentEntry.AppointmentRecords.Cache.SetValueExt<FSAppointment.billServiceContractID>
                                                                                            (graphAppointmentEntry.AppointmentRecords.Current, null);
        ...
        private void SetBillingPeriod(FSServiceContract fsServiceContractRow)
        {
            if (ContractPeriodRecords.Current != null)
            {
        ...
        private bool EnableDisableActivatePeriodButton(FSServiceContract fsServiceContractRow, FSContractPeriod fsContractPeriodRow)
        {
        ...
        private bool AllowActivatePeriod(FSContractPeriod fsContractPeriodRow)
        {
        ...
        public void InvoiceBillingPeriod(FSSetup fsSetupRow, FSContractPostDoc fsContractPostDocRow)
        {
        ...
        private void UnholdAPPSORelatedToContractPeriod(FSServiceContract fsServiceContractRow, FSContractPeriod fsContractPeriodRow)
        {
        ...
        private static void SetBillCustomerAndLocationID(PXCache cache, FSServiceContract fsServiceContractRow)
        {
        ...
        protected virtual void FSServiceContract_BranchID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSServiceContract_BillingPeriod_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSServiceContract_StartDate_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            UpdateSalesPrices(cache, fsServiceContractRow);
            SetBillingPeriod(fsServiceContractRow);
        }

        protected virtual void FSServiceContract_EndDate_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSServiceContract_Status_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSServiceContract_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            this.SalesPricesServices.AllowSelect = fsServiceContractRow.Mem_ShowPriceTab == true;
            this.SalesPricesInventoryItems.AllowSelect = fsServiceContractRow.Mem_ShowPriceTab == true;
            this.ServiceContractSelected.AllowSelect = fsServiceContractRow.Mem_ShowScheduleTab == false;
        }

        protected virtual void FSServiceContract_RowPersisting(PXCache cache, PXRowPersistingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if (e.Operation == PXDBOperation.Delete)
            {
                ...
                ServiceContractScheduleEntryBase<RouteServiceContractScheduleEntry, FSSchedule, FSSchedule.scheduleID, FSSchedule.entityID, FSSchedule.customerID>
                    routeServiceContractScheduleEntry =

                PXGraph.CreateInstance<ServiceContractScheduleEntryBase<RouteServiceContractScheduleEntry, FSSchedule, FSSchedule.scheduleID, FSSchedule.entityID, FSSchedule.customerID>>();
        ...
        protected virtual void FSServiceContract_RowPersisted(PXCache cache, PXRowPersistedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            string scheduleGenTypeOriginal = (string)cache.GetValueOriginal<FSServiceContract.scheduleGenType>(fsServiceContractRow);
                        ...
                        && fsServiceContractRow.ScheduleGenType != scheduleGenTypeOriginal)
            {
                ...
                FSSchedule,
                Where<FSSchedule.customerID, Equal<Required<FSSchedule.customerID>>,
        ...
        protected virtual void FSServiceContract_CustomerID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            SetBillCustomerAndLocationID(cache, fsServiceContractRow);
        }

        protected virtual void FSServiceContract_SourcePrice_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSServiceContract_ExpirationType_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            FSServiceContract fsServiceContractRow = (FSServiceContract)e.Row;
            SetContractEndDate(cache, fsServiceContractRow);
            setUpcommingStatus(fsServiceContractRow);
            setEffectiveUntilDate(cache, fsServiceContractRow);
        }

        protected virtual void FSServiceContract_BillingType_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSServiceContract_BillCustomerID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSServiceContract_ScheduleGenType_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if (fsServiceContractRow.ScheduleGenType != null )
            {
                switch(fsServiceContractRow.ScheduleGenType)
                {
                    case ID.ScheduleGenType_ServiceContract.NONE:
                        ...
                        SharedFunctions.DefaultGenerationType(cache, fsServiceContractRow, e);
                        break;
        ...
        #endregion
        #region FSSalesPrice Events
        protected virtual void FSSalesPrice_RowSelecting(PXCache cache, PXRowSelectingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if (ServiceContractRecords.Current != null)
            {
                ...
                {
                    fsSalesPriceRow.Mem_UnitPrice = GetSalesPrice(cache, fsSalesPriceRow);
                }
            }
        }

        protected virtual void FSSalesPrice_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            ...
            PXUIFieldAttribute.SetEnabled<FSSalesPrice.mem_UnitPrice>(cache, fsSalesPriceRow, isContract);
        }
        #endregion
        #region FSContractPeriodFilterEvents

        protected virtual void FSContractPeriodFilter_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSContractPeriodFilter_Actions_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            cache.SetDefaultExt<FSContractPeriodFilter.contractPeriodID>(e.Row);
        }

        protected virtual void FSContractPeriodFilter_Actions_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        #endregion
        #region FSContractPeriodDet Events
        protected virtual void FSContractPeriodDet_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            EnableDisableContractPeriodDet(cache, fsContractPeriodDetRow);
        }

        protected virtual void FSContractPeriodDet_RowSelecting(PXCache cache, PXRowSelectingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            using (new PXConnectionScope())
            {
                ...
                var fsSODetRows = PXSelectJoin<FSSODet,
                                    InnerJoin<FSServiceOrder, On<FSServiceOrder.sOID, Equal<FSSODet.sOID>>>,
                                        Where2<
                                            Where<
                ...
                var fsAppointmentDetRows = PXSelectJoin<FSAppointmentDet,
                                            ...
                                            InnerJoin<FSSODet, On<FSSODet.sODetID, Equal<FSAppointmentDet.sODetID>>>>,
                                                Where2<
                                                    Where<
                ...
                {
                    decimal? qtySum = fsSODetRows.Sum(x => ((FSSODet)x).EstimatedQty);
        ...
        protected virtual void FSContractPeriodDet_InventoryID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSContractPeriodDet_RecurringTotalPrice_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            FSContractPeriodDet fsContractPeriodDetRow = (FSContractPeriodDet)e.Row;
            e.NewValue = GetTotalPrice(cache, fsContractPeriodDetRow);
        }

        protected virtual void FSContractPeriodDet_BillingRule_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            FSContractPeriodDet fsContractPeriodDetRow = (FSContractPeriodDet)e.Row;
            SetDefaultQtyTime(cache, fsContractPeriodDetRow);
        }

        protected virtual void FSContractPeriodDet_Amount_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSContractPeriodDet_Amount_FieldSelecting(PXCache cache, PXFieldSelectingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            FSContractPeriodDet fsContractPeriodDetRow = (FSContractPeriodDet)e.Row;
            AmountFieldSelectingHandler(cache, e, typeof(FSContractPeriodDet.amount).Name, fsContractPeriodDetRow.BillingRule, fsContractPeriodDetRow.Time, fsContractPeriodDetRow.Qty);
        }

        protected virtual void FSContractPeriodDet_UsedAmount_FieldSelecting(PXCache cache, PXFieldSelectingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            FSContractPeriodDet fsContractPeriodDetRow = (FSContractPeriodDet)e.Row;
            AmountFieldSelectingHandler(cache, e, typeof(FSContractPeriodDet.usedAmount).Name, fsContractPeriodDetRow.BillingRule, fsContractPeriodDetRow.UsedTime, fsContractPeriodDetRow.UsedQty);
        }

        protected virtual void FSContractPeriodDet_RemainingAmount_FieldSelecting(PXCache cache, PXFieldSelectingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            FSContractPeriodDet fsContractPeriodDetRow = (FSContractPeriodDet)e.Row;
            AmountFieldSelectingHandler(cache, e, typeof(FSContractPeriodDet.remainingAmount).Name, fsContractPeriodDetRow.BillingRule, fsContractPeriodDetRow.RemainingTime, fsContractPeriodDetRow.RemainingQty);
        }

        protected virtual void FSContractPeriodDet_ScheduledAmount_FieldSelecting(PXCache cache, PXFieldSelectingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            FSContractPeriodDet fsContractPeriodDetRow = (FSContractPeriodDet)e.Row;
            AmountFieldSelectingHandler(cache, e, typeof(FSContractPeriodDet.scheduledAmount).Name, fsContractPeriodDetRow.BillingRule, fsContractPeriodDetRow.ScheduledTime, fsContractPeriodDetRow.ScheduledQty);
        }
        #endregion
        #region PrepaidContractFilters Events
        protected virtual void FSActivationContractFilter_ActivationDate_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if (filter.ActivationDate.HasValue == true)
            {
                ...
                {
                    cache.RaiseExceptionHandling<FSActivationContractFilter.activationDate>(
                        filter,
        ...
        protected virtual void FSTerminateContractFilter_CancelationDate_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if (filter.CancelationDate.HasValue == true)
            {
                ...
                {
                    cache.RaiseExceptionHandling<FSTerminateContractFilter.cancelationDate>(
                        filter,
        ...
        protected virtual void FSSuspendContractFilter_SuspensionDate_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if (filter.SuspensionDate.HasValue == true)
            {
                ...
                {
                    cache.RaiseExceptionHandling<FSSuspendContractFilter.suspensionDate>(
                        filter,
        ...
        protected virtual void ActiveSchedule_EffectiveRecurrenceStartDate_FieldSelecting(PXCache cache, PXFieldSelectingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void ActiveSchedule_ChangeRecurrence_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void ActiveSchedule_EffectiveRecurrenceStartDate_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
