    ...
    public class StaffSelectionHelper
    {
        ...
        public class StaffRecords_View : PXSelectJoin<BAccountStaffMember,
                    ...
                    LeftJoin<FSGeoZoneEmp,
                            On<FSGeoZoneEmp.employeeID, Equal<BAccountStaffMember.bAccountID>>,
                    LeftJoin<PMProject,
                    ...
                    Where<PMProject.isActive, Equal<True>,
                        ...
                        And<
                            Where2<
                                Where<CurrentValue<StaffSelectionFilter.geoZoneID>, IsNull,
                                    Or<FSGeoZoneEmp.geoZoneID, Equal<Current<StaffSelectionFilter.geoZoneID>>>>,
                                And<
                                    Where2<
                                        Where<
       ...
       public class LicenseTypeRecords_View : PXSelectOrderBy<LicenseTypeGridFilter,
        ...
        {
            var fsGeoZoneRows =
                    PXSelectReadonly<FSGeoZonePostalCode>.Select(graph);
