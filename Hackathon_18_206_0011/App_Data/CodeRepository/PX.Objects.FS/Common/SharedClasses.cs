...
namespace PX.Objects.FS
{
    public class SharedClasses
    {
        ...
        public class AppointmentInfo
        {
            ...
            public PXResultset<FSAppointmentInventoryItem> FSAppointmentInventoryItemToPostIn_AR_AP;
            public PXResultset<FSAppointmentInventoryItem> FSAppointmentInventoryItemToPostInSO;
            ...
            public AppointmentInfo(
                                ...
                                PXResultset<FSAppointmentInventoryItem> bqlResultSet_FSAppointmentInventoryItem_PostAR_AP,
                                PXResultset<FSAppointmentInventoryItem> bqlResultSet_FSAppointmentInventoryItem_PostSO)
            {
        ...
        public class InvoiceItem
        {
            ...
            public InvoiceItem(PXGraph graph, AppointmentInfo appointmentInfo, int index)
            {
                ...
                foreach (FSAppointmentInventoryItem fsAppointmentInventoryItemRow in appointmentInfo.FSAppointmentInventoryItemToPostIn_AR_AP)
                {
                    this.AddAppointmentLineToList(graph, null, fsAppointmentInventoryItemRow, appointmentInfo, true, false);
                }

                foreach (FSAppointmentInventoryItem fsAppointmentInventoryItemRow in appointmentInfo.FSAppointmentInventoryItemToPostInSO)
                {
        ...
        public class AppointmentInventoryItemInfo
        {
            ...
            public FSAppointmentInventoryItem FSAppointmentInventoryItem;
            public int Index;
        ...
        public class decimal_60 : Constant<decimal>
        {
            public decimal_60()
                : base(60m)
            {
        ...
        public class SOLineEquipmentComponent
        {
            ...
            public SOLineEquipmentComponent(IDocLine docLine, SOLine sOLineRow, FSxSOLine fSxSOLineRow)
            {
        ...
        public class SOPrepaymentBySO
        {
            ...
            public SOPrepaymentBySO(SOLine soLineRow, FSxSOLine fsxSOLineRow)
            {
                SOID = fsxSOLineRow.SOID;
                unpaidAmount = 0;
                unpaidAmount += soLineRow.CuryLineAmt ?? 0m;
        ...
        public class SOPrepaymentHelper
        {
            ...
            public void Add(SOLine soLineRow, FSxSOLine fsxSOLineRow)
            {
                ...
                if (row != null)
                {
                    row.unpaidAmount += soLineRow.CuryLineAmt ?? 0m;
                    row.fsxSOLineList.Add(fsxSOLineRow);
                }
                else
                {
                    SOPrepaymentBySO newRow = new SOPrepaymentBySO(soLineRow, fsxSOLineRow);
                    SOPrepaymentList.Add(newRow);
                }
            }
        }

        public class SubAccountIDList
        {
            ...
            public SubAccountIDList(int? branchLocation_SubID, int? company_SubID, int? item_SubID, int? customer_SubID, int? postingClass_SubID, int? salesPerson_SubID, int? srvOrdType_SubID, int? warehouse_SubID)
            {
