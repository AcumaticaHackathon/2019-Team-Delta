...
namespace PX.Objects.FS
{
    public static class FSMailProcess
    {
        ...
        /// </summary>
        private static void AddVendorStaffRecipient(
                                                    AppointmentEntry graphAppointmentEntry,
                                                    FSAppointmentEmployee fsAppointmentEmployee,
                                                    NotificationRecipient recSetup,
            RecipientList recipients)
        {
            //TODO: 6082 validate Vendor's AppNotification flag
            /*
                select * from Contact
        ...
        public static RecipientList GetRecipients(AppointmentEntry graphAppointmentEntry, int? sourceID, int? sourceEmailID)
        {
            ...
            PXResultset<NotificationRecipient> notificationRecipientSet = PXSelect<NotificationRecipient,
                                                                          Where<
                                                                                ...
                                                                                And<NotificationRecipient.active, Equal<True>>>,
                                                                          OrderBy<Asc<NotificationRecipient.notificationID>>>
            ...
            var staffMemberRowsGrouped = graphAppointmentEntry.AppointmentEmployees.Select().GroupBy(
