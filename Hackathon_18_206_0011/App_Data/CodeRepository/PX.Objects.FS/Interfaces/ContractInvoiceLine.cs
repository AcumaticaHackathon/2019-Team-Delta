...
namespace PX.Objects.FS
{
    public class ContractInvoiceLine
    {
        ...
        public ContractInvoiceLine(PXResult<FSContractPeriodDet, FSContractPeriod, FSServiceContract> row)
        {
            FSServiceContract fsServiceContract = (FSServiceContract)row;
            FSContractPeriodDet fsContractPeriodDet = (FSContractPeriodDet)row;

            ServiceContractID = fsServiceContract.ServiceContractID;
            ContractType = fsServiceContract.RecordType;
            ContractPeriodID = fsContractPeriodDet.ContractPeriodDetID;
            ContractPeriodDetID = fsContractPeriodDet.ContractPeriodID;

            BillingRule = fsContractPeriodDet.BillingRule;
            InventoryID = fsContractPeriodDet.InventoryID;
            UOM = fsContractPeriodDet.UOM;
            SMEquipmentID = fsContractPeriodDet.SMEquipmentID;
            CuryUnitPrice = fsContractPeriodDet.RecurringUnitPrice;
            ...
            {
                Qty = decimal.Divide((decimal)(fsContractPeriodDet.Time ?? 0), 60);
            }
            else
            {
                Qty = fsContractPeriodDet.Qty;
            }

            OverageItemPrice = fsContractPeriodDet.OverageItemPrice;
            AcctID = null;
            SubID = null;
            ...
            SalesPersonID = fsServiceContract.SalesPersonID;
            Commissionable = fsServiceContract.Commissionable;
