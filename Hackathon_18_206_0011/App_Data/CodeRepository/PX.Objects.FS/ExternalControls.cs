...
namespace PX.Objects.FS
{
    public class ExternalControls : PXGraph<ExternalControls>
    {
        ...
        public PXSelect<PX.SM.UserPreferences,
                Where<
                PX.SM.UserPreferences.userID, Equal<CurrentValue<AccessInfo.userID>>,
                And<PX.SM.UserPreferences.defBranchID, Equal<Current<FSServiceOrder.branchID>>>>> UserPreferencesRecords;
        ...
        public PXSelectJoin<FSAppointmentDet,
                        ...
                        And<
                            Where<FSAppointmentDet.status, Equal<FSAppointmentDet.status.Open>,
        ...
        public static PXResultset<FSServiceOrder> ServiceOrderRecords(int? branchID, int? branchLocationID, DispatchBoardFilters[] filters, DateTime? scheduledDateStart = null, DateTime? scheduledDateEnd = null, bool? isRoomCalendar = false)
        {
            ...
            if (scheduledDateEnd != null)
            {
                servicesOrdersBase.WhereAnd<Where2<
                                        ...
                                        Or<
                                            Where2<
                                                Where<
                                                    FSServiceOrder.promisedDate, IsNotNull,
                                                And<
            ...
            if (filters != null)
            {
                ...
                for (int i = 0; i < bqlResultSet_FSServicesOrdersToFilter.Count; i++)
                {
                    ...
                    PXResultset<FSSODet> bqlResultSet = graph.SODetPendingLines.Select(fsServiceOrderRow.SOID);
                    ...
                    else
                    {
                        ...
                        {
                            SharedClasses.ItemList appointmentDetList = activeAppointmentDetList.FirstOrDefault(y => y.itemID == fsSODetRow.SODetID);
        ...
        public List<FSAppointmentStaffScheduleBoard> GetAppointmentRecords(DateTime timeBegin, DateTime timeEnd, int? branchID, int? branchLocationID, int[] employeeIDList)
        {
            ...
            BqlCommand appointmentRecords = new Select<FSAppointmentStaffScheduleBoard,
                                                    Where<
                                                        FSAppointmentStaffScheduleBoard.status, NotEqual<FSAppointmentStaffScheduleBoard.status.Canceled>,
                                                        And<
                                                            Where<
                                                                Where2<
                                                                    Where<FSAppointmentStaffScheduleBoard.scheduledDateTimeBegin, GreaterEqual<Required<FSAppointmentStaffScheduleBoard.scheduledDateTimeBegin>>,
                                                                ...
                                                                Or<
                                                                    Where<FSAppointmentStaffScheduleBoard.scheduledDateTimeEnd, GreaterEqual<Required<FSAppointmentStaffScheduleBoard.scheduledDateTimeBegin>>,
            ...
            foreach (FSAppointmentStaffScheduleBoard result in results)
            {
                appointmentList.Add(GetStaffCalendarAppointment(result));
            }
        ...
        public List<FSAppointmentScheduleBoard> GetAppointmentRecordsByRooms(DateTime timeBegin, DateTime timeEnd, int? branchID, int? branchLocationID, int[] roomIDList)
        {
            ...
            BqlCommand appointmentRecords = new Select<FSAppointmentScheduleBoard,
                                                Where<
            ...
            foreach (FSAppointmentScheduleBoard result in results)
            {
                appointmentList.Add(GetCalendarAppointment(result));
            }
        ...
        public List<FSAppointmentScheduleBoard> UnassignedAppointmentRecords(DateTime timeBegin, DateTime timeEnd, int? branchID, int? branchLocationID, bool? unassignedAppointmentByRoom, DispatchBoardFilters[] filters)
        {
            ...
            PXSelectBase<FSAppointmentScheduleBoard> appointmentRecords = new PXSelectJoin<FSAppointmentScheduleBoard,
                                                LeftJoin<Address,
                                                    On<Address.addressID, Equal<FSAppointmentScheduleBoard.addressID>>>,
                                               Where<
                                                   FSAppointmentScheduleBoard.status, NotEqual<FSAppointmentScheduleBoard.status.Canceled>,
                                                   ...
                                                   And<Where<
                                                           ...
                                                           Or<
                                                               Where<FSAppointmentScheduleBoard.scheduledDateTimeEnd, GreaterEqual<Required<FSAppointmentScheduleBoard.scheduledDateTimeBegin>>,
                                                                   And<FSAppointmentScheduleBoard.scheduledDateTimeEnd, LessEqual<Required<FSAppointmentScheduleBoard.scheduledDateTimeEnd>>>>>>>>>>>>(this);
            ...
            if (unassignedAppointmentByRoom == false)
            {
                appointmentRecords.Join<LeftJoin<FSAppointmentEmployee,
                                                    On<FSAppointmentEmployee.appointmentID, Equal<FSAppointmentScheduleBoard.appointmentID>>>>();
            ...
            {
                FSAppointmentScheduleBoard fsAppointmentRow = result;
        ...
        public DispatchBoardAppointmentMessages DBPutAppointments(FSAppointmentScheduleBoard fsAppointmentRow)
        {
            DispatchBoardAppointmentMessages messages = new DispatchBoardAppointmentMessages();
            ...
            try
            {
                if (fsAppointmentRow != null)
                {
                    ...
                    FSAppointment fsAppointmentRow_Aux = graphAppointmentMaint.AppointmentRecords.Current;

                    if (fsAppointmentRow_Aux != null)
                    {
                        if (fsAppointmentRow_Aux.ScheduledDateTimeBegin != fsAppointmentRow.ScheduledDateTimeBegin
                                || fsAppointmentRow_Aux.ScheduledDateTimeEnd != fsAppointmentRow.ScheduledDateTimeEnd)
                        {
                            fsAppointmentRow_Aux.HandleManuallyScheduleTime = true;
                        }

                        fsAppointmentRow_Aux.Confirmed = fsAppointmentRow.Confirmed;
                        fsAppointmentRow_Aux.ValidatedByDispatcher = fsAppointmentRow.ValidatedByDispatcher;
                        fsAppointmentRow_Aux.ScheduledDateTimeBegin = fsAppointmentRow.ScheduledDateTimeBegin;
                        fsAppointmentRow_Aux.ScheduledDateTimeEnd = fsAppointmentRow.ScheduledDateTimeEnd;

                        graphAppointmentMaint.AppointmentRecords.Update(fsAppointmentRow_Aux);
                        ...
                        {
                            FSAppointmentEmployee fsAppointmentEmployeeRow = (FSAppointmentEmployee)this.AppointmentEmployeeByEmployee
                                                                .Select(fsAppointmentRow.AppointmentID, fsAppointmentRow.EmployeeID);
                            ...
                            else
                            {
                                ...
                                fsAppointmentEmployeeRow_New = graphAppointmentMaint.AppointmentEmployees.Insert(fsAppointmentEmployeeRow_New);

                                foreach (FSAppointmentEmployee fsAppointmentEmployeeRow_Old in graphAppointmentMaint.AppointmentEmployees.Select())
                                {
                                    if (fsAppointmentEmployeeRow_Old.EmployeeID == fsAppointmentRow.OldEmployeeID)
                                    {
                                        graphAppointmentMaint.AppointmentEmployees.Delete(fsAppointmentEmployeeRow_Old);
                                    }
                                }
                            }
                        }

                        if (graphAppointmentMaint.PressSave(messages) == false)
                        {
                            return messages;
                        }
                    }
        ...
        public DispatchBoardAppointmentMessages DBDeleteAppointments(FSAppointment fsAppointmentRow)
        {
            ...
            try
            {
                ...
                graphAppointmentMaint.AppointmentRecords.Delete(fsAppointmentRow);
        ...
        public int? DBCreateAppointmentBridge(FSAppointmentScheduleBoard fsAppointmentRow, List<int> sODetIDList, List<int> employeeIDList)
        {
        ...
        public FSAppointmentScheduleBoard GetCalendarAppointment(FSAppointmentScheduleBoard fsAppointmentScheduleBoardRow)
        {
            ...
            fsAppointmentScheduleBoardRow.AttendeeCount = fsAppointmentAttendeeRows.Count;

            if (fsAppointmentScheduleBoardRow.ContactEmail == null)
            {
                fsAppointmentScheduleBoardRow.ContactEmail = fsAppointmentScheduleBoardRow.ServiceOrderEmail;
            }

            if (fsAppointmentScheduleBoardRow.ContactPhone == null)
            {
                fsAppointmentScheduleBoardRow.ContactPhone = fsAppointmentScheduleBoardRow.ServiceOrderPhone;
            }
        ...
        public List<RouteNode> GetTreeAppointmentNodesByRoute(int routeDocumentID, FSRoute fsRouteRow)
        {
            ...
            FSBranchLocation fsBranchLocationRow_Begin = PXSelect<FSBranchLocation,
                                            Where<
            ...
            tmpLeaf.Add(new RouteNode(fsRouteRow, fsBranchLocationRow_Begin, TX.Route_Location.START_LOCATION, routeDocumentID.ToString()));

            foreach (PXResult<FSAppointment, FSServiceOrder, FSSrvOrdType, Location, Address, Country, State, FSCustomer> bqlResult in results)
            {
                ...
                Address addressRow = bqlResult;
                FSCustomer fsCustomerRow = bqlResult;
                Location locationRow = bqlResult;

                //Appointment Tree Node 
                tmpLeaf.Add(new RouteNode(fsAppointmentRow, fsSrvOrdTypeRow, fsServiceOrderRow, fsCustomerRow, locationRow));
            }

            FSBranchLocation fsBranchLocationRow_End = PXSelect<FSBranchLocation,
                                            Where<
                                                FSBranchLocation.branchLocationID, Equal<Required<FSBranchLocation.branchLocationID>>>>
                                            .Select(this, fsRouteRow.EndBranchLocationID);

            //End Location Tree Node 
            tmpLeaf.Add(new RouteNode(fsRouteRow, fsBranchLocationRow_End, TX.Route_Location.END_LOCATION, routeDocumentID.ToString()));
        ...
        public List<RouteNode> GetTreeAppointmentNodesByEmployee(int employeeID, DateTime calendarDate)
        {
            ...
            foreach (PXResult<EPEmployee,
                              ...
                              Country,
                              State,
                              FSCustomer> bqlResult in results)
            {
                FSAppointment fsAppointmentRow = bqlResult;
                FSServiceOrder fsServiceOrderRow = bqlResult;
                FSSrvOrdType fsSrvOrdTypeRow = bqlResult;
                ...
                //Appointment Tree Node 
                tmpLeaf.Add(new RouteNode(fsAppointmentRow, fsSrvOrdTypeRow, fsServiceOrderRow, fsCustomerRow, bAccountStaffMemberRow, locationRow));
            }

            return tmpLeaf;
        }

        //Revisar para usa projection
        public List<object> GetUnassignedAppointmentNode(DateTime calendarDate, int branchID, int? branchLocationID)
        {
            ...
            foreach (PXResult<FSAppointment, FSServiceOrder, FSSrvOrdType, Customer, FSAppointmentEmployee, Location, Address, Country, State> bqlResult in results)
            {
                FSAppointment fsAppointmentRow = bqlResult;
                FSServiceOrder fsServiceOrderRow = bqlResult;
                FSSrvOrdType fsSrvOrdTypeRow = bqlResult;
        ...
        {
            DateTime? startDate = calendarDate ?? Accessinfo.BusinessDate;
            ...
            PXSelectBase<EPEmployee> employeesBase = new PXSelectJoin<EPEmployee,
                                                            LeftJoin<PX.Objects.GL.Branch,
                                                                On<
                                                                    PX.Objects.GL.Branch.bAccountID, Equal<EPEmployee.parentBAccountID>>>,
                                                            Where<
            ...
            if (ignoreAvailabilityFlag != true)
            {
                if (auxByScheduled)
                {
                    ...
                    employeeScheduleArgs.Add(date.BeginOfNextDay());
                ...
                appointmentArgs.Add(date.BeginOfNextDay());
                appointmentArgs.Add(date.StartOfDay());
                appointmentArgs.Add(date.BeginOfNextDay());
            ...
            PXResultset<EPEmployee> bqlResultSet_EPEmployeesToFilter;
            ...
            if (filters != null)
            {
                ...
                bqlResultSet_EPEmployeesToFilter = (args.Count > 0) ? employeesBase.Select(args.ToArray()) : employeesBase.Select();
                ...
                if (ignoreAvailabilityFlag != true)
                {
                    if (auxByScheduled)
                    {
                        bqlResultSet_EPEmployeesToFilter = FilterEmployeesByBranchLocationAndScheduled(bqlResultSet_EPEmployeesToFilter, bqlResultSet_EmployeeSchedule, bqlResultSet_FSAppointmentEmployee);
                    }
                    else
                    {
                        bqlResultSet_EPEmployeesToFilter = FilterEmployeesByBranchLocation(bqlResultSet_EPEmployeesToFilter, bqlResultSet_EmployeeSchedule, bqlResultSet_FSAppointmentEmployee);
                    }
                }
                ...
                List<SharedClasses.ItemList> employeeSkills = SharedFunctions.GetItemWithList<FSEmployeeSkill,
                                                                                              ...
                                                                                              FSEmployeeSkill.skillID>(graph, employeeList);
        ...
        public PXResultset<EPEmployee> FilterEmployeesByBranchLocation(PXResultset<EPEmployee> bqlResultSet_EPEmployee, PXResultset<FSTimeSlot> bqlResultSet_FSTimeSlot, PXResultset<FSAppointmentEmployee> bqlResultSet_FSAppointmentEmployee)
        {
        ...
        public PXResultset<EPEmployee> FilterEmployeesByBranchLocationAndScheduled(PXResultset<EPEmployee> bqlResultSet_EPEmployee, PXResultset<FSTimeSlot> bqlResultSet_FSEmployeeSchedule, PXResultset<FSAppointmentEmployee> bqlResultSet_FSAppointmentEmployee)
        {
            bool employeeHasRules;
            bool employeeHasAppointment;
        ...
        public PXResultset<Vendor> VendorRecords(int? branchID, int? branchLocationID, bool? ignoreActiveFlag, bool? ignoreAvailabilityFlag, DateTime? calendarDate, DispatchBoardFilters[] filters)
        {
            DateTime? startDate = calendarDate ?? Accessinfo.BusinessDate;
        ...
        public string GetBusinessDate()
        {
            ...
            { 
                return ((DateTime)SharedFunctions.GetCustomDateTime(Accessinfo.BusinessDate.Value, PXTimeZoneInfo.Now)).ToString("MM/dd/yyyy h:mm:ss tt", new CultureInfo("en-US"));
            }
        ...
        public class RouteNode
        {
            ...
            /// <param name="fsBranchLocationRow"> Branch Location Record. </param>
            /// <param name="locationName"> Display Text Node. </param>
            public RouteNode(FSRoute fsRouteRow, FSBranchLocation fsBranchLocationRow, string locationName, string nodeID)
            {
                this.NodeID = locationName + " (" + nodeID + ")";
                this.Text = locationName + " ( " + fsRouteRow.RouteCD.Trim() + ")";
                this.ServicesDuration = 0;
                this.Address = fsBranchLocationRow.AddressLine1 + " " + fsBranchLocationRow.AddressLine2 + ", "
                            + fsBranchLocationRow.State + ", " + fsBranchLocationRow.City + " "
                            + fsBranchLocationRow.PostalCode + ", " + fsBranchLocationRow.CountryID;
                this.CustomerLocation = fsBranchLocationRow.AddressLine1 + " " + fsBranchLocationRow.AddressLine2;
                this.PostalCode = fsBranchLocationRow.PostalCode;
            ...
            /// <param name="fsCustomerRow"> Customer Record. </param>
            /// <param name="bAccountStaffMemberRow"> Staff Member Record. </param>
            public RouteNode(FSAppointment fsAppointmentRow, FSSrvOrdType fsSrvOrdTypeRow, FSServiceOrder fsServiceOrderRow, FSCustomer fsCustomerRow, BAccountStaffMember bAccountStaffMemberRow, Location locationRow)
            {
                ...
                this.SetCommonAttributes(fsAppointmentRow, fsSrvOrdTypeRow, fsServiceOrderRow, fsCustomerRow, locationRow);
            }
            ...
            /// <param name="fsServiceOrderRow"> Service Order Record. </param>
            /// <param name="fsCustomerRow"> Customer Record. </param>
            public RouteNode(FSAppointment fsAppointmentRow, FSSrvOrdType fsSrvOrdTypeRow, FSServiceOrder fsServiceOrderRow, FSCustomer fsCustomerRow, Location locationRow)
            {
            ...
            private void SetCommonAttributes(FSAppointment fsAppointmentRow, FSSrvOrdType fsSrvOrdTypeRow, FSServiceOrder fsServiceOrderRow, FSCustomer fsCustomerRow, Location locationRow)
            {
                this.RefNbr = fsAppointmentRow.RefNbr;
                this.CustomerName = fsCustomerRow.AcctName;
                ...
                this.Address = fsServiceOrderRow.AddressLine1 + " " + fsServiceOrderRow.AddressLine2 + ", " + fsServiceOrderRow.State
                            + ", " + fsServiceOrderRow.City + " " + fsServiceOrderRow.PostalCode + ", " + fsServiceOrderRow.CountryID;
                this.CustomerLocation = fsServiceOrderRow.AddressLine1 + " " + fsServiceOrderRow.AddressLine2;
                this.PostalCode = fsServiceOrderRow.PostalCode;
        ...
        private static int GetRowMessages(PXCache cache, object row, ExternalControls.DispatchBoardAppointmentMessages messages)
        {
            ...
            foreach (string field in cache.Fields)
            {
                ...
                if (fieldState != null && fieldState.Error != null)
                {
                    ...
                    {
                        errorCount++;
                        messages.ErrorMessages.Add(fieldState.Error);
                    }
                    else
                    {
                        messages.WarningMessages.Add(fieldState.Error);
                    }
                }
            }
