...
namespace PX.Objects.FS
{
    public class SM_NonStockItemMaint : PXGraphExtension<NonStockItemMaint>
    {
        ...
        /// </summary>
        private void EnableDisable(PXCache cache, InventoryItem inventoryItemRow)
        {
            ...
            PXUIFieldAttribute.SetEnabled<FSxService.autoShowNote>(cache, inventoryItemRow, enabled);
        ...
        /// </summary>
        private void SetDefaultBillingRule(PXCache cache, InventoryItem nonStockItemRow)
        {
        ...
        /// </summary>        
        private void SetPostClassIDField(PXCache cache, InventoryItem inventoryItemRow)
        {
        ...
        /// </summary>
        private void EnableDisablePickUpDelivery(PXCache cache, InventoryItem inventoryItemRow)
        {
        ...
        /// </summary>
        private void EnableDisableActionType(PXCache cache, InventoryItem inventoryItemRow)
        {
            ...
            if (enableActionType == false)
            {
                cache.RaiseExceptionHandling<FSxService.actionType>(
                                                                    ...
                                                                    new PXSetPropertyException(
                                                                        PXMessages.LocalizeFormat(TX.Warning.CANNOT_MODIFY_FIELD, "Appoinments", "Service"),
                                                                        PXErrorLevel.Warning));
            }
        }

        private void HideOrShowTabs(PXCache cache, InventoryItem inventoryItemRow)
        {
            ...
            PXUIFieldAttribute.SetVisible<FSxService.autoShowNote>(cache, inventoryItemRow, isService);
        ...
        protected void FSServiceSkill_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
