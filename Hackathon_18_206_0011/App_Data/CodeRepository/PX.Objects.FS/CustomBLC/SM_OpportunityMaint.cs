...
{
    public class SM_OpportunityMaint : PXGraphExtension<OpportunityMaint>
    {
        ...
        {
            base.Initialize();
            Base.actionsFolder.AddMenuAction(CreateServiceOrder);
            Base.actionsFolder.AddMenuAction(OpenAppointmentBoard);
        ...
        public PXFilter<FSCreateServiceOrderOnOpportunityFilter> CreateServiceOrderFilter;
        ...
        private void CreateServiceOrderDocument(OpportunityMaint graphOpportunityMaint, CROpportunity crOpportunityRow, FSCreateServiceOrderOnOpportunityFilter fsCreateServiceOrderOnOpportunityFilterRow)
        {
            if(graphOpportunityMaint == null
                    ||  crOpportunityRow == null
                        || fsCreateServiceOrderOnOpportunityFilterRow == null)
            {
                return;
            }
            ...
            FSServiceOrder newServiceOrderRow = CRExtensionHelper.InitNewServiceOrder(fsCreateServiceOrderOnOpportunityFilterRow.SrvOrdType, ID.SourceType_ServiceOrder.OPPORTUNITY);
            ...
            CRExtensionHelper.UpdateServiceOrderHeader(
                                                        ...
                                                        crOpportunityRow,
                                                        fsCreateServiceOrderOnOpportunityFilterRow,
