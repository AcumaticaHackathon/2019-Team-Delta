...
namespace PX.Objects.FS
{
    public class ServiceContractScheduleEntry : ServiceContractScheduleEntryBase<ServiceContractScheduleEntry, 
                                                        ...
                                                        FSContractSchedule.entityID, FSContractSchedule.customerID>, IGraphWithInitialization
    {
        [InjectDependency]
        ...
        protected virtual void FSContractSchedule_EntityID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            ...
            if (fsScheduleRow.CustomerID != null && fsScheduleRow.EntityID != null)
            {
                ...
                .Select(this, fsScheduleRow.CustomerID, fsScheduleRow.EntityID);
