...
namespace PX.Objects.GL
{
	...
	public partial class GLTran : PX.Data.IBqlTable, IAccountable
	{
		...
		[ActiveProjectOrContractForGLAttribute(AccountFieldType = typeof(accountID), FieldClass = ProjectAttribute.DimensionName)]
		...
		#endregion
		#region IsNonPM
		public abstract class isNonPM : PX.Data.IBqlField
		{
		}
	...
	//	[PXDBDecimal(4)]
		...
		/// see the descriptions of the corresponding fields in the <see cref="Batch"/> class.
		/// </value>
		[TranPeriodID(typeof(GLTran.tranDate), typeof(GLTran.branchID))]
		...
		#endregion
        #region ReclassType
        public abstract class reclassType : PX.Data.IBqlField { }
        ...
        public abstract class curyReclassRemainingAmt : PX.Data.IBqlField { }
        ...
        public abstract class reclassRemainingAmt : PX.Data.IBqlField { }
        ...
        #endregion
        #region OrigTranDate
        public abstract class reclassOrigTranDate : IBqlField { }
		...
		public abstract class reclassTotalCount : IBqlField { }
		...
		public abstract class reclassReleasedCount : IBqlField { }
