...
namespace PX.Objects.GL
{
	...
	public static class BatchModule
	{
		...
		public class NumberingAttribute : AutoNumberAttribute
		{
            private static string[] _Modules
            {
                get
                {
                    return new string[] { GL, AP, AR, CM, CA, IN, DR, FA, PM };
                }
            }
	...
	public partial class Batch : PX.Data.IBqlTable
	{
        ...
        /// <summary>
        /// Identifier of the <see cref="PX.Objects.GL.Obsolete.FinPeriod">Financial Period</see> of the batch.
        /// </summary>
        /// <value>
        ...
        /// </value>
		[TranPeriodID(typeof(Batch.dateEntered), typeof(Batch.branchID))]
        ...
        public abstract class hasRamainingAmount : IBqlField { }
