...
namespace PX.Objects.CR
{
	public class CREmailActivityMaint : CRBaseActivityMaint<CREmailActivityMaint, CRSMEmail>
	{
		...
		private Int32? GetDefaultAccountId(Guid? owner)
		{
			...
			var currentSelectAccount = new PXSelect<UserPreferences, Where<UserPreferences.userID, Equal<Required<AccessInfo.userID>>>>(this);
			UserPreferences curaccount = currentSelectAccount.SelectSingle(Accessinfo.UserID);
			if (curaccount.DefaultEMailAccountID != null)
				return curaccount.DefaultEMailAccountID;
