...
namespace PX.Objects.CR
{
	...
	[DebuggerDisplay("Contact: ContactID = {ContactID,nq}, ContactType = {ContactType}, MemberName = {MemberName}")]
	public partial class Contact : IBqlTable, IContactBase, IAssign, IPXSelectable, CRDefaultMailToAttribute.IEmailMessageTarget, IConsentable
	{
		#region Selected
		...
		public abstract class consentAgreement : IBqlField { }
		...
		#region ConsentDate
		public abstract class consentDate : IBqlField { }
		...
		public abstract class consentExpirationDate : IBqlField { }
    ...
    [Serializable]
	[PXProjection(typeof(Select<Contact, Where<Contact.contactType, Equal<ContactTypesAttribute.lead>, Or<Contact.contactType, Equal<ContactTypesAttribute.person>>>>), Persistent = false)]
