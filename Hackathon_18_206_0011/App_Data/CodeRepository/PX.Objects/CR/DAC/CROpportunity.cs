...
namespace PX.Objects.CR
{
    ...
    public partial class CROpportunity : IBqlTable, IAssign, IPXSelectable, INotable
	{
        ...
        [PXDBInt(BqlField = typeof(Standalone.CROpportunity.convertedLeadID))]
		...
		public abstract class curyRawAmount : PX.Data.IBqlField { }
		...
		[PXNote(
			...
			ShowInReferenceSelector = true, BqlField = typeof(Standalone.CROpportunity.noteID))]
		public virtual Guid? NoteID { get; set; }
		#endregion

		#region QuoteNoteID
		public abstract class quoteNoteID : PX.Data.IBqlField { }
		[PXExtraKey()]
		...
		public abstract class quoteOpportunityID : PX.Data.IBqlField { }
		[PXExtraKey()]
		...
		public abstract class primaryQuoteID : PX.Data.IBqlField { }
		[PXExtraKey()]
		...
		public abstract class primaryQuoteType : PX.Data.IBqlField { }
        ...
        [PXFormula(typeof(Switch<
			Case<Where<Current2<source>, IsNull, And<contactID, IsNotNull>>, IsNull<Selector<contactID, Contact.source>, Current<source>>>, 
			source>))]
        ...
        [PXDBCreatedDateTimeUtc(BqlField = typeof(Standalone.CROpportunity.createdDateTime))]
        ...
        [PXDBLastModifiedDateTimeUtc(BqlField = typeof(Standalone.CROpportunity.lastModifiedDateTime))]
