...
namespace PX.Objects.CR
{
	...
	public static class Messages
	{
		...
		public const string SalesOrderHasOnlyNonInventoryLines = "The opportunity contains one or multiple product lines with no inventory item specified. You can create an invoice now. If you want to create a sales order, you may need to first review the product lines and specify inventory items where necessary because only lines with inventory items can be included in sales orders.";
		...
		public const string QuoteSubmittedReadonly = "The opportunity cannot be modified because the primary quote has been submitted.";
