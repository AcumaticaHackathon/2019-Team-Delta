...
namespace PX.Objects.AR
{
    ...
    class OldInvoiceDateRefresher
    {
        ...
        public void CommitRefresh(PXGraph graph)
        {
            ...
            {
                PXUpdateJoin<
                    Set<ARBalances.oldInvoiceDate, ARInvoiceEarliestDueDate.dueDate>,
                    ARBalances,
                    LeftJoin<ARInvoiceEarliestDueDate,
                        On<ARInvoiceEarliestDueDate.customerID, Equal<ARBalances.customerID>,
                        And<ARInvoiceEarliestDueDate.customerLocationID, Equal<ARBalances.customerLocationID>,
                        And<ARInvoiceEarliestDueDate.branchID, Equal<ARBalances.branchID>>>>>,
                    ...
                    .Update(graph, k.CustomerID, k.CustomerLocationID, k.BranchID);
            }
        }
    }
