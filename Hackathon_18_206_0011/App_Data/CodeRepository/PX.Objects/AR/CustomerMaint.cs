...
namespace PX.Objects.AR
{
				...
				Or<BAccount.type, Equal<BAccountType.combinedType>>>>
	{
		...
		public partial class CustomerBalanceSummary : IBqlTable
		{
			...
			public abstract class retainageBalance : IBqlField { }
			...
			where ParentField : IBqlField
		{
			using (new PXReadBranchRestrictedScope())
			{
				return (ARBalances)PXSelectJoinGroupBy<ARBalances,
					InnerJoin<Override.BAccount, On<Override.BAccount.bAccountID, Equal<ARBalances.customerID>>,
					InnerJoin<Override.Customer, On<Override.Customer.bAccountID, Equal<Override.BAccount.bAccountID>>>>,
					Where<ParentField, Equal<Required<ParentField>>,
						Or<Override.BAccount.bAccountID, Equal<Required<ARBalances.customerID>>>>,
					Aggregate<
		...
		public partial class CustomerBalances : PX.Data.IBqlTable
			...
			#endregion
			#region UnreleasedBalance
			public abstract class unreleasedBalance : IBqlField { }
			...
			#endregion
			#region OpenOrdersBalance
			public abstract class openOrdersBalance : IBqlField { }
		...
		public partial class ChildCustomerBalanceSummary : IBqlTable
		{
			...
			#endregion
			#region SignedDepositsBalance
			public abstract class signedDepositsBalance : IBqlField { }
				...
				if (DefPaymentMethodInstance.Cache.Inserted.Count() > 0)
				{
					...
					if (cpmEnumerator.MoveNext())
					{
						...
						if (current != null && CCProcessingHelper.IsTokenizedPaymentMethod(this, current.PMInstanceID))
						{
							...
							graph.GetOrCreatePaymentProfile(this, new GenericCustomerPaymentMethodAdaper<CustomerPaymentMethod>(DefPaymentMethodInstance),
