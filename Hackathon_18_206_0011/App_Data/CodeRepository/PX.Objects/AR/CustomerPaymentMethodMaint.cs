...
namespace PX.Objects.AR
{
	public class CustomerPaymentMethodMaint : PXGraph<CustomerPaymentMethodMaint, CustomerPaymentMethod>
	{
		...
		public virtual IEnumerable CreateCCPaymentMethodHF(PXAdapter adapter)
		{
			...
			graph.GetCreatePaymentProfileForm(this, new GenericCustomerPaymentMethodAdaper<CustomerPaymentMethod>(CustomerPaymentMethod));
			return adapter.Get();
		}
		...
		public virtual IEnumerable SyncCCPaymentMethods(PXAdapter adapter)
		{
			...
			if (!isIDFilled)
			{
				graph.GetNewPaymentProfiles(this, new GenericCustomerPaymentMethodAdaper<CustomerPaymentMethod>(CustomerPaymentMethod), 
					new GenericCustomerPaymentMethodDetailAdapter<CustomerPaymentMethodDetail>(DetailsAll));
			}
			else
			{
		...
		public override void Persist()
		{
				...
				&& CCProcessingHelper.IsTokenizedPaymentMethod(this, CustomerPaymentMethod.Current.PMInstanceID))
			{
				...
				graph.GetOrCreatePaymentProfile(this, new GenericCustomerPaymentMethodAdaper<CustomerPaymentMethod>(CustomerPaymentMethod), 
					new GenericCustomerPaymentMethodDetailAdapter<CustomerPaymentMethodDetail>(DetailsAll));
			}
