...
namespace PX.Objects.AR
{
	...
	public class ARFinChargesApplyMaint : PXGraph<ARFinChargesApplyMaint>
	{
		...
		private static void CreateFCDoc(List<ARFinChargesDetails> list, ARFinChargesApplyParameters filter)
		{
			...
			FinPeriod finPeriod = ie.GetService<IFinPeriodRepository>().FindByID(PXAccess.GetParentOrganizationID(PXAccess.GetBranchID()), filter.FinPeriodID);
			ie.GetService<IFinPeriodUtils>().CanPostToPeriod(finPeriod).RaiseIfHasError();
