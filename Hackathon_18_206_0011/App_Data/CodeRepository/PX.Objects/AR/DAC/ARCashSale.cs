...
namespace PX.Objects.AR.Standalone
{
	...
	public class ARCashSale : ARRegister, ICCPayment, IApprovable, IApprovalDescription
	{
		...
		public abstract class curyOrigTaxDiscAmt : IBqlField
		{
		}
		...
		public abstract class origTaxDiscAmt : IBqlField
		{
		}
		...
		[TranPeriodID(typeof(ARCashSale.adjDate), typeof(ARCashSale.branchID), BqlField = typeof(ARPayment.adjTranPeriodID))]
		...
		[FinPeriodID(typeof(ARCashSale.docDate), typeof(ARCashSale.branchID), BqlField = typeof(ARRegister.tranPeriodID))]
		...
		[FinPeriodID(typeof(ARCashSale.docDate), typeof(ARCashSale.branchID), BqlField = typeof(ARRegister.finPeriodID))]
        [PXDefault()]
		[PXUIField(DisplayName = "Post Period", Visibility = PXUIVisibility.SelectorVisible)]
