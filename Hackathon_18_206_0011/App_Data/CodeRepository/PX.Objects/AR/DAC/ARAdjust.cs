...
namespace PX.Objects.AR
{
	...
	[PXDefault(typeof(ARPayment.adjCntr))]
		...
		[FinPeriodID(typeof(ARAdjust.adjdDocDate), typeof(ARAdjust.adjdBranchID))]
		...
		[TranPeriodID(typeof(ARAdjust.adjdDocDate), typeof(ARAdjust.adjdBranchID))]
		...
		//TODO 000 Pank DisplayFinPeriodID
	...
	public partial class ARAdjust2 : PX.Objects.AR.ARAdjust
	{
		...
		[FinPeriodID(typeof(ARAdjust2.adjdDocDate), typeof(ARAdjust2.adjdBranchID))]
		[PXDBDefault(typeof(AR.ARInvoice.finPeriodID))]
		...
		[PXDBCurrency(typeof(ARAdjust2.adjdCuryInfoID), typeof(ARAdjust2.adjAmt), MinValue = 0)]
		[PXUIField(DisplayName = Messages.AmountPaid, Visibility = PXUIVisibility.Visible)]
		[PXDefault(TypeCode.Decimal, "0.0")]
