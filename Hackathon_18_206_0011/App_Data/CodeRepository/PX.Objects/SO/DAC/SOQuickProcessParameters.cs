...
{	
	...
	public class SOQuickProcessParameters : IBqlTable
	{
		...
		[PXParent(typeof(Select<SOOrderType, Where<SOOrderType.orderType, Equal<Current<orderType>>>>))]
		...
		public abstract class createShipment : IBqlField { }
		...
		public abstract class confirmShipment : IBqlField { }
		#endregion
		#region UpdateIN
		...
		public abstract class updateIN : IBqlField { }
		#endregion
		...
		public abstract class prepareInvoiceFromShipment : IBqlField { }
		#endregion
		...
		public abstract class prepareInvoice : IBqlField { }
		#endregion
		#region EmailInvoice
		...
		public abstract class releaseInvoice : IBqlField { }
		#endregion
		#region AutoRedirect
		...
		public abstract class autoRedirect : IBqlField { }
		#endregion
		...
		public abstract class autoDownloadReports : IBqlField { }
		#endregion
	}
	...
	public sealed class SOQuickProcessParametersReportsExt : PXCacheExtension<SOQuickProcessParameters>
	{
		...
		public abstract class printPickList : IBqlField { }
		#endregion
		#region PrintLabels
		...
		public abstract class printLabels : IBqlField { }
		#endregion
		...
		public abstract class printConfirmation : IBqlField { }
		#endregion
		#region PrintInvoice
	...
	public sealed class SOQuickProcessParametersAvailabilityExt : PXCacheExtension<SOQuickProcessParameters>
	{
		...
		public static class Msg
		{
			...
			public class canShipAll : ConstantMessage { public canShipAll() : base(CanShipAll) { } }
			public class canShipPartCancelRemainder : ConstantMessage { public canShipPartCancelRemainder() : base(CanShipPartCancelRemainder) { } }
			public class canShipPartBackOrder : ConstantMessage { public canShipPartBackOrder() : base(CanShipPartBackOrder) { } }
			public class nothingToShip : ConstantMessage { public nothingToShip() : base(NothingToShip) { } }
			public class nothingToShipAtAll : ConstantMessage { public nothingToShipAtAll() : base(NothingToShipAtAll) { } }
			public class noItemsAvailableToShip : ConstantMessage { public noItemsAvailableToShip() : base(NoItemsAvailableToShip) { } }
		}

		#region AvailabilityStatus
		[PXString]
		public string AvailabilityStatus { get; set; }
		public abstract class availabilityStatus : IBqlField { }
		#endregion
		#region SuccessIcon
		[PXBool]
		...
		public abstract class greenStatus : IBqlField { }
		#endregion
		#region WarningIcon
		[PXBool]
		[PXDefault(true, PersistingCheck = PXPersistingCheck.Nothing)]
		...
		public abstract class yellowStatus : IBqlField { }
		#endregion
		#region ErrorIcon
		[PXBool]
		[PXDefault(true, PersistingCheck = PXPersistingCheck.Nothing)]
		...
		public abstract class redStatus : IBqlField { }
		#endregion
		#region Message
		...
		public abstract class availabilityMessage : IBqlField { }
		#endregion
		...
		public abstract class skipByDateMsg : IBqlField { }
		#endregion
	}
	...
	public static class AvailabilityStatus
	{
		...
		public class canShipAll : Constant<string> { public canShipAll() :base(CanShipAll) { } }
		public class canShipPartCancelRemainder : Constant<string> { public canShipPartCancelRemainder() : base(CanShipPartCancelRemainder) { } }
		public class canShipPartBackOrder : Constant<string> { public canShipPartBackOrder() : base(CanShipPartBackOrder) { } }
		public class nothingToShip : Constant<string> { public nothingToShip() : base(NothingToShip) { } }
		public class nothingToShipAtAll : Constant<string> { public nothingToShipAtAll() : base(NothingToShipAtAll) { } }
		public class noItemsAvailableToShip : Constant<string> { public noItemsAvailableToShip() : base(NoItemsAvailableToShip) { } }
	}
	...
	public sealed class SOQuickProcessParametersShipDateExt : PXCacheExtension<SOQuickProcessParameters>
	{
		...
		public abstract class shipDateMode : IBqlField { }
		#endregion
		#region ShipDate
		[PXDate]
		...
		public abstract class today : IBqlField { }
		[PXDate]
		public DateTime? Tomorrow { get { return Today.With(d => d.AddDays(1)); } set { } }
		public abstract class tomorrow : IBqlField { }
	...
	public static class ShipDateMode
	{
		...
		public class today : Constant<short> { public today() : base(Today) { } }
		public class tomorrow : Constant<short> { public tomorrow() : base(Tomorrow) { } }
		public class custom : Constant<short> { public custom() : base(Custom) { } }
	}
	...
	public sealed class SOQuickProcessParametersPrinterExt : PXCacheExtension<SOQuickProcessParameters>, PX.SM.IPrintable
	{
		...
		public abstract class hideWhenNothingToPrint : IBqlField { }
		#endregion
		...
		[PXFormula(typeof(IIf<Where<printWithDeviceHub, Equal<False>, Or<definePrinterManually, Equal<False>>>, Null, printerName>))]
		[ReportsPrintingSetting(nameof(PrinterName))]
