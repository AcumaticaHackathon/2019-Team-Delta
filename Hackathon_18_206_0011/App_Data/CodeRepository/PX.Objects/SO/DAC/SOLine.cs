...
namespace PX.Objects.SO
{
	...
	public partial class SOLine : PX.Data.IBqlTable, ILSPrimary, IHasMinGrossProfit, ISortOrder
	{
		#region Keys
		public class PK : PrimaryKeyOf<SOLine>.By<orderType, orderNbr, lineNbr>
		{
			...
			[Obsolete("The method is kept for binary compatibility and will be removed in 2019R1")]
			public static SOLine Find(PXGraph graph, string orderType, string orderNbr, int lineNbr) => FindBy(graph, orderType, orderNbr, lineNbr);
		}
		public class SOOrderFK : SOOrder.PK.ForeignKeyOf<SOLine>.By<orderType, orderNbr> { }
		public class InventoryFK : InventoryItem.PK.ForeignKeyOf<SOLine>.By<inventoryID> { }
		#endregion
		...
		[PXRestrictor(typeof(Where2<SameOrganizationBranch<INSite.branchID, Current<SOOrder.branchID>>,
			Or2<FeatureInstalled<FeaturesSet.interBranch>, Or<Current<SOOrder.behavior>, Equal<SOBehavior.qT>>>>), Common.Messages.InterBranchFeatureIsDisabled)]
		...
		[CostCode(typeof(salesAcctID), typeof(taskID), GL.AccountType.Income)]
