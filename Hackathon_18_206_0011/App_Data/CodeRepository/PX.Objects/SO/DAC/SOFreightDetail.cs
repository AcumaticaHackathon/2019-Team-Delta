namespace PX.Objects.SO
{
	...
	public partial class SOFreightDetail : PX.Data.IBqlTable, IFreightBase
	{
		...
		[PXSelector(typeof(Search<SOOrderShipment.shipmentNbr, Where<SOOrderShipment.orderType, Equal<Current<SOFreightDetail.orderType>>, And<SOOrderShipment.orderNbr, Equal<Current<SOFreightDetail.orderNbr>>, And<SOOrderShipment.shipmentType, Equal<Current<SOFreightDetail.shipmentType>>>>>>), DirtyRead = true)]
