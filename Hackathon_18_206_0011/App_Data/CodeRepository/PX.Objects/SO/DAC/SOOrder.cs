    ...
    public partial class SOOrder : PX.Data.IBqlTable, PX.Data.EP.IAssign, IFreightBase, ICCAuthorizePayment, ICCCapturePayment, IInvoice
	{
		...
		[SO.RefNbr(typeof(Search2<SOOrder.orderNbr,
			...
			Where<SOOrder.orderType, Equal<Optional<SOOrder.orderType>>,
				And<Where<SOOrderType.aRDocType, Equal<ARDocType.noUpdate>,
		...
		public abstract class overrideFreightAmount : IBqlField
		{
		}
		[PXDBBool]
		[PXDefault(false)]
		...
		public abstract class willCall : PX.Data.IBqlField { }
		#endregion
		...
		/// </summary>
		public abstract class paymentProfileID : IBqlField
		{ }
