...
namespace PX.Objects.SO
{
	...
	public static class Messages
	{
		...
		[Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
		public const string SOExternalTaxCalcProcess = "SO External Tax Calculation Process";
        ...
        public const string CannotSelectSpecificSOLine = "Cannot find Sales Order line using the parameters provided.";
		...
		public const string UnableToProcessUnconfirmedShipment = "Unable to process unconfirmed shipment {0}.";
