...
namespace PX.Objects.SO
{
	public class SOPackageEngine
	{
		...
		[Obsolete("Use PackByWeight(List<INItemBoxEx>, decimal, decimal, int) instead")]
		public virtual List<BoxInfo> PackByWeight(List<INItemBoxEx> boxes, decimal baseWeight, decimal baseQty) => PackByWeight(boxes, baseWeight, baseQty, -1);
