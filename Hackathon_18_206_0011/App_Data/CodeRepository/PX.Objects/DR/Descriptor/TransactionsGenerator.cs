...
namespace PX.Objects.DR
{
	public class TransactionsGenerator
	{
		...
		private void SetAmounts(IList<DRScheduleTran> deferredTransactions, decimal deferredAmount, DRSchedule schedule, int? organizationID)
		{
			switch (_code.Method)
			{
				...
				case DeferredMethodType.ProrateDays:
					SetAmountsProrateDays(deferredTransactions, deferredAmount, schedule.DocDate.Value, organizationID);
					break;
				...
				case DeferredMethodType.FlexibleProrateDays:
					SetAmountsFlexibleProrateByDays(deferredTransactions, deferredAmount, schedule.TermStartDate.Value, schedule.TermEndDate.Value, organizationID);
					break;
				case DeferredMethodType.FlexibleExactDays:
					SetAmountsFlexibleByDays(deferredTransactions, deferredAmount, schedule.TermStartDate.Value, schedule.TermEndDate.Value, organizationID);
					break;
			}
		}
