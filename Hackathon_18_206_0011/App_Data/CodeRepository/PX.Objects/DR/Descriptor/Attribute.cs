...
namespace PX.Objects.DR
{
	...
	public class DRComponentSelectorAttribute : PXSelectorAttribute
	{
		...
		public DRComponentSelectorAttribute()
			: base(typeof(Search<InventoryItem.inventoryID, Where<InventoryItem.itemStatus, NotEqual<InventoryItemStatus.unknown>>>), new Type[] { typeof(InventoryItem.inventoryCD), typeof(InventoryItem.descr) })
		{
		}
