...
namespace PX.Objects
{
	public abstract class DefaultEndpointImpl
	{
		...
		protected void AccountByPeriodInquiry_Insert(PXGraph graph, EntityImpl entity, EntityImpl targetEntity)
		{
			...
			accountHistoryByYearEnq.Filter.Cache.SetValueExt<AccountByYearFilter.branchID>(
				accountHistoryByYearEnq.Filter.Current, values.GetOrDefault("BranchID", null));
			accountHistoryByYearEnq.Filter.Cache.SetValueExt<AccountByYearFilter.ledgerID>(
				accountHistoryByYearEnq.Filter.Current, values.GetOrDefault("Ledger", null));
			accountHistoryByYearEnq.Filter.Cache.SetValueExt<AccountByYearFilter.accountID>(
				accountHistoryByYearEnq.Filter.Current, values.GetOrDefault("Account", null));
			accountHistoryByYearEnq.Filter.Cache.SetValueExt<AccountByYearFilter.subCD>(
				accountHistoryByYearEnq.Filter.Current, values.GetOrDefault("Subaccount", null)?.Replace("-", string.Empty));
			accountHistoryByYearEnq.Filter.Cache.SetValueExt<AccountByYearFilter.finYear>(
				accountHistoryByYearEnq.Filter.Current, values.GetOrDefault("FinancialYear", null));
		...
		protected void AccountBySubaccountInquiry_Insert(PXGraph graph, EntityImpl entity, EntityImpl targetEntity)
		{
			...
			Dictionary<string, string> values = entity.Fields.OfType<EntityValueField>().ToDictionary(f => f.Name, f => f.Value);
			AccountHistoryBySubEnq.Filter.Cache.SetValueExt<GLHistoryEnqFilter.branchID>(
				AccountHistoryBySubEnq.Filter.Current, values.GetOrDefault("Branch", null));
			AccountHistoryBySubEnq.Filter.Cache.SetValueExt<GLHistoryEnqFilter.ledgerID>(
				AccountHistoryBySubEnq.Filter.Current, values.GetOrDefault("Ledger", null));
			AccountHistoryBySubEnq.Filter.Cache.SetValueExt<GLHistoryEnqFilter.accountID>(
				AccountHistoryBySubEnq.Filter.Current, values.GetOrDefault("Account", null));
			AccountHistoryBySubEnq.Filter.Cache.SetValueExt<GLHistoryEnqFilter.subCD>(
				AccountHistoryBySubEnq.Filter.Current, values.GetOrDefault("Subaccount", null)?.Replace("-", string.Empty));
			AccountHistoryBySubEnq.Filter.Cache.SetValueExt<GLHistoryEnqFilter.finPeriodID>(
				AccountHistoryBySubEnq.Filter.Current, values.GetOrDefault("Period", null)?.Replace("-", string.Empty));
		...
		protected void AccountDetailsInquiry_Insert(PXGraph graph, EntityImpl entity, EntityImpl targetEntity)
		{
			...
			Dictionary<string, string> values = entity.Fields.OfType<EntityValueField>().ToDictionary(f => f.Name, f => f.Value);
			accountDetailsEnq.Filter.Cache.SetValueExt<AccountByPeriodFilter.branchID>(
				accountDetailsEnq.Filter.Current, values.GetOrDefault("Branch", null));
			accountDetailsEnq.Filter.Cache.SetValueExt<AccountByPeriodFilter.ledgerID>(
				accountDetailsEnq.Filter.Current, values.GetOrDefault("Ledger", null));
			accountDetailsEnq.Filter.Cache.SetValueExt<AccountByPeriodFilter.accountID>(
				accountDetailsEnq.Filter.Current, values.GetOrDefault("Account", null));
			accountDetailsEnq.Filter.Cache.SetValueExt<AccountByPeriodFilter.subCDWildcard>(
				accountDetailsEnq.Filter.Current, values.GetOrDefault("Subaccount", null)?.Replace("-", string.Empty));
			accountDetailsEnq.Filter.Cache.SetValueExt<AccountByPeriodFilter.startPeriodID>(
				accountDetailsEnq.Filter.Current, values.GetOrDefault("FromPeriod", null)?.Replace("-", string.Empty));
			accountDetailsEnq.Filter.Cache.SetValueExt<AccountByPeriodFilter.endPeriodID>(
				accountDetailsEnq.Filter.Current, values.GetOrDefault("ToPeriod", null)?.Replace("-", string.Empty));
		...
		private static void FillInvoiceRowFromEntiry(SOInvoiceEntry graph, EntityImpl targetEntity, ARTran row)
		{
			...
			if (location != null)
			{
				row.LocationID = PXSelect<INLocation, Where<INLocation.locationCD, Equal<Required<INLocation.locationCD>>>>.Select(graph, location).FirstOrDefault()?.GetItem<INLocation>().LocationID;
			}
			if (warehouseID != null)
			{
		...
		protected virtual void BillDetail_Insert(PXGraph graph, EntityImpl entity, EntityImpl targetEntity)
		{
			...
			if (insertViaAddPO)
			{
                ...
                var orders = orderGraphExtension.poorderslist.Select().Select(r => r.GetItem<APInvoiceEntry.POOrderRS>());
