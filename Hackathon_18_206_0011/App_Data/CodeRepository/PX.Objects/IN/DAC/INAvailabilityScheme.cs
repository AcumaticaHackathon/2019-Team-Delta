...
namespace PX.Objects.IN
{
	...
	public class INAvailabilityScheme : IBqlTable
	{
        ...
        public abstract class inclQtyFSSrvOrdBooked : IBqlField { }
        [PXDBBool]
        [PXDefault(true)]
        ...
        public abstract class inclQtyFSSrvOrdAllocated : IBqlField { }
        [PXDBBool]
        [PXDefault(true)]
        ...
        public abstract class inclQtyFSSrvOrdPrepared : IBqlField { }
        [PXDBBool]
        [PXDefault(true)]
