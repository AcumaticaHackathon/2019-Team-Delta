...
namespace PX.Objects.IN
{
	...
	public partial class INRegister : PX.Data.IBqlTable
	{
        ...
        #endregion
		#region SrcDocType
		public abstract class srcDocType : IBqlField { }
		/// <summary>
		...
		#endregion
		#region SrcRefNbr
		public abstract class srcRefNbr : IBqlField { }
		/// <summary>
		/// The field is used for consolidation by source document (Shipment or Invoice for direct stock item lines) of IN Issues created from one Invoice
		/// </summary>
		...
		[INOpenPeriod(typeof(INRegister.tranDate), typeof(INRegister.branchID), RaiseErrorOnInactiveOrLockedPeriod = true)]
		...
		[TranPeriodID(typeof(INRegister.tranDate), typeof(INRegister.branchID))]
