...
namespace PX.Objects.IN
{
	...
	public partial class InventoryItem : PX.Data.IBqlTable, PX.SM.IIncludable, ILotSerNumVal
	{
		...
		[PXDefault(typeof(Search<INItemClass.hSTariffCode,
							Where<INItemClass.itemClassID, Equal<Current<InventoryItem.itemClassID>>>>),
			PersistingCheck = PXPersistingCheck.Nothing)]
		[PXFormula(typeof(Default<InventoryItem.itemClassID>))]
		public virtual string HSTariffCode { get; set; }

		public abstract class hSTariffCode : IBqlField { }
		#endregion

		#region CountryOfOrigin
		[PXDBString(100, IsUnicode = true)]
		[PXUIField(DisplayName = "Country Of Origin")]
		[PXDefault(typeof(Search<INItemClass.countryOfOrigin,
							Where<INItemClass.itemClassID, Equal<Current<InventoryItem.itemClassID>>>>),
			PersistingCheck = PXPersistingCheck.Nothing)]
		[PXFormula(typeof(Default<InventoryItem.itemClassID>))]
		[Country]
		...
		public abstract class countryOfOrigin : IBqlField { }
		#endregion
