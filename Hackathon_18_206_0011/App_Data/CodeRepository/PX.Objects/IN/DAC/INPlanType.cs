namespace PX.Objects.IN
{
	...
	public partial class INPlanType : PX.Data.IBqlTable
	{
        ...
        // M9
        public abstract class inclQtyProdFixedPurchase : PX.Data.IBqlField
	    {
	    }
        ...
        // MA
	    public abstract class inclQtyProdFixedProduction : PX.Data.IBqlField
	    {
	    }
	    ...
	    // MB
	    public abstract class inclQtyProdFixedProdOrdersPrepared : PX.Data.IBqlField
	    {
	    }
	    ...
	    // MC
	    public abstract class inclQtyProdFixedProdOrders : PX.Data.IBqlField
	    {
	    }
	    ...
	    // MD
	    public abstract class inclQtyProdFixedSalesOrdersPrepared : PX.Data.IBqlField
	    {
	    }
	    ...
	    // ME
	    public abstract class inclQtyProdFixedSalesOrders : PX.Data.IBqlField
	    {
	    }
        ...
        public abstract class inclQtyFixedFSSrvOrd : IBqlField { }
        ...
        public abstract class inclQtyPOFixedFSSrvOrd : IBqlField { }
        ...
        public abstract class inclQtyPOFixedFSSrvOrdPrepared : IBqlField { }
        ...
        public abstract class inclQtyPOFixedFSSrvOrdReceipts : IBqlField { }
	...
	public class INPlanConstants
	{
        ...
        */
	    ...
	    public class planM9 : Constant<string>
	    {
	        public planM9() : base(PlanM9) { }
	    }

	    public class planMA : Constant<string>
	    {
	        public planMA() : base(PlanMA) { }
	    }

	    public class planMB : Constant<string>
	    {
	        public planMB() : base(PlanMB) { }
	    }

	    public class planMC : Constant<string>
	    {
	        public planMC() : base(PlanMC) { }
	    }

	    public class planME : Constant<string>
	    {
	        public planME() : base(PlanME) { }
	    }

	    public class planMD : Constant<string>
	    {
	        public planMD() : base(PlanMD) { }
	    }
        public class planF0 : Constant<string>
        {
            public planF0() : base(PlanF0) {; }
        }

        public class planF1 : Constant<string>
        {
            public planF1() : base(PlanF1) {; }
        }

        public class planF2 : Constant<string>
        {
            public planF2() : base(PlanF2) {; }
        }

        public class planF5 : Constant<string>
        {
            public planF5() : base(PlanF5) {; }
        }

        public class planF6 : Constant<string>
        {
            public planF6() : base(PlanF6) {; }
        }
        public class planF7 : Constant<string>
        {
            public planF7() : base(PlanF7) {; }
        }
        public class planF8 : Constant<string>
        {
            public planF8() : base(PlanF8) {; }
        }
        public class planF9 : Constant<string>
        {
