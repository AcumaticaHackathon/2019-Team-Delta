...
namespace PX.Objects.IN
{
    ...
    public class INDocumentRelease : PXGraph<INDocumentRelease>
    {
	    ...
	    public static void ReleaseDoc(List<INRegister> list, bool isMassProcess) => ReleaseDoc(list, isMassProcess, PXQuickProcess.ActionFlow.NoFlow);
    ...
    public class INReleaseProcess : PXGraph<INReleaseProcess>
    {
		...
		public PXSelect<POReceiptLineCost> poreceiptcostupdate;
		...
		public virtual JournalEntry CreateJournalEntry()
		{
			...
			if (UpdateGL)
			{
				this.Caches[typeof(Sub)] = je.Caches[typeof(Sub)];
			}
        ...
        public virtual INTransitLine GetTransitLine(INTran tran)
        {
            ...
            if (ntlloc == null)
            {
	            ...
	            INTranSplit split = PXSelectReadonly<INTranSplit,
				    ...
				    And<INTranSplit.tranType, Equal<Current<INTran.tranType>>>>>>.SelectSingleBound(this, new object[] { tran });
		...
		/// </summary>
		[Obsolete("This method has been deprecated and will be renamed in Acumatica ERP 2019R1.")]
        public virtual void UpdateLayerAccountSub(INTranSplit split, InventoryItem item, INCostStatus layer, List<object> costStatuses, bool updateAccountSub)
        {
			...
			if (!negQtyAdj && !costAdj || !item.ValMethod.IsIn(INValMethod.Average, INValMethod.FIFO))
            {
                        return;
                    }
        ...
        public virtual void ReceiveCost(INTran tran, INTranSplit split, InventoryItem item, bool correctImbalance)
        {
            if (tran.InvtMult == (short)1 && tran.TranType != INTranType.Transfer && (split.InvtMult == (short)1 || item.ValMethod != INValMethod.Standard && !correctImbalance || item.ValMethod == INValMethod.Standard && correctImbalance) || (tran.InvtMult == (short)0 && !IsUnmanagedTran(tran)))
            {
                ...
                if (exactCostStatus != null)
                {
                    ...
                    cmd.Cache.SetStatus(exactCostStatus, PXEntryStatus.Held);
                ...
                if (cmd != null)
                {
                    ...
                    if (tran.InvtMult == (short)1 && QtyUnCosted > 0m)
                    {
                        ...
                        var siteAndLocation = (PXResult<INSite, INLocation>)
                            ...
                            InnerJoin<INLocation, On<INLocation.siteID, Equal<INSite.siteID>>>,
		...
		[Obsolete("The method is obsolete and will be removed in Acumatica 2018R2. Use virtual non-generic method.")]
        ...
        {
            ReasonCode reasoncode = (tranreasoncode.AccountID == null) ? defreasoncode : tranreasoncode;
			return GetReasonCodeSubID(this, reasoncode, item, site, postclass, typeof(Field));
		}
		...
		[Obsolete("The method is obsolete and will be removed in Acumatica 2018R2. Use non-generic method.")]
        ...
        {
			return (reasoncode.AccountID == null) ? null
				: GetReasonCodeSubID(graph, reasoncode, item, site, postclass, typeof(Field));
		}
		...
		public virtual int? GetCogsAcctID(InventoryItem item, INSite site, INPostClass postclass, INTran tran, bool useTran)
		{
			...
			return GetAccountDefaults<INPostClass.cOGSAcctID>(this, item, site, postclass, useTran ? tran : null, out isControlAccount);
		}

		public virtual int? GetCogsSubID(InventoryItem item, INSite site, INPostClass postclass, INTran tran, bool useTran)
		{
			bool isControlAccount;
			return GetAccountDefaults<INPostClass.cOGSSubID>(this, item, site, postclass, useTran ? tran : null, out isControlAccount);
		}

		public virtual int? GetInvtAcctID(InventoryItem item, INSite site, INPostClass postclass, INTran tran, bool useTran)
		{
			bool isControlAccount;
			return GetAccountDefaults<INPostClass.invtAcctID>(this, item, site, postclass, useTran ? tran : null, out isControlAccount);
		}

		public virtual int? GetInvtSubID(InventoryItem item, INSite site, INPostClass postclass, INTran tran, bool useTran)
		{
			bool isControlAccount;
			return GetAccountDefaults<INPostClass.invtSubID>(this, item, site, postclass, useTran ? tran : null, out isControlAccount);
		}

		public virtual int? GetSalesAcctID(InventoryItem item, INSite site, INPostClass postclass, INTran tran, bool useTran)
		{
			bool isControlAccount;
			return GetAccountDefaults<INPostClass.salesAcctID>(this, item, site, postclass, useTran ? tran : null, out isControlAccount);
		}

		public virtual int? GetSalesSubID(InventoryItem item, INSite site, INPostClass postclass, INTran tran, bool useTran)
		{
			bool isControlAccount;
			return GetAccountDefaults<INPostClass.salesSubID>(this, item, site, postclass, useTran ? tran : null, out isControlAccount);
		}

		public virtual int? GetStdCostVarAcctID(InventoryItem item, INSite site, INPostClass postclass, INTran tran, bool useTran)
		{
			bool isControlAccount;
			return GetAccountDefaults<INPostClass.stdCstVarAcctID>(this, item, site, postclass, useTran ? tran : null, out isControlAccount);
		}

		public virtual int? GetStdCostVarSubID(InventoryItem item, INSite site, INPostClass postclass, INTran tran, bool useTran)
		{
			bool isControlAccount;
			return GetAccountDefaults<INPostClass.stdCstVarSubID>(this, item, site, postclass, useTran ? tran : null, out isControlAccount);
        }

		[Obsolete("The method is obsolete and will be removed in Acumatica 2018R2. Use virtual non-generic methods.")]
            ...
            else
            {
                switch (tran.TranType)
                {
					...
					case INTranType.Adjustment:
						if (tran.InvtAcctID == null)
						{
							if (tran.POReceiptType == PO.POReceiptType.POReturn && reasoncode.Usage == ReasonCodeUsages.VendorReturn)
							{
								tran.InvtAcctID = GetCogsAcctID(item, null, postclass, tran, false);
								tran.InvtSubID = GetCogsSubID(item, null, postclass, tran, false);
							}
		...
		public virtual POReceiptLineCost UpdatePOReceiptCost(INTran tran, INTranCost tranCost, InventoryItem item)
		{
			bool updatePOTranCostFinal =
				(tran.TranType == INTranType.Issue || tran.TranType == INTranType.Adjustment && item.ValMethod != INValMethod.Standard)
			...
			var row = new POReceiptLineCost
			{
				ReceiptNbr = tran.POReceiptNbr,
				LineNbr = tran.POReceiptLineNbr,
			};
			row = this.poreceiptcostupdate.Insert(row);
			row.TranCostFinal -= tranCost.InvtMult * tranCost.TranCost;

			return poreceiptcostupdate.Update(row);
		}

		public virtual void UpdatePOReceiptLine(INTran tran)
		{
			if (tran.POReceiptNbr == null || tran.POReceiptLineNbr == null) return;
			var receiptLine = new POReceiptLineUpdate {ReceiptNbr = tran.POReceiptNbr, LineNbr = tran.POReceiptLineNbr};
			receiptLine = this.poreceiptlineupdate.Insert(receiptLine);
			receiptLine.INReleased = tran.Released;
		}
        ...
        public virtual void ReleaseDocProc(JournalEntry je, INRegister doc)
        {
	        ...
	        using (PXTransactionScope ts = new PXTransactionScope())
	        {
		        ...
		        if (unattachedLCtran != null)
		        {
			        ...
			        throw new PXException(inregister.Current.IsPPVTran != true
					        ? PO.Messages.INReceiptMustBeReleasedBeforeLCProcessing
					        : AP.Messages.INReceiptMustBeReleasedBeforePPV, ortran == null ? String.Empty : ortran.RefNbr,
				        unattachedLCtran.POReceiptNbr);
		        }
		        ...
		        foreach (PXResult<INTran, INTranSplit, INItemPlan, INSite> res in PXSelectJoin<INTran,
				        InnerJoin<INTranSplit, On<INTranSplit.tranType, Equal<INTran.tranType>, And<INTranSplit.refNbr,
						        Equal<INTran.refNbr>, And<INTranSplit.lineNbr, Equal<INTran.lineNbr>>>>,
					        InnerJoin<INItemPlan, On<INItemPlan.planID, Equal<INTranSplit.planID>,
							        And<INItemPlan.planType, Equal<INPlanConstants.plan40>>>,
		        ...
		        foreach (PXResult<INTranSplit, INTran, INItemPlan, INPlanType, INItemSite, INSite> res in PXSelectJoin<
			        INTranSplit,
			        InnerJoin<INTran, On<INTran.tranType, Equal<INTranSplit.tranType>, And<INTran.refNbr,
					        Equal<INTranSplit.refNbr>, And<INTran.lineNbr, Equal<INTranSplit.lineNbr>>>>,
				        InnerJoin<INItemPlan, On<INItemPlan.planID, Equal<INTranSplit.planID>>,
					        InnerJoin<INPlanType, On<INPlanType.planType, Equal<INItemPlan.planType>>,
						        LeftJoinSingleTable<INItemSite, On<INItemSite.inventoryID, Equal<INTran.inventoryID>,
		        ...
		        PXResultset<INTran> tranDataRows = mainselect.Select(doc.DocType, doc.RefNbr);
		        ...
		        ValidateFinPeriod(doc, tranDataRows.Cast<PXResult<INTran, InventoryItem, INSite>>());
                    ...
                    foreach (INTranCost costtran in intrancost.Cache.Inserted)
                    {
                        ...
                        if (tran != null)
                        {
							...
							UpdatePOReceiptCost(tran, costtran, (InventoryItem)res);
        ...
        {
            public new class planID : PX.Data.IBqlField
            {
            }
        }
        ...
        protected virtual void ProcessLinkedAllocation(INRegister doc)
        {
            ...
            foreach (PXResult<INItemPlan, INTranSplit, INTran, INPlanType, INItemPlanDemand> res in
                ...
                InnerJoin<INPlanType, On<INPlanType.planType, Equal<INItemPlan.planType>>,
                LeftJoin<INItemPlanDemand, On<INItemPlanDemand.planID, Equal<INItemPlan.demandPlanID>>>>>>,
                ...
                .Select(this, doc.DocType, doc.RefNbr))
            {
                ...
                planlist.Add(new PXResult<INItemPlan, INTranSplit, INTran, INPlanType, INItemPlanDemand>(res, res, res, plantype, res));
	    ...
	    {
		    IFinPeriodUtils finPeriodUtils = GetService<IFinPeriodUtils>();
			...
			{
				INSite siteTo = PXSelect<INSite, Where<INSite.siteID, Equal<Required<INSite.siteID>>>>.Select(this, doc.ToSiteID);
...
namespace PX.Objects.IN.Overrides.INDocumentRelease
{
	...
	[Serializable]
	[PXHidden]
	[POReceiptLineCost.Accumulator(BqlTable = typeof(PO.POReceiptLine))]
	public partial class POReceiptLineCost : IBqlTable
	{
		#region ReceiptNbr
		...
		public class AccumulatorAttribute : PXAccumulatorAttribute
		{
			...
			protected override bool PrepareInsert(PXCache sender, object row, PXAccumulatorCollection columns)
			{
				...
				var returnRow = (POReceiptLineCost)row;

				columns.Update<POReceiptLineCost.tranCostFinal>(returnRow.TranCostFinal, PXDataFieldAssign.AssignBehavior.Replace);
				columns.Update<POReceiptLineCost.lastModifiedByID>(returnRow.LastModifiedByID, PXDataFieldAssign.AssignBehavior.Replace);
				columns.Update<POReceiptLineCost.lastModifiedDateTime>(returnRow.LastModifiedDateTime, PXDataFieldAssign.AssignBehavior.Replace);
				columns.Update<POReceiptLineCost.lastModifiedByScreenID>(returnRow.LastModifiedByScreenID, PXDataFieldAssign.AssignBehavior.Replace);
	...
	[POReceiptLineUpdate.Rule]
	[Serializable]
	public partial class POReceiptLineUpdate : IBqlTable
	{
		public class Rule : PXAccumulatorAttribute
		{
			public Rule()
			{
				this.SingleRecord = true;
				BqlTable = typeof(PO.POReceiptLine);
			}
			...
			protected override bool PrepareInsert(PXCache sender, object row, PXAccumulatorCollection columns)
			{
				...
				columns.UpdateOnly = true;
				columns.Update<POReceiptLineUpdate.iNReleased>(((POReceiptLineUpdate)row).INReleased, PXDataFieldAssign.AssignBehavior.Replace);
		...
		public abstract class iNReleased : PX.Data.IBqlField { }
		#endregion
	}
	...
	public partial class SiteStatus : INSiteStatus, IQtyAllocated
	{
        ...
        public abstract class inclQtyFSSrvOrdPrepared : PX.Data.IBqlField
        {
        }
        ...
        public abstract class inclQtyFSSrvOrdBooked : PX.Data.IBqlField
        {
        }
        ...
        public abstract class inclQtyFSSrvOrdAllocated : PX.Data.IBqlField
        {
        }
    ...
    public partial class SiteLotSerial : INSiteLotSerial, IQtyAllocatedBase
    {
        ...
        [PXDefault(typeof(Search<InventoryItem.itemClassID, Where<InventoryItem.inventoryID, Equal<Current<SiteLotSerial.inventoryID>>>>), CacheGlobal = true, PersistingCheck = PXPersistingCheck.Nothing)]
        public virtual int? ItemClassID
        {
            get
            {
        ...
        protected bool? _NegQty;
        [PXBool()]
        [PXDefault(typeof(Select<INItemClass, Where<INItemClass.itemClassID, Equal<Current<SiteLotSerial.itemClassID>>>>), CacheGlobal = true, SourceField = typeof(INItemClass.negQty), PersistingCheck = PXPersistingCheck.Nothing)]
        [PXDBScalar(typeof(Search2<INItemClass.negQty, 
	        InnerJoin<InventoryItem, 
		        On<InventoryItem.itemClassID, Equal<INItemClass.itemClassID>>>, 
	        Where<InventoryItem.inventoryID, Equal<INSiteLotSerial.inventoryID>>>))]
        public virtual bool? NegQty
        {
            get
            {
    ...
    public partial class OversoldCostStatus : INCostStatus
    {
        ...
        [PXDBDecimal(6)]
        [PXDefault(TypeCode.Decimal, "0.0", typeof(Search2<INItemSite.negativeCost, 
	        InnerJoin<INLocation, 
		        On<INLocation.siteID, Equal<INItemSite.siteID>>>, 
	        Where<INItemSite.inventoryID, Equal<Current<OversoldCostStatus.inventoryID>>, 
		        And<Where<INItemSite.siteID, Equal<Current<OversoldCostStatus.costSiteID>>, 
			    Or<INLocation.locationID, Equal<Current<OversoldCostStatus.costSiteID>>>>>>>))]
