	...
	public class INReplenishmentProjection : TM.OwnedFilter.ProjectionAttribute
	{
		...
		protected override Type GetSelect(PXCache sender)
		{
			...
			commands.AddRange(new [] {
				...
				typeof(LeftJoin<,,>), typeof(Vendor), typeof(On<Vendor.bAccountID, Equal<IN.S.INItemSite.preferredVendorID>>) });
			...
			if (subItems)
			{
				...
				typeof(LeftJoin<,,>), typeof(INSubItem), typeof(On<INSubItem.subItemID, Equal<INSiteStatus.subItemID>>),
			...
			commands.AddRange(new [] {
				typeof(
					...
					LeftJoin<INAvailabilityScheme, On<INAvailabilityScheme.availabilitySchemeID, Equal<INItemClass.availabilitySchemeID>>>>),
				TM.OwnedFilter.ProjectionAttribute.ComposeWhere(typeof(INReplenishmentFilter), typeof(InventoryItem.productWorkgroupID), typeof(InventoryItem.productManagerID))});
