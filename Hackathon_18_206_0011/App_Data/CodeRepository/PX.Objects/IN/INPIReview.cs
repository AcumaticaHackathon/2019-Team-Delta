...
namespace PX.Objects.IN
{
	...
	public class INPIEntry : PXGraph<INPIEntry>, PXImportAttribute.IPXPrepareItems, PXImportAttribute.IPXProcess
	{
		...
		public PXSelectJoin<INPIHeader, InnerJoin<INSite, On<INSite.siteID, Equal<INPIHeader.siteID>>>, Where<Match<INSite, Current<AccessInfo.userName>>>> PIHeader;
		[PXFilterable]
		...
		[PXSelector(typeof(Search2<INPIHeader.pIID, InnerJoin<INSite, On<INSite.siteID, Equal<INPIHeader.siteID>>>, Where<Match<INSite, Current<AccessInfo.userName>>>, OrderBy<Desc<INPIHeader.pIID>>>), Filterable = true)]
