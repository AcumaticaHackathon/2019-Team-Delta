...
namespace PX.Objects.IN
{
	...
	public class INIntegrityCheck : PXGraph<INIntegrityCheck>
	{
		...
		{
			// TODO: unify the codebase with INItemPlanIDAttribute
			...
			{
				plantype = (INPlanType)0;
			}

			return INItemPlanIDAttribute.UpdateAllocatedQuantitiesBase<TNode>(this, plan, plantype, InclQtyAvail);
		}
                ...
                using (PXTransactionScope ts = new PXTransactionScope())
                {
                    ...
                    if (minPeriod != null)
                    {
						...
						foreach (PXResult<INTran, INTranCost> res in 
							...
							InnerJoin<INTranCost, On<INTranCost.tranType, Equal<INTran.tranType>, 
								And<INTranCost.refNbr, Equal<INTran.refNbr>, 
								And<INTranCost.lineNbr, Equal<INTran.lineNbr>>>>>, 
