namespace PX.Objects.TX
{
	...
	public partial class TaxReportLine : IBqlTable, ISortOrder
	{
		...
		#endregion
		#region LineMult
		public abstract class lineMult : IBqlField
		{
		}
		...
		#endregion
		#region NetTax
		public abstract class netTax : IBqlField
		{
		}
		...
		#endregion
		#region TempLine
		public abstract class tempLine : IBqlField
		{
		}
		...
		#endregion
		#region TempLineNbr
		public abstract class tempLineNbr : IBqlField
		{
		}
        ...
        public abstract class reportLineNbr : IBqlField
        {
        }
        ...
        #endregion
        #region BucketSum
        public abstract class bucketSum : IBqlField
        {
        }
		...
		public abstract class hideReportLine : IBqlField
		{
		}
