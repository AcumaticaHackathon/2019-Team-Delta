...
namespace PX.Objects.TX
{
	...
	public partial class Tax : PX.Data.IBqlTable
	{
		...
		public abstract class retainageTaxPayableAcctID : IBqlField { }

		[Account(DisplayName = "Retainage Tax Payable Account", DescriptionField = typeof(Account.description))]
		...
		public abstract class retainageTaxPayableSubID : IBqlField { }
		...
		public abstract class retainageTaxClaimableAcctID : IBqlField { }

		[Account(DisplayName = "Retainage Tax Claimable Account", DescriptionField = typeof(Account.description))]
		...
		public abstract class retainageTaxClaimableSubID : IBqlField { }
