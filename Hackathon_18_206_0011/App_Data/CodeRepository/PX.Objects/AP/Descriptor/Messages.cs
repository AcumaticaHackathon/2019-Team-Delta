...
namespace PX.Objects.AP
{
	...
	public static class Messages
	{
		...
		public const string VerndorNonEmployeeOrOrganization = "Only a vendor or company business account can be specified (not an employee business account).";
		...
		public const string Unefiled1099Organizations = "The {0} company or companies have a 1099 history but the 1099-MISC Reporting Entity check box is not selected on the Companies (CS101500) form for the company or companies. Information for the company or companies will not be included in the 1099-MISC form e-file.";
		...
		public const string EFilingIsAvailableOnlyCompaniesWithEnabled1099 = "E-Filing is available for only companies for which the 1099-MISC Reporting Entity check box is selected on the Company Details tab of the Companies (CS101500) form.";
		...
		public const string NoUnreleasedDocuments = "Open documents do not exist.";
