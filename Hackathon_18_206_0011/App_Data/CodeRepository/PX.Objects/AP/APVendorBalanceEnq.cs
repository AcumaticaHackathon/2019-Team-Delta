...
namespace PX.Objects.AP
{
	...
	public class APVendorBalanceEnq : PXGraph<APVendorBalanceEnq>
	{
	    ...
	    public partial class APHistorySummary : IBqlTable
	    {
			...
			public abstract class curyBalanceRetainedSummary : PX.Data.IBqlField { }
			...
			public abstract class balanceRetainedSummary : PX.Data.IBqlField { }
		...
		public partial class APHistoryResult : IBqlTable
		{
			...
			public abstract class curyRetainageWithheld : PX.Data.IBqlField { }
			[PXDBCury(typeof(APHistoryResult.curyID))]
			...
			public abstract class retainageWithheld : PX.Data.IBqlField { }
			[PXBaseCury()]
			...
			public abstract class curyRetainageReleased : PX.Data.IBqlField { }
			[PXDBCury(typeof(APHistoryResult.curyID))]
			...
			public abstract class retainageReleased : PX.Data.IBqlField { }
			[PXBaseCury()]
			...
			public abstract class curyBegRetainedBalance : PX.Data.IBqlField { }
			...
			public abstract class begRetainedBalance : PX.Data.IBqlField { }
			...
			public abstract class curyEndRetainedBalance : PX.Data.IBqlField { }
			...
			public abstract class endRetainedBalance : PX.Data.IBqlField { }
		...
		public sealed class APH : CuryAPHistory
		{
			...
			public abstract new class finYtdRetainageWithheld : PX.Data.IBqlField { }
			#endregion
			#region FinYtdRetainageReleased
			public abstract new class finYtdRetainageReleased : PX.Data.IBqlField { }
			#endregion
			#region TranYtdRetainageWithheld
			public abstract new class tranYtdRetainageWithheld : PX.Data.IBqlField { }
			#endregion
			#region TranYtdRetainageReleased
			public abstract new class tranYtdRetainageReleased : PX.Data.IBqlField { }
			#endregion
			#region CuryFinYtdRetainageWithheld
			public abstract new class curyFinYtdRetainageWithheld : PX.Data.IBqlField { }
			#endregion
			#region CuryFinYtdRetainageReleased
			public abstract new class curyFinYtdRetainageReleased : PX.Data.IBqlField { }
			#endregion
			#region CuryTranYtdRetainageWithheld
			public abstract new class curyTranYtdRetainageWithheld : PX.Data.IBqlField { }
			#endregion
			#region CuryTranYtdRetainageReleased
			public abstract new class curyTranYtdRetainageReleased : PX.Data.IBqlField { }
			#endregion
		}
        ...
        protected virtual void RetrieveHistory(APHistoryFilter header, out Dictionary<KeyValuePair<int, string>, APHistoryResult> result)
		{
			...
			{
				branchIDs = PXAccess.GetChildBranchIDs(header.OrganizationID);
