...
namespace PX.Objects.AP
{
	...
	public partial class APTaxTran : TaxTran
	{
		...
		public abstract class curyTaxableDiscountAmt : IBqlField
		{
		}
		...
		public abstract class taxableDiscountAmt : IBqlField
		{
		}
		[PXDecimal(4)]
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
		...
		public abstract class curyTaxDiscountAmt : IBqlField
		{
		}
		...
		#endregion
		#region TaxableDiscountAmt
		public abstract class taxDiscountAmt : IBqlField
		{
		}
		[PXDBDecimal(4)]
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
		...
		public new abstract class curyRetainedTaxableAmt : IBqlField { }
		...
		public new abstract class retainedTaxableAmt : IBqlField
		{
		}
		#endregion
		#region CuryRetainedTaxAmt
		public new abstract class curyRetainedTaxAmt : IBqlField { }
		...
		public new abstract class retainedTaxAmt : IBqlField
		{
		}
		#endregion
