...
namespace PX.Objects.AP.Standalone
{
	...
	public class APQuickCheck : APRegister, IPrintCheckControlable, IAssign, IApprovable, IApprovalDescription
	{
		...
		[TranPeriodID(typeof(APQuickCheck.adjDate), typeof(APQuickCheck.branchID), BqlField = typeof(APPayment.adjTranPeriodID))]
		...
		[FinPeriodID(typeof(APQuickCheck.docDate), typeof(APQuickCheck.branchID), BqlField = typeof(APRegister.tranPeriodID))]
