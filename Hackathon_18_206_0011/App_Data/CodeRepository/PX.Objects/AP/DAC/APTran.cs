...
namespace PX.Objects.AP
{
	...
	public partial class APTran : IBqlTable, DR.Descriptor.IDocumentLine, ISortOrder, ITaxableDetail, IAccountable
	{
		...
		#endregion
		#region LCLineNbr
		public abstract class lCLineNbr : PX.Data.IBqlField
		{
		}
		...
		/// </summary>
		[ManualDiscountMode(typeof(APTran.curyDiscAmt), typeof(APTran.curyTranAmt), typeof(APTran.discPct), typeof(APTran.freezeManualDisc))]
		[PXDBBool()]
		[PXDefault(false)]
		...
		[PXFormula(typeof(Sub<APTran.curyLineAmt, Add<APTran.curyDiscAmt, APTran.curyRetainageAmt>>))]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		public abstract class origGroupDiscountRate : PX.Data.IBqlField
		{
		}
		...
		public abstract class origDocumentDiscountRate : PX.Data.IBqlField
		{
		}
