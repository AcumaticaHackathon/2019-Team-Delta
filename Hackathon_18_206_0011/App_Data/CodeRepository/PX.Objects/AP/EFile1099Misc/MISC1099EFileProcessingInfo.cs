...
namespace PX.Objects.AP
{
	...
	public class MISC1099EFileProcessingInfoRaw : AP1099History
	{
		...
		[Obsolete("MISC1099EFileProcessingInfoRaw.consolidatedBranchID is obsolete, not used and will be removed in Acumatica 2018 R2.")]
		...
		[Obsolete("MISC1099EFileProcessingInfoRaw.payerBranchID is obsolete and will be removed in Acumatica 2018 R2. Use MISC1099EFileProcessingInfoRaw.payerOrganizationID instead.")]
		...
		public abstract class payerOrganizationID : IBqlField { }

		[PXDBInt(BqlField = typeof(Organization.organizationID))]
		[PXDimensionSelector(BranchAttribute._DimensionName, typeof(Search<Organization.organizationID>), typeof(Organization.organizationCD))]
		[PXUIField(DisplayName = "Payer")]
	...
	public class MISC1099EFileProcessingInfo : IBqlTable
	{
		...
		#region PayerBranchID
		[Obsolete("MISC1099EFileProcessingInfo.payerBranchID is obsolete and will be removed in Acumatica 2018 R2. Use MISC1099EFileProcessingInfo.payerOrganizationID instead.")]
		public abstract class payerBranchID : IBqlField { }
