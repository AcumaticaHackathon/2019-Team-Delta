...
namespace PX.Objects.AP
{
	...
	public class APApproveBills : PXGraph<APApproveBills>
	{
		...
		protected virtual IEnumerable apdocumentlist()
		{
			...
			if (filter != null && filter.SelectionDate != null)
			{
				...
				PXView view = new PXView(this, true, BqlCommand.CreateInstance(getAPDocumentSelect(false)));

				foreach (PXResult<APInvoice> res in
					view.Graph.QuickSelect(view.BqlSelect, new object[] { PayInLessThan, DueInLessThan, DiscountExpiresInLessThan }))
				{
					APInvoice apdoc = res;
	...
	public partial class ApproveBillsFilter : PX.Data.IBqlTable
	{
		...
		public abstract class curyDocsTotal : IBqlField { }
		...
		public abstract class curyApprovedTotal : IBqlField { }
