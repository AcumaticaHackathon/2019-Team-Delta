...
namespace PX.Objects.FA
{
	...
	public class FADetailsTransfer : FADetails
	{
		...
		#region CurrentCost
		public new abstract class currentCost : PX.Data.IBqlField { }
		/// <summary>
		...
		public new abstract class accrualBalance : PX.Data.IBqlField { }
		/// <summary>
	...
	public class TransferProcess : PXGraph<TransferProcess>
	{
		...
		public partial class TransferFilter : IBqlTable
		{
			...
			[FAOpenPeriod(
				typeof(TransferFilter.transferDate),
				selectionModeWithRestrictions: FinPeriodSelectorAttribute.SelectionModesWithRestrictions.All,
				sourceSpecificationTypes:
				new[]
				{
					typeof(CalendarOrganizationIDProvider.SourceSpecification<TransferFilter.branchFrom, True>),
					typeof(CalendarOrganizationIDProvider.SourceSpecification<TransferFilter.branchTo, False>),
				},
