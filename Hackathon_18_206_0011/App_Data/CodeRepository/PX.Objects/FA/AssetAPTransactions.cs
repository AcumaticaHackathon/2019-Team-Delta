...
namespace PX.Objects.FA
{
	...
	public class AssetGLTransactions : PXGraph<AssetGLTransactions>
	{
			...
			out int? assetID)
		{
			...
			location.PeriodID = finPeriodRepository.FindFinPeriodByDate(det.ReceiptDate, FinPeriod.organizationID.MasterValue)?.FinPeriodID;
			...
			foreach (FixedAsset asset in Caches[typeof(FixedAsset)].Inserted)
			{
				...
				if (assetdet != null)
				{
					...
					if (newhist != null)
					{
						...
						newhist.PeriodID = FinPeriodRepository.FindFinPeriodByDate(assetdet.ReceiptDate, FinPeriod.organizationID.MasterValue)?.FinPeriodID;
					}
				}
			}
	...
	public partial class GLTranFilter : IBqlTable
	{
		...
		[FinPeriodSelector(typeof(GLTranFilter.tranDate))]
