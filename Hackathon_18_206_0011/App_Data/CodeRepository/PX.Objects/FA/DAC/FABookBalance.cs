...
namespace PX.Objects.FA
{
	...
	public partial class FABookBalance : PX.Data.IBqlTable
	{
		...
		[PXDefault(
			typeof(Search<
				...
				Where<FABookPeriod.finPeriodID, Equal<Current<FABookBalance.deprFromPeriod>>>>), 
		...
		[PXSelector(typeof(Search<
			...
			Where<FABookPeriod.bookID, Equal<Current<FABookBalance.bookID>>>>))]
	...
	[PXProjection(typeof(Select5<
		...
		InnerJoin<FixedAsset, On<FixedAsset.assetID, Equal<Standalone.FABookBalance.assetID>>,
		InnerJoin<Branch, On<Branch.branchID, Equal<FixedAsset.branchID>>,
