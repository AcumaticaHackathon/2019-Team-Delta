	...
	public partial class FADepreciationMethod : IBqlTable
	{
		...
		public abstract class depreciationMethod : IBqlField
		{
			...
			public class ListAttribute : PXStringListAttribute
			{
				public ListAttribute()
					: base(
					new string[] { StraightLine, DecliningBalance, SumOfTheYearsDigits, RemainingValue, Dutch1, Dutch2, RemainingValueByPeriodLength, DecliningBalanceByPeriodLength },
					new string[] { Messages.StraightLine, Messages.DecliningBalance, Messages.SumOfTheYearsDigits, Messages.RemainingValue, Messages.Dutch1, Messages.Dutch2, Messages.RemainingValueByPeriodLength, Messages.DecliningBalanceByPeriodLength })
				{ }
			}
			...
			public class remainingValueByPeriodLength : Constant<string>
			{
				public remainingValueByPeriodLength() : base(RemainingValueByPeriodLength) { }
			}
			public class decliningBalanceByPeriodLength : Constant<string>
			{
