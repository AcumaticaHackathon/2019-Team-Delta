namespace PX.Objects.PO
{
	...
	public partial class POSetup : PX.Data.IBqlTable
	{
		...
		public abstract class landedCostDocNumberingID : PX.Data.IBqlField
		{
		}
		[PXDBString(10, IsUnicode = true)]
		...
		public abstract class requireLandedCostsControlTotal : PX.Data.IBqlField
		{
		}
		[PXDBBool()]
		[PXDefault(false)]
		...
		public abstract class holdLandedCosts : PX.Data.IBqlField
		{
		}
		[PXDBBool()]
		[PXDefault(true)]
		...
		public abstract class autoCreateLCAP : PX.Data.IBqlField
		{
		}
        ...
        public abstract class copyLineNotesFromServiceOrder : PX.Data.IBqlField
        {
        }
        ...
        public abstract class copyLineAttachmentsFromServiceOrder : PX.Data.IBqlField
        {
        }
