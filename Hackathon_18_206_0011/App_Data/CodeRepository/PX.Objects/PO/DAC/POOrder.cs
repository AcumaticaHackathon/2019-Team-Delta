...
namespace PX.Objects.PO
{
	...
	public partial class POOrder : PX.Data.IBqlTable, PX.Data.EP.IAssign
	{
        ...
        [PXNote(new Type[0], ShowInReferenceSelector = true, Selector = typeof(Search<POOrder.noteID, Where<POOrder.orderType, NotEqual<POOrderType.regularSubcontract>>>))]
		...
		public abstract class curyUnbilledLineTotal : IBqlField
		{
		}
		...
		public abstract class unbilledLineTotal : IBqlField
		{
		}
		[PXDBDecimal(4)]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		public abstract class curyUnbilledTaxTotal : IBqlField
		{
		}
		...
		public abstract class unbilledTaxTotal : IBqlField
		{
		}
		...
		public abstract class lockCommitment : PX.Data.IBqlField
		{
		}
		[PXDBBool()]
		[PXDefault(false)]
		...
		public abstract class disableAutomaticDiscountCalculation : IBqlField { }
		...
		public abstract class orderBasedAPBill : IBqlField
		{
		}
		[PXBool]
	...
	public class POOrderType
	{
		...
		public class regularSubcontract : Constant<string>
		{
	...
	public class POBehavior
	{
		...
		public class changeOrder : Constant<string>
		{
