...
namespace PX.Objects.PO
{
	...
	public partial class POReceiptLine : PX.Data.IBqlTable, ILSPrimary, ISortOrder, IPOReturnLineSource
	{
		...
		public class SiteStatusFK : INSiteStatus.PK.ForeignKeyOf<POReceiptLine>.By<inventoryID, subItemID, siteID> { }
		public class LocationStatusFK : INLocationStatus.PK.ForeignKeyOf<POReceiptLine>.By<inventoryID, subItemID, siteID, locationID> { }
		public class LotSerialStatusFK : INLotSerialStatus.PK.ForeignKeyOf<POReceiptLine>.By<inventoryID, subItemID, siteID, locationID, lotSerialNbr> { }
		#endregion
		#region Selected
		...
		[PXRestrictor(typeof(Where2<SameOrganizationBranch<INSite.branchID, Current<POReceipt.branchID>>,
		...
		#region TranUnitCost
		public abstract class tranUnitCost : IBqlField
		{
			}
		[PXDBDecimal(6)]
		...
		[Account(typeof(POReceiptLine.branchID),DisplayName = "Account", Visibility = PXUIVisibility.Visible, Filterable = false, DescriptionField = typeof(Account.description), Visible = false)]
		[PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
		...
		public abstract class origToLocationID : PX.Data.IBqlField { }
		#endregion
		...
		public abstract class origIsLotSerial : PX.Data.IBqlField { }
		#endregion
		#region OrigNoteID
		/// <summary>
		...
		public abstract class origIsFixedInTransit : PX.Data.IBqlField { }
		#endregion
		...
		public abstract class origReceiptNbr : IBqlField
		{
		}
		[PXDBString(15, IsUnicode = true)]
		...
		public abstract class origReceiptLineNbr : IBqlField
		{
		}
		[PXDBInt]
		...
		public abstract class origReceiptLineType : IBqlField
        {
        }
		[PXDBString(lineType.Length, IsFixed = true)]
