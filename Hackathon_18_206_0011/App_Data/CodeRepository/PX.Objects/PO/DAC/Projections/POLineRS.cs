	...
	public partial class POLineRS : IBqlTable, IAPTranSource, ISortOrder
	{
		...
		[LocationID(typeof(Where<Location.bAccountID, Equal<Current<POOrder.vendorID>>,
			And<Location.isActive, Equal<True>,
				And<MatchWithBranch<Location.vBranchID>>>>), DescriptionField = typeof(Location.descr), Visibility = PXUIVisibility.SelectorVisible, BqlField = typeof(POOrder.vendorLocationID))]
