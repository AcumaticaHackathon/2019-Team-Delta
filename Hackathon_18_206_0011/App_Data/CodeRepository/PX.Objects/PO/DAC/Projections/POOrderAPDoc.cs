...
namespace PX.Objects.PO
{
	...
	public partial class APTranSigned : IBqlTable
	{
		...
		public abstract class signedBaseQty : IBqlField
		{
		}
		...
		public abstract class signedCuryLineAmt : IBqlField
		{
		}
		...
		#endregion
		#region POPPVAmt
		public abstract class pOPPVAmt : IBqlField
		{
		}
	...
	[PXProjection(typeof(Select5<APTranSigned,
		...
		Aggregate<
			...
			Sum<APTranSigned.signedCuryLineAmt,
	...
	public partial class POOrderAPDoc : IBqlTable
	{
		...
		/// </summary>
		[PXDBBaseCury(BqlField = typeof(APTranSigned.signedCuryLineAmt))]
