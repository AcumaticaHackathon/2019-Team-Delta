...
{   
	...
	public class POReceiptEntry : PXGraph<POReceiptEntry, POReceipt>, IGraphWithInitialization
	{
		...
		public PXSelect<POReceiptLineSplit, Where<POReceiptLineSplit.receiptNbr, Equal<Current<POReceiptLine.receiptNbr>>,
											...
											And<Where<POLineType.goodsForInventory, Equal<Current<POReceiptLine.lineType>>,
                                                ...
                                                Or<POLineType.goodsForServiceOrder, Equal<Current<POReceiptLine.lineType>>,
		...
		[PXCopyPasteHiddenView()]
		public PXSelect<POOrderReceiptLink, Where<POOrderReceiptLink.receiptNbr, Equal<Current<POReceipt.receiptNbr>>>> ReceiptOrdersLink;
		...
		public PXSelect<APTranReceiptUpdate> apTranUpdate;
		...
		public IEnumerable ApDocs()
		{
			...
			var rawdata = PXSelectJoin<POReceiptLine,
				...
				Where<POReceiptLine.receiptNbr, Equal<Current<POReceipt.receiptNbr>>>>.Select(this);
		...
		public PXSelectJoin<
			...
			Where<POLineS.orderType, Equal<Current<POOrderFilter.orderType>>,
				...
				And2<Where<POLineS.lineType, NotEqual<POLineType.service>, Or<POLineS.pOAccrualType, Equal<POAccrualType.receipt>,
					Or<Where2<Where<POOrder.orderType, In3<POOrderType.regularOrder, POOrderType.regularSubcontract>, And<Current<POSetup.addServicesFromNormalPOtoPR>, Equal<True>>>,
					Or<Where<POOrder.orderType, Equal<POOrderType.dropShip>, And<Current<POSetup.addServicesFromDSPOtoPR>, Equal<True>>>>>>>>,
		...
		public IEnumerable OpenTransfers()
		{
			...
			{ 
				results = 
					...
					InnerJoin<INRegister, On<INRegister.docType, Equal<SOOrderShipment.invtDocType>,
						And<INRegister.refNbr, Equal<SOOrderShipment.invtRefNbr>>>,
					InnerJoin<INTran, On<INTran.docType, Equal<INRegister.docType>, 
						And<INTran.refNbr, Equal<INRegister.refNbr>,
						And<INTran.sOOrderType, Equal<SOOrderShipment.orderType>,
						And<INTran.sOOrderNbr, Equal<SOOrderShipment.orderNbr>,
						And<INTran.sOShipmentType, Equal<SOOrderShipment.shipmentType>,
						And<INTran.sOShipmentNbr, Equal<SOOrderShipment.shipmentNbr>>>>>>>,
				InnerJoin<INSite, On<INSite.siteID, Equal<INRegister.toSiteID>>,
				...
				if (this.poReceiptLineReturn.AskExt((graph, view) =>
					{
						...
						graph.Views[view].Cache.ClearQueryCache();
			...
			if (_licenseLimits != null)
			{
				OnBeforeCommit += _licenseLimits.GetCheckerDelegate<POReceipt>(
					new TableQuery(TransactionTypes.LinesPerMasterRecord, typeof(POReceiptLine), (graph) =>
					{
						...
						{
							new PXDataFieldValue<POReceiptLine.receiptType>(((POReceiptEntry)graph).Document.Current?.ReceiptType),
					...
					new TableQuery(TransactionTypes.SerialsPerDocument, typeof(POReceiptLineSplit), (graph) =>
					{
						return new PXDataFieldValue[]
						{
							new PXDataFieldValue<POReceiptLineSplit.receiptType>(((POReceiptEntry)graph).Document.Current?.ReceiptType),
        ...
        protected virtual void POReceipt_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
        {
			...
			transactions.AllowInsert = !released && !isTransferReceipt && hasVendor;
			transactions.AllowUpdate = hasVendor;
			transactions.AllowDelete = !released && !isTransferReceipt;
			PXUIFieldAttribute.SetEnabled<POReceiptLine.selected>(transactions.Cache, null, isReceipt && released);
            ...
            if (this._skipUIUpdate == false)
            {
                ...
                bool allowAddOrder = !isReturn && !released && hasVendor && (!requireSingleProject || doc.ProjectID != null);
			...
			if (IsAccrualAccountRequired(row))
			{
				...
				var item = (PXResult<InventoryItem, INPostClass, INSite>)
					...
					.Select(this, row.SiteID, row.InventoryID);
						...
						if (item != null && ((INPostClass)item).PostClassID != null)
				{
		...
		protected virtual void POReceiptLine_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
			...
			if (row.Released != true)
			{
				...
				PXUIFieldAttribute.SetEnabled<POReceiptLine.branchID>(sender, row, !isTransferReceipt && (receiptBasedBilling || !usePOAccrual));
            ...
            try
            {
				...
				foreach (PXResult<INTran, INTransitLine, INTransitLineStatus, INLotSerialStatus2, INLocationStatus2, InventoryItem, POReceiptLine> iTran in 
					...
					LeftJoin<POReceiptLine,
						On<POReceiptLine.origTranType, Equal<INTran.tranType>,
				...
				foreach (var tranToTransit in tranToTransits.Where(r => r.Value.Any()))
				{
					...
					PXSelect<INTran, Where<INTran.tranType, Equal<INTranType.transfer>,
										...
										And<INTran.tranType, Equal<Current<POReceiptLine.origTranType>>>>>>>.StoreCached(this, new PXCommandKey(new object[] { tranToTransit.Key.RefNbr, tranToTransit.Key.LineNbr, tranToTransit.Key.TranType }, true, false), new List<object> { tranToTransit.Key });
		...
		public virtual bool IsLotSerTracked(IPOReturnLineSource line)
		{
			...
			INLotSerClass lotclass = PXSelectJoin<INLotSerClass,
				InnerJoin<InventoryItem, On<INLotSerClass.lotSerClassID, Equal<InventoryItem.lotSerClassID>>>,
				Where<InventoryItem.inventoryID, Equal<Required<InventoryItem.inventoryID>>>>
				.SelectWindowed(this, 0, 1, line.InventoryID);
		...
		public virtual void CopyFromOrigReceiptLine(POReceiptLine destLine, IPOReturnLineSource srcLine)
		{
			...
			destLine.LotSerialNbr = srcLine.LotSerialNbr;
			destLine.ExpireDate = srcLine.ExpireDate;
		...
		public virtual void Copy(POReceiptLine aDest, POLine aSrc, decimal aQtyAdj, decimal aBaseQtyAdj)
		{
			...
			decimal? accrualAmt = APReleaseProcess.GetExpensePostingAmount(this, aSrc).Base;
			aDest.TranCost = PXCurrencyAttribute.BaseRound(this, (aSrc.OrderQty != 0m) ? accrualAmt * aDest.Qty / aSrc.OrderQty : accrualAmt);
			aDest.TranUnitCost = (aSrc.OrderQty != 0m) ? accrualAmt / aSrc.OrderQty : accrualAmt;
        ...
        public virtual void ReleaseReceipt(INReceiptEntry docgraph, AP.APInvoiceEntry invoiceGraph, POReceipt aDoc, DocumentList<INRegister> aINCreated, DocumentList<AP.APInvoice> aAPCreated, bool aIsMassProcess)
		{
			...
			foreach (PXResult<POReceiptLine, POReceiptLineSplit, INTran, INItemPlan, INPlanType, INSite, POOrder, POAddress, INRegister> res
				...
				LeftJoin<INRegister, On<
					INRegister.docType, Equal<INTran.docType>,
				...
				if (rctLineChange || (newline != null && newline.InventoryID != split.InventoryID))
				{
					if (line.IsStockItem() || (line.IsNonStockItem() && insetup.Current.UpdateGL == true && line.POAccrualAcctID != null))
					{
						...
						if (line.OrigTranType == INTranType.Transfer)
						{
							...
							newline.OrigNoteID = inregister.NoteID;
							newline.OrigToLocationID = intran.ToLocationID;
							INTranSplit insplit =
								PXSelectReadonly<INTranSplit,
									...
									.SelectSingleBound(this, new object[] { intran });
							newline.OrigIsLotSerial = !string.IsNullOrEmpty(insplit?.LotSerialNbr);
						}
						else
						{
					...
					if (poLine != null && !(string.IsNullOrEmpty(poLine.OrderType) || String.IsNullOrEmpty(poLine.OrderNbr) || poLine.LineNbr == null))
					{
						...
						if (poLine.Completed != true || poLine.Closed != true)
						{
							...
							if (!unreleasedRcptExists && poLine.POAccrualType == POAccrualType.Order)
							{
								...
								{
									billedEnough = (poLineAccrualStatus.BillCuryID != null && poLineAccrualStatus.BillCuryID == poOrder.CuryID)
										? ((poLine.CuryExtCost + poLine.CuryRetainageAmt) * poLine.RcptQtyThreshold / 100m <= poLineAccrualStatus.CuryBilledAmt)
										: ((poLine.ExtCost + poLine.RetainageAmt) * poLine.RcptQtyThreshold / 100m <= poLineAccrualStatus.BilledAmt);
								}
							...
							if (completePOLine)
							{
								...
								{
									poLine.Closed = true;
									poLine.UnbilledQty = 0m;
									poLine.CuryUnbilledAmt = 0m;
									orderCheckClosed.Add(new Tuple<string, string>(poLine.OrderType, poLine.OrderNbr));
								}
							}
						}

						if (poLine.Closed == false)
						{
							decimal? unbilledQty = ((poLine.OrderQty < poLine.CompletedQty) ? poLine.CompletedQty : poLine.OrderQty) - poLine.BilledQty;
							poLine.UnbilledQty = (unbilledQty < 0m) ? 0m : unbilledQty;
							decimal? curyUnbilledAmt = poLine.CuryExtCost + poLine.CuryRetainageAmt - poLine.CuryBilledAmt;
							poLine.CuryUnbilledAmt = (curyUnbilledAmt < 0m) ? 0m : curyUnbilledAmt;
						}

						if (poLine.LineType == POLineType.GoodsForSalesOrder ||
							poLine.LineType == POLineType.NonStockForSalesOrder ||
						    poLine.LineType == POLineType.GoodsForManufacturing	||
						    poLine.LineType == POLineType.NonStockForManufacturing ||
                            poLine.LineType == POLineType.GoodsForServiceOrder ||
                            poLine.LineType == POLineType.NonStockForServiceOrder)
						{
							            ...
							            And<INPlanType.isFixed, Equal<True>>>>>.Select(this, poLine.PlanID))
							{
                                ...
                                bool lineIsFromServiceModule = poLine.LineType == POLineType.GoodsForServiceOrder || poLine.LineType == POLineType.NonStockForServiceOrder; 
                                ...
                                if (SupplyQty >= demand.PlanQty)
								{
									...
									supply.PlanType = lineIsFromServiceModule ? INPlanConstants.PlanF5 : INPlanConstants.Plan64;
			...
			foreach (Tuple<string, string> orderNbr in orderCheckClosed)
			{
				POLineUOpen line =
					...
					Where<POLineUOpen.orderType, Equal<Required<POLineUOpen.orderType>>,
						...
						And<POLineUOpen.closed, Equal<False>>>>>>
					.Select(this, orderNbr.Item1, orderNbr.Item2);
				if (line == null)
				{
					POOrder order = PXSelect<POOrder,
						Where<POOrder.orderType, Equal<Required<POOrder.orderType>>,
						...
						if (upd != null)
						{
							POLineUOpen cancelled =
								...
								Where<POLineUOpen.orderType, Equal<Required<POLineUOpen.orderType>>,
									And<POLineUOpen.orderNbr, Equal<Required<POLineUOpen.orderNbr>>,
									And<POLineUOpen.lineType, NotEqual<POLineType.description>,
									And<POLineUOpen.cancelled, Equal<True>>>>>>
								.Select(this, orderNbr.Item1, orderNbr.Item2);
		...
		{
			if (poAccrual == null || poAccrual.BaseReceivedQty >= poAccrual.BaseBilledQty)
			{
			...
			string accruedUom, decimal? accruedQty, decimal? baseAccruedQty, decimal? accruedCost)
		{
			...
			foreach (APTranReceiptUpdate tran in PXSelect<APTranReceiptUpdate,
				Where<APTranReceiptUpdate.pOAccrualType, Equal<Required<APTranReceiptUpdate.pOAccrualType>>,
					And<APTranReceiptUpdate.pOOrderType, Equal<Required<APTranReceiptUpdate.pOOrderType>>,
					And<APTranReceiptUpdate.pONbr, Equal<Required<APTranReceiptUpdate.pONbr>>,
					And<APTranReceiptUpdate.pOLineNbr, Equal<Required<APTranReceiptUpdate.pOLineNbr>>,
					And<APTranReceiptUpdate.released, Equal<True>,
					And<APTranReceiptUpdate.unreceivedQty, Greater<decimal0>,
					And<APTranReceiptUpdate.baseUnreceivedQty, Greater<decimal0>>>>>>>>>
				.Select(this, poAccrual.Type, poAccrual.OrderType, poAccrual.OrderNbr, poAccrual.OrderLineNbr))
			{
		...
		public virtual void ReleaseReturnViaIssue(INIssueEntry docgraph, AP.APInvoiceEntry invoiceGraph, POReceipt aDoc, DocumentList<INRegister> aCreated, DocumentList<AP.APInvoice> aInvoiceCreated, bool aIsMassProcess)
		{
			this.Clear();
			...
			foreach (PXResult<POReceiptLine, POReceiptLineSplit, POLineUOpen, INTran, INTran2, INItemPlan, INPlanType> res in PXSelectJoin<POReceiptLine,
				...
				LeftJoin<INTran2, On<INTran2.pOReceiptNbr, Equal<POReceiptLine.origReceiptNbr>, And<INTran2.pOReceiptLineNbr, Equal<POReceiptLine.origReceiptLineNbr>, And<INTran2.docType, Equal<INDocType.receipt>>>>,
				LeftJoin<INItemPlan, On<INItemPlan.planID, Equal<POReceiptLineSplit.planID>>,
				LeftJoin<INPlanType, On<INPlanType.planType, Equal<INItemPlan.planType>>>>>>>>,
					...
					OrderBy<Asc<POReceiptLine.receiptNbr, Asc<POReceiptLine.lineNbr>>>>.Select(this))
			{
				...
				INTran2 origINTran = (INTran2)res;

				bool isStock = (line.IsStockItem() && split.IsStockItem == true);
				bool isNonStock = line.IsNonStockItem();
				if ((isStock || isNonStock)
					&& !string.IsNullOrEmpty(line.OrigReceiptNbr) && line.OrigReceiptLineNbr != null
					&& !POLineType.IsDropShip(line.OrigReceiptLineType) && origINTran.Released != true)
				{
				...
				if (rctLineChange)
				{
					...
					UpdateReceiptReturn(line, origINTran.BaseQty);
				}
			...
			ReopenOrdersOnReturn(orderCheckClosed);
			List<APRegister> forReleaseAP = new List<APRegister>();
		...
		public virtual void ReopenOrdersOnReturn(IEnumerable<Tuple<string, string>> orderCheckClosed)
		{
			foreach (var orderNbr in orderCheckClosed)
			{
				POOrder order = PXSelect<POOrder,
					Where<POOrder.orderType, Equal<Required<POOrder.orderType>>,
						And<POOrder.orderNbr, Equal<Required<POOrder.orderNbr>>>>>
		...
		public virtual void ReleaseReturnViaAdjustment(INAdjustmentEntry adjGraph, APInvoiceEntry invoiceGraph, POReceipt aDoc, DocumentList<INRegister> aCreated, DocumentList<APInvoice> aInvoiceCreated, bool aIsMassProcess)
		{
			this.Clear();

			adjGraph.Clear();

			adjGraph.insetup.Current.RequireControlTotal = false;
			adjGraph.insetup.Current.HoldEntry = false;
			...
			newdoc = adjGraph.adjustment.Insert(newdoc);
			...
			var receiptLineSplits = PXSelectJoin<POReceiptLine,
				...
				.Select(this)
				.Select(r => (PXResult<POReceiptLine, POReceiptLineSplit, POLineUOpen, InventoryItem, INTran, INTran2, INItemPlan, INPlanType>)r).ToList();
				...
				if (rctLineChange || splitBasedTran)
				{
					if (isStock || isNonStock)
					{
						...
						newline = new INTran()
						{
							...
							Qty = (splitBasedTran ? split.Qty : line.ReceiptQty) * line.InvtMult,
						};
						SetAdjustmentReturnCostFinal(newline, line, split, item, splitBasedTran, lastLineSplit);
						newline = adjGraph.lsselect.Insert(newline);
						if (isStock)
						{
							var newsplit = (INTranSplit)newline;
							newsplit.SplitLineNbr = null;
							newsplit = adjGraph.splits.Insert(newsplit);
							adjGraph.splits.Cache.RaiseRowUpdated(newsplit, newsplit);
						}
					}
					else
					{
			...
			if (hasTransactions)
			{
				INRegister copy = PXCache<INRegister>.CreateCopy(adjGraph.adjustment.Current);
				PXFormulaAttribute.CalcAggregate<INTran.qty>(adjGraph.transactions.Cache, copy);
				PXFormulaAttribute.CalcAggregate<INTran.tranAmt>(adjGraph.transactions.Cache, copy);
				PXFormulaAttribute.CalcAggregate<INTran.tranCost>(adjGraph.transactions.Cache, copy);
				adjGraph.adjustment.Update(copy);
			}
			if ((bool)aDoc.AutoCreateInvoice)
			{
				bool hasRetainedTaxes = (apsetup.Current.RetainTaxes == true) && HasOrderWithRetainage(aDoc);
			...
			using (PXTransactionScope ts = new PXTransactionScope())
			{
				bool isINDocValid = (adjGraph.transactions.Select().Count > 0);
				...
				if (isINDocValid)
				{
					receipt_copy.InvtDocType = adjGraph.adjustment.Current.DocType;
					receipt_copy.InvtRefNbr = adjGraph.adjustment.Current.RefNbr;
				}
				receipt_copy = this.Document.Update(receipt_copy);
				...
				if (isINDocValid)
				{
					try
					{
						INDocumentRelease.ReleaseDoc(new List<INRegister>() { adjGraph.adjustment.Current }, false);
					}
					catch (PXException ex)
					{
						throw new PXException(Messages.INDocumentFailedToReleaseDuringPOReceiptReleaseInTransaction, ex.Message);
			...
			if (aCreated.Find(adjGraph.adjustment.Current) == null)
			{
				aCreated.Add(adjGraph.adjustment.Current);
			}
		...
		public virtual void SetAdjustmentReturnCostFinal(INTran newline, POReceiptLine rctLine, POReceiptLineSplit split, InventoryItem item, bool splitBasedTran, bool lastLineSplit)
		{
			...
			newline.TranCost = rctLine.InvtMult * tranCost;
		...
		public partial class POOrderS : POOrder
		{
			...
			public new abstract class isUnbilledTaxValid : PX.Data.IBqlField
			{
			}
			#endregion
	...
	public partial class POLineR : IBqlTable, ISortOrder
	{
		...
		public abstract class curyBLOrderedCost : IBqlField
		{
		}
		...
		public abstract class bLOrderedCost : IBqlField
		{
		}
	...
	public partial class POLineUOpen : IBqlTable, IItemPlanMaster, ISortOrder
	{
		...
		#endregion
		#region Completed
		public abstract class completed : IBqlField
		{
		}
		[PXDBBool(BqlField = typeof(POLine.completed))]
		...
		#endregion
		#region BaseOrderQty
		public abstract class baseOrderQty : IBqlField
		{
		}
		...
		#region CompletedQty
		public abstract class completedQty : IBqlField
		{
		}
		...
		public abstract class baseCompletedQty : IBqlField
		{
		}
		...
		#endregion
		#region BaseOpenQty
		public abstract class baseOpenQty : IBqlField
		{
		}
		[PXDBDecimal(6, BqlField = typeof(POLine.baseOpenQty))]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		[PXFormula(null, typeof(SumCalc<POOrder.unbilledOrderQty>))]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		#endregion
		#region OrigExtCost
		public abstract class origExtCost : PX.Data.IBqlField
		{
		}

		[PXDBBaseCury(BqlField = typeof(POLine.origExtCost))]
		...
		public abstract class completePOLine : IBqlField
		{
		}
		...
		public abstract class rcptQtyThreshold : IBqlField
		{
		}
