...
namespace PX.Objects.GDPR
{
	public class GDPRPersonalDataProcessBase : PXGraph<GDPRPersonalDataProcessBase>
	{
		...
		public delegate void TopLevelProcessorDelegate(string combinedKey, Guid? topParentNoteID, string info);
		public delegate void ChildLevelProcessorDelegate(PXGraph graph, Type table, IEnumerable<PXPersonalDataFieldAttribute> fields, IEnumerable<object> childs, Guid? topParentNoteID);

		public static TopLevelProcessorDelegate TopLevelProcessor { get; set; }
		public static ChildLevelProcessorDelegate ChildLevelProcessor { get; set; }

		public static Type GetPseudonymizationStatus = typeof(PXPseudonymizationStatusListAttribute.notPseudonymized);
		public static int SetPseudonymizationStatus = PXPseudonymizationStatusListAttribute.NotPseudonymized;

		#endregion

		#region Implementation
		
		protected static void ProcessImpl(IEnumerable<IBqlTable> entities, bool topLayer, Guid? topParentNoteID)
		{
		...
		protected static void LogOperation(Type tableName, string combinedKey)
		{
