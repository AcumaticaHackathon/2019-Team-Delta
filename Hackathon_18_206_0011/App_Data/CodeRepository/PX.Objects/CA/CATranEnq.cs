...
namespace PX.Objects.CA
{
		...
		public virtual void GetRange(DateTime date, string Range, int? cashAccountID, out DateTime? RangeStart, out DateTime? RangeEnd)
		{
			switch (Range)
			{
				...
				case "M":
					...
					return;
				case "P":
					var repository = GetService<IFinPeriodRepository>();
					...
					var period = repository.FindFinPeriodByDate(date, organizationID);
	...
	public partial class CAEnqFilter : IBqlTable
	{
		...
		public abstract class lastStartDate : IBqlField
		{
		}
		...
		#endregion
		#region LastEndDate
		public abstract class lastEndDate : IBqlField
		{
		}
		...
		#region ShowSummary
		public abstract class showSummary : IBqlField
		{
		}
		...
		public abstract class includeUnreleased : IBqlField
		{
		}
		...
		#endregion
		#region CreditTotal
		public abstract class creditTotal : IBqlField
		{
		}
		...
		#endregion
		#region DebitTotal
		public abstract class debitTotal : IBqlField
		{
		}
		...
		public abstract class begClearedBal : IBqlField
		{
		}
		...
		public abstract class creditClearedTotal : IBqlField
		{
		}
		...
		public abstract class debitClearedTotal : IBqlField
		{
		}
		...
		public abstract class endClearedBal : IBqlField
		{
		}
