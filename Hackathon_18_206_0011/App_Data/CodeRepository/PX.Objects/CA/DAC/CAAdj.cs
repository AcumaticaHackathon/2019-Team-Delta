...
namespace PX.Objects.CA
{
	...
	public partial class CAAdj : IBqlTable, ICADocument, IAssign, IRegister
	{
		...
		/// </value>
		[TranPeriodID(
			typeof(CAAdj.tranDate), 
			typeof(CAAdj.cashAccountID),
			typeof(Selector<CAAdj.cashAccountID, CashAccount.branchID>))]
		...
		#endregion
		#region Draft
		public abstract class draft : IBqlField
		{
		}
		...
		#endregion
		#region IsTaxValid
		public abstract class isTaxValid : IBqlField
		{
		}
		...
		#endregion
		#region IsTaxPosted
		public abstract class isTaxPosted : IBqlField
		{
		}
		...
		public abstract class curySplitTotal : IBqlField
		{
		}
		...
		#endregion
		#region SplitTotal
		public abstract class splitTotal : IBqlField
		{
		}
		...
		public abstract class paymentsReclassification : IBqlField
		{
		}
