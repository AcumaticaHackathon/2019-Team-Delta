	...
	public class ProjectAttribute : AcctSubAttribute, IPXFieldVerifyingSubscriber
	{
		...
		public static bool IsAutonumbered(PXGraph graph, string dimensionID)
		{
			...
			else
			{
				...
				foreach (Segment segment in PXSelect<Segment, Where<Segment.dimensionID, Equal<Required<Segment.dimensionID>>>>.Select(graph, dimensionID))
				{
	...
	public class ProjectTaskAttribute : AcctSubAttribute, IPXRowPersistingSubscriber, IPXFieldSelectingSubscriber
	{
		...
		public virtual void FieldSelecting(PXCache sender, PXFieldSelectingEventArgs e)
		{
			...
			if (ss != null && !AlwaysEnabled)
			{
                ...
                ss.Enabled = (project != null && (project.BaseType == CT.CTPRType.Project|| project.BaseType == CT.CTPRType.ProjectTemplate) && project.NonProject != true && sender.GetValue(e.Row, projectIDField.Name) != null) || sender.Graph.IsImport;
			}
			...
			Type SearchType = typeof(Search<Account.accountID,
				...
				And2<
					...
					Or2<Where<Current<PMAccountGroup.type>, Equal<AccountType.expense>,
						And<Account.type, In3<AccountType.expense, AccountType.income, AccountType.asset>>>,
