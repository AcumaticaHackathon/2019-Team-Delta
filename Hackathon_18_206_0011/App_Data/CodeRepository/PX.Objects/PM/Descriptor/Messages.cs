...
namespace PX.Objects.PM
{
	...
	public static class Messages
	{
		...
		public const string OnlyPlannedCanbeDeleted = "Once Activated the record cannot be deleted. Only Tasks that are in 'Planning' or 'Canceled' can be deleted.";
		...
		public const string CancelledProjectsCannotBeBilled = "Canceled Project cannot be billed.";
		...
		public const string CancelledContract = "The '{0}' project/contract is canceled.";
		...
		public const string CommitmentCannotbeDecreased = "The value of the resulting commitment line cannot be negative.";
		...
		public const string CostCodeNotInBudget = "Cost code is not present in the project budget.";
		...
		public const string ChangeOrderPrefix = "Change Order #";
