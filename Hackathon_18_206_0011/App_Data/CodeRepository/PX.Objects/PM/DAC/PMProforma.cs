...
namespace PX.Objects.PM
{
	...
	Search<GL.Branch.branchID, Where<GL.Branch.branchID, Equal<Current<AccessInfo.branchID>>>>>), IsDetail = false)]
		...
		public abstract class curyRetainageTotal : PX.Data.IBqlField
		{
		}
		...
		public abstract class retainageTotal : PX.Data.IBqlField
		{
		}
		[PXBaseCury]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		public abstract class curyRetainageDetailTotal : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region RetainageTotal
		public abstract class retainageDetailTotal : PX.Data.IBqlField
		{
		}
		[PXDBBaseCury]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		public abstract class curyRetainageTaxTotal : PX.Data.IBqlField
		{
		}
		...
		public abstract class retainageTaxTotal : PX.Data.IBqlField
		{
		}
		[PXDBBaseCury]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		[PXFormula(typeof(Add<curyTaxTotal, Add<curyProgressiveTotal, curyTransactionalTotal>>))]
		...
		public abstract class curyAmountDue : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region AmountDue
		public abstract class amountDue : PX.Data.IBqlField
		{
		}
		[PXBaseCury]
		[PXDefault(TypeCode.Decimal, "0.0")]
