...
namespace PX.Objects.PM
{
	...
	[PXProjection(typeof(Select2<POLine,
		InnerJoin<POOrder, On<POOrder.orderType, Equal<POLine.orderType>, 
			And<POOrder.orderNbr, Equal<POLine.orderNbr>, And<POOrder.behavior, Equal<POBehavior.changeOrder>,
	...
	public partial class POLinePM : PX.Data.IBqlTable
	{
		...
		[PXDefault(TypeCode.Decimal, "0.0")]
		[PXDBPriceCost(BqlField = typeof(POLine.curyExtCost))]
		...
		[PXDimensionSelector(PMCostCode.costCodeCD.DimensionName, typeof(Search<PMCostCode.costCodeID>), typeof(PMCostCode.costCodeCD))]
		...
		//Calculated fields:
		#region CalcOpenQty
		public abstract class calcOpenQty : PX.Data.IBqlField
		{
		}
		[PXQuantity]
		...
		public abstract class calcCuryOpenAmt : PX.Data.IBqlField
		{
		}
		[PXPriceCost]
		...
		public virtual Decimal? CalcCuryOpenAmt
		{
			get
			{
				if (this.OrderQty.GetValueOrDefault() == 0) return this.CuryUnbilledAmt;
				Decimal unitCost = this.CuryExtCost.GetValueOrDefault() / this.OrderQty.GetValueOrDefault();
