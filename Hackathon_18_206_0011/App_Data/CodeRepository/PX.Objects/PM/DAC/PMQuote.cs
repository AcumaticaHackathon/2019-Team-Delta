...
namespace PX.Objects.PM
{
	...
	public partial class PMQuote : IBqlTable, IAssign, IPXSelectable
	{
		...
		[PXRestrictor(typeof(Where<CR.CROpportunity.majorStatus, NotEqual<OpportunityMajorStatusesAttribute.closed>>), Messages.ClosedOpportunityCannotBeSelected)]
		...
		[PXDBInt(BqlField = typeof(CR.Standalone.CROpportunity.majorStatus))]
		...
		public abstract class quoteProjectCD : PX.Data.IBqlField
		{
		}
		...
		public abstract class projectManager : PX.Data.IBqlField
		{
		}
		...
		public abstract class submitCancelled : IBqlField { }
		[PXBool]
		[PXDefault(false, PersistingCheck = PXPersistingCheck.Nothing)]
		...
		public abstract class curyGrossMarginAmount : PX.Data.IBqlField
		{
		}
		...
		#region QuoteTotal
		public abstract class quoteTotal : PX.Data.IBqlField
		{
		}
		[PXBaseCury]
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
		...
		public abstract class curyQuoteTotal : PX.Data.IBqlField
		{
		}
		...
		[PXExtraKey()]
		[PXSearchable(SM.SearchCategory.CR, CR.Messages.OpportunitySearchTitle, new Type[] { typeof(opportunityID), typeof(bAccountID), typeof(BAccount.acctName) },
		...
		[PXDBCreatedDateTimeUtc(BqlField = typeof(CR.Standalone.CRQuote.createdDateTime))]
		...
		[PXDBLastModifiedDateTimeUtc(BqlField = typeof(CR.Standalone.CRQuote.lastModifiedDateTime))]
