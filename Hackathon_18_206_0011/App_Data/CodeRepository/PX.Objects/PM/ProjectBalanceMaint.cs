	...
	public class ProjectBalanceMaint : PXGraph<ProjectBalanceMaint>, PXImportAttribute.IPXPrepareItems
	{
		...
		protected virtual void _(Events.RowSelected<PMBudget> e)
		{
			if (e.Row != null)
			{
				...
				PXUIFieldAttribute.SetEnabled<PMCostBudget.revisedAmount> (e.Cache, null, project?.ChangeOrderWorkflow != true);
			}
		}

		protected virtual void _(Events.FieldUpdated<PMBudget, PMCostBudget.amount> e)
		{
			if (e.Row != null)
			{
				...
				{
					row.Amount = e.OldValue as decimal?;
				}
			}
		}
		...
		public virtual void SetDefaultColumnVisibility()
		{
			...
			PXUIFieldAttribute.SetVisible<PMBudget.committedAmount>(Items.Cache, null, commitmentTracking);
			PXUIFieldAttribute.SetVisible<PMBudget.committedQty>(Items.Cache, null, commitmentTracking);
			PXUIFieldAttribute.SetVisible<PMBudget.committedInvoicedAmount>(Items.Cache, null, commitmentTracking);
			PXUIFieldAttribute.SetVisible<PMBudget.committedInvoicedQty>(Items.Cache, null, commitmentTracking);
			PXUIFieldAttribute.SetVisible<PMBudget.committedOpenAmount>(Items.Cache, null, commitmentTracking);
