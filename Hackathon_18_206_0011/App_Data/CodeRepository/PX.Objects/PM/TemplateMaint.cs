...
namespace PX.Objects.PM
{
    public class TemplateMaint : PXGraph<TemplateMaint, PMProject>, PXImportAttribute.IPXPrepareItems
	{
        ...
        #region PMTask
        [Project(typeof(Where<PMProject.baseType, Equal<CTPRType.projectTemplate>>), DisplayName = "Project ID", IsKey = true, DirtyRead=true)]
		...
		protected virtual void _(Events.RowSelected<PMProject> e)
		{
			...
			if (e.Row != null)
			{
				...
				PXUIFieldAttribute.SetVisibility<PMCostBudget.revenueInventoryID>(CostBudget.Cache, null, e.Row.BudgetLevel == BudgetLevels.Item || IsCopyPasteContext || IsExport || IsImport || enforceVisibility ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				PXUIFieldAttribute.SetVisibility<PMCostBudget.inventoryID>(CostBudget.Cache, null, !CostCodeAttribute.UseCostCode() ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
		...
		{
			bool isAutonumbered = ProjectAttribute.IsAutonumbered(this, ProjectAttribute.DimensionNameTemplate);
