...
namespace PX.Objects.PM
{
	...
	public class ProjectEntry : PXGraph<ProjectEntry, PMProject>, PXImportAttribute.IPXPrepareItems, IGraphWithInitialization
	{
		...
		[PXCopyPasteHiddenFields(typeof(PMCostBudget.revisedQty), typeof(PMCostBudget.revisedAmount), typeof(PMCostBudget.costToComplete), typeof(PMCostBudget.percentCompleted), typeof(PMCostBudget.costAtCompletion), typeof(PMCostBudget.completedPct))]
		[PXImport(typeof(PMProject))]
		[PXFilterable]
		...
		public IEnumerable costBudget()
		{
			...
			else
			{
                ...
                delResult.IsResultTruncated = totalRows > delResult.Count;
		...
		public virtual IEnumerable CreateTemplate(PXAdapter adapter)
		{
			...
			if (!ProjectAttribute.IsAutonumbered(this, ProjectAttribute.DimensionNameTemplate))
			{
		...
		public IEnumerable ViewCostTransactions(PXAdapter adapter)
		{
			if (CostBudget.Current != null)
			{
				...
				{
					if (CostBudget.Current.CostCodeID != null && !ProjectDefaultAttribute.IsNonProject(CostBudget.Current.CostCodeID))
		...
		public IEnumerable ViewRevenueTransactions(PXAdapter adapter)
		{
			if (RevenueBudget.Current != null)
			{
				...
				if (Project.Current.BudgetLevel == BudgetLevels.Item && RevenueBudget.Current.InventoryID != null && !ProjectDefaultAttribute.IsNonProject(RevenueBudget.Current.InventoryID))
					target.Filter.Current.InventoryID = RevenueFilter.Current?.GroupByTask == true ? null : RevenueBudget.Current.InventoryID;
				
				if (PXAccess.FeatureInstalled<FeaturesSet.costCodes>())
				{
					if (Project.Current.BudgetLevel == BudgetLevels.CostCode && RevenueBudget.Current.CostCodeID != null && !ProjectDefaultAttribute.IsNonProject(RevenueBudget.Current.CostCodeID))
		...
		[PXButton]
		protected virtual IEnumerable UpdateRetainage(PXAdapter adapter)
		{
			if (Project.Current != null)
			{
		...
		protected virtual void _(Events.RowSelected<PMProject> e)
		{
			...
			if (e.Row != null)
			{
				...
				PXUIFieldAttribute.SetVisible<PMCostBudget.committedAmount>(CostBudget.Cache, null, Setup.Current.CostCommitmentTracking == true);
				...
				PXUIFieldAttribute.SetVisible<PMCostBudget.committedOrigAmount>(CostBudget.Cache, null, Setup.Current.CostCommitmentTracking == true);
				...
				PXUIFieldAttribute.SetVisible<PMCostBudget.committedCOAmount>(CostBudget.Cache, null, ChangeOrderVisible() && Setup.Current.CostCommitmentTracking == true);
				...
				PXUIFieldAttribute.SetVisible<PMCostBudget.committedInvoicedAmount>(CostBudget.Cache, null, Setup.Current.CostCommitmentTracking == true);
				...
				PXUIFieldAttribute.SetVisible<PMCostBudget.committedOpenAmount>(CostBudget.Cache, null, Setup.Current.CostCommitmentTracking == true);
				...
				PXUIFieldAttribute.SetVisible<PMCostBudget.actualPlusOpenCommittedAmount>(CostBudget.Cache, null, Setup.Current.CostCommitmentTracking == true);
				PXUIFieldAttribute.SetVisible<PMCostBudget.varianceAmount>(CostBudget.Cache, null, Setup.Current.CostCommitmentTracking == true);
				PXUIFieldAttribute.SetVisible<PMCostBudget.inventoryID>(CostBudget.Cache, null, (!CostCodeAttribute.UseCostCode() || e.Row.BudgetLevel == BudgetLevels.Item) && CostBudgetIsEditable());
				...
				PXUIFieldAttribute.SetEnabled<PMCostBudget.rate>(CostBudget.Cache, null, CostBudgetIsEditable() && BudgetEditable());
				PXUIFieldAttribute.SetEnabled<PMCostBudget.qty>(CostBudget.Cache, null,  CostBudgetIsEditable() && BudgetEditable());
				PXUIFieldAttribute.SetEnabled<PMCostBudget.amount>(CostBudget.Cache, null, CostBudgetIsEditable() && BudgetEditable());
				PXUIFieldAttribute.SetEnabled<PMCostBudget.revisedQty>(CostBudget.Cache, null, CostBudgetIsEditable() && RevisedEditable());
				PXUIFieldAttribute.SetEnabled<PMCostBudget.revisedAmount>(CostBudget.Cache, null, CostBudgetIsEditable() && RevisedEditable());
				...
				PXUIFieldAttribute.SetVisibility<PMCostBudget.committedAmount>(CostBudget.Cache, null, Setup.Current.CostCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				...
				PXUIFieldAttribute.SetVisibility<PMCostBudget.committedCOAmount>(CostBudget.Cache, null, ChangeOrderVisible() && Setup.Current.CostCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				...
				PXUIFieldAttribute.SetVisibility<PMCostBudget.committedInvoicedAmount>(CostBudget.Cache, null, Setup.Current.CostCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				...
				PXUIFieldAttribute.SetVisibility<PMCostBudget.committedOpenAmount>(CostBudget.Cache, null, Setup.Current.CostCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				...
				PXUIFieldAttribute.SetVisibility<PMCostBudget.actualPlusOpenCommittedAmount>(CostBudget.Cache, null, Setup.Current.CostCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				PXUIFieldAttribute.SetVisibility<PMCostBudget.varianceAmount>(CostBudget.Cache, null, Setup.Current.CostCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				...
				PXUIFieldAttribute.SetVisible<PMRevenueBudget.committedAmount>(RevenueBudget.Cache, null, Setup.Current.RevenueCommitmentTracking == true);
				...
				PXUIFieldAttribute.SetVisible<PMRevenueBudget.committedInvoicedAmount>(RevenueBudget.Cache, null, Setup.Current.RevenueCommitmentTracking == true);
				...
				PXUIFieldAttribute.SetVisible<PMRevenueBudget.committedOpenAmount>(RevenueBudget.Cache, null, Setup.Current.RevenueCommitmentTracking == true);
				...
				PXUIFieldAttribute.SetVisible<PMRevenueBudget.actualPlusOpenCommittedAmount>(RevenueBudget.Cache, null, Setup.Current.RevenueCommitmentTracking == true);
				PXUIFieldAttribute.SetVisible<PMRevenueBudget.varianceAmount>(RevenueBudget.Cache, null, Setup.Current.RevenueCommitmentTracking == true);
				PXUIFieldAttribute.SetVisible<PMRevenueBudget.inventoryID>(RevenueBudget.Cache, null, RevenueBudgetIsEditable() && e.Row.BudgetLevel == BudgetLevels.Item || IsCopyPasteContext || IsExport || IsImport || enforceVisibility);
				...
				PXUIFieldAttribute.SetEnabled<PMRevenueBudget.rate>(RevenueBudget.Cache, null, RevenueBudgetIsEditable() && BudgetEditable());
				PXUIFieldAttribute.SetEnabled<PMRevenueBudget.qty>(RevenueBudget.Cache, null, RevenueBudgetIsEditable() && BudgetEditable());
				PXUIFieldAttribute.SetEnabled<PMRevenueBudget.amount>(RevenueBudget.Cache, null, RevenueBudgetIsEditable() && BudgetEditable());
				...
				PXUIFieldAttribute.SetEnabled<PMRevenueBudget.revisedAmount>(RevenueBudget.Cache, null, RevenueBudgetIsEditable() && RevisedEditable());
				...
				PXUIFieldAttribute.SetVisibility<PMRevenueBudget.committedAmount>(RevenueBudget.Cache, null, Setup.Current.RevenueCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				...
				PXUIFieldAttribute.SetVisibility<PMRevenueBudget.committedInvoicedAmount>(RevenueBudget.Cache, null, Setup.Current.RevenueCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				...
				PXUIFieldAttribute.SetVisibility<PMRevenueBudget.committedOpenAmount>(RevenueBudget.Cache, null, Setup.Current.RevenueCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				...
				PXUIFieldAttribute.SetVisibility<PMRevenueBudget.actualPlusOpenCommittedAmount>(RevenueBudget.Cache, null, Setup.Current.RevenueCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				PXUIFieldAttribute.SetVisibility<PMRevenueBudget.varianceAmount>(RevenueBudget.Cache, null, Setup.Current.RevenueCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				...
				PXUIFieldAttribute.SetVisible<PMProjectBalanceRecord.committedAmount>(BalanceRecords.Cache, null, Setup.Current.CostCommitmentTracking == true || Setup.Current.RevenueCommitmentTracking == true);
				PXUIFieldAttribute.SetVisible<PMProjectBalanceRecord.committedInvoicedAmount>(BalanceRecords.Cache, null, Setup.Current.CostCommitmentTracking == true || Setup.Current.RevenueCommitmentTracking == true);
				PXUIFieldAttribute.SetVisible<PMProjectBalanceRecord.committedOpenAmount>(BalanceRecords.Cache, null, Setup.Current.CostCommitmentTracking == true || Setup.Current.RevenueCommitmentTracking == true);
				PXUIFieldAttribute.SetVisible<PMProjectBalanceRecord.actualPlusOpenCommittedAmount>(BalanceRecords.Cache, null, Setup.Current.CostCommitmentTracking == true || Setup.Current.RevenueCommitmentTracking == true);
				PXUIFieldAttribute.SetVisible<PMProjectBalanceRecord.varianceAmount>(BalanceRecords.Cache, null, Setup.Current.CostCommitmentTracking == true || Setup.Current.RevenueCommitmentTracking == true);
				PXUIFieldAttribute.SetVisible<PMProjectBalanceRecord.budgetedCOAmount>(BalanceRecords.Cache, null, ChangeOrderVisible());
				PXUIFieldAttribute.SetVisible<PMProjectBalanceRecord.committedCOAmount>(BalanceRecords.Cache, null, Setup.Current.CostCommitmentTracking == true && ChangeOrderVisible());
				PXUIFieldAttribute.SetVisible<PMProjectBalanceRecord.originalCommittedAmount>(BalanceRecords.Cache, null, Setup.Current.CostCommitmentTracking == true);

				PXUIFieldAttribute.SetVisibility<PMProjectBalanceRecord.committedAmount>(BalanceRecords.Cache, null, Setup.Current.CostCommitmentTracking == true || Setup.Current.RevenueCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				PXUIFieldAttribute.SetVisibility<PMProjectBalanceRecord.committedInvoicedAmount>(BalanceRecords.Cache, null, Setup.Current.CostCommitmentTracking == true || Setup.Current.RevenueCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				PXUIFieldAttribute.SetVisibility<PMProjectBalanceRecord.committedOpenAmount>(BalanceRecords.Cache, null, Setup.Current.CostCommitmentTracking == true || Setup.Current.RevenueCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				PXUIFieldAttribute.SetVisibility<PMProjectBalanceRecord.actualPlusOpenCommittedAmount>(BalanceRecords.Cache, null, Setup.Current.CostCommitmentTracking == true || Setup.Current.RevenueCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				PXUIFieldAttribute.SetVisibility<PMProjectBalanceRecord.varianceAmount>(BalanceRecords.Cache, null, Setup.Current.CostCommitmentTracking == true || Setup.Current.RevenueCommitmentTracking == true ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				PXUIFieldAttribute.SetVisibility<PMProjectBalanceRecord.budgetedCOAmount>(BalanceRecords.Cache, null, ChangeOrderVisible() ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
				PXUIFieldAttribute.SetVisibility<PMProjectBalanceRecord.committedCOAmount>(BalanceRecords.Cache, null, ChangeOrderVisible() ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
		...
		protected virtual void _(Events.FieldSelecting<PMRevenueBudget, PMRevenueBudget.amountToInvoice> e)
		{
			if (e.Row != null)
			{
				...
				{
					decimal budgetedAmount = e.Row.RevisedAmount.GetValueOrDefault();
					decimal result = (budgetedAmount * e.Row.CompletedPct.GetValueOrDefault() / 100m) - e.Row.InvoicedAmount.GetValueOrDefault();
        ...
        protected virtual void _(Events.RowSelected<RevenueBudgetFilter> e)
        {
            if (e.Row != null)
            {
                var select = new PXSelectGroupBy<PMRevenueBudget,
                    ...
                    Aggregate<Sum<PMRevenueBudget.amountToInvoice>>>(this);

                PMRevenueBudget total = select.Select();
                e.Row.AmountToInvoiceTotal = total.AmountToInvoice;
                
                foreach(PMRevenueBudget budget in RevenueBudget.Cache.Deleted)
                {
                    e.Row.AmountToInvoiceTotal -= budget.AmountToInvoice.GetValueOrDefault();
                }
                ...
                {
                    decimal? originalValue = (decimal?) RevenueBudget.Cache.GetValueOriginal<PMRevenueBudget.amountToInvoice>(budget);
                    if (originalValue != null)
                    {
                        e.Row.AmountToInvoiceTotal -= originalValue.Value;
                    }
                    e.Row.AmountToInvoiceTotal += budget.AmountToInvoice.GetValueOrDefault();
                }
            }
		...
		{
			bool isAutonumbered = ProjectAttribute.IsAutonumbered(this, ProjectAttribute.DimensionName);
		...
		public virtual bool UpdateLastXXXFields(PMCostBudget budget)
		{
			...
			if (budget.CostToComplete != originalCostToComplete ||
				...
				budget.CostAtCompletion != originalCostAtCompletion)
			{
		...
		public virtual void AddToSummary(PMBudget summary, PMBudget record)
		{
			...
			summary.CommittedOrigAmount = summary.CommittedOrigAmount.GetValueOrDefault() + record.CommittedOrigAmount.GetValueOrDefault();
		...
		public virtual void ApplyChangeOrderBudget(PMChangeOrderBudget changeBudget)
		{
			if (changeBudget.Type == GL.AccountType.Income)
			{
				PMRevenueBudget budget = RevenueBudget.Select().RowCast<PMRevenueBudget>().FirstOrDefault(r => r.TaskID == changeBudget.TaskID &&
			   r.AccountGroupID == changeBudget.AccountGroupID && r.InventoryID == changeBudget.InventoryID && r.CostCodeID == changeBudget.CostCodeID);

				if (budget != null)
				{
					budget.ChangeOrderQty = budget.ChangeOrderQty.GetValueOrDefault() + changeBudget.Qty.GetValueOrDefault();
					budget.ChangeOrderAmount = budget.ChangeOrderAmount.GetValueOrDefault() + changeBudget.Amount.GetValueOrDefault();
					budget.RevisedQty = budget.RevisedQty.GetValueOrDefault() + changeBudget.Qty.GetValueOrDefault();
					budget.RevisedAmount = budget.RevisedAmount.GetValueOrDefault() + changeBudget.Amount.GetValueOrDefault();

					RevenueBudget.Update(budget);
				}
				else
				{
					budget = new PMRevenueBudget();
					budget.ProjectID = changeBudget.ProjectID;
					budget.ProjectTaskID = changeBudget.ProjectTaskID;
					budget.AccountGroupID = changeBudget.AccountGroupID;
					budget.InventoryID = changeBudget.InventoryID;
					budget.CostCodeID = changeBudget.CostCodeID;
					budget.UOM = changeBudget.UOM;
					budget.Rate = changeBudget.Rate;
					budget.ChangeOrderQty = changeBudget.Qty;
					budget.RevisedQty = changeBudget.Qty;
					budget.ChangeOrderAmount = changeBudget.Amount;
					budget.RevisedAmount = changeBudget.Amount;
					budget.Description = changeBudget.Description;

					RevenueBudget.Insert(budget);
				}
			}
			else if (changeBudget.Type == GL.AccountType.Expense)
			{
				PMCostBudget budget = CostBudget.Select().RowCast<PMCostBudget>().FirstOrDefault(r => r.TaskID == changeBudget.TaskID &&
			   r.AccountGroupID == changeBudget.AccountGroupID && r.InventoryID == changeBudget.InventoryID && r.CostCodeID == changeBudget.CostCodeID);
		...
		public class PMProjectBalanceRecord : PX.Data.IBqlTable, IComparable<PMProjectBalanceRecord>
		{
			...
			public abstract class budgetedCOAmount : PX.Data.IBqlField
			{
			}
			protected Decimal? _BudgetedCOAmount;
			[PXBaseCury]
			...
			public virtual Decimal? BudgetedCOAmount
			{
				get
				{
					return this._BudgetedCOAmount;
				}
				set
				{
					this._BudgetedCOAmount = value;
				}
			}
			#endregion
			...
			public abstract class originalCommittedAmount : PX.Data.IBqlField
			{
			}
			protected Decimal? _OriginalCommittedAmount;
			[PXBaseCury]
			...
			public virtual Decimal? OriginalCommittedAmount
			{
				get
				{
					return this._OriginalCommittedAmount;
				}
				set
				{
					this._OriginalCommittedAmount = value;
				}
			}
			#endregion
			...
			protected Decimal? _CommittedCOAmount;
			[PXBaseCury]
			...
			public virtual Decimal? CommittedCOAmount
			{
				get
				{
					return this._CommittedCOAmount;
				}
				set
				{
					this._CommittedCOAmount = value;
				}
			}
			#endregion
		...
		public class RevenueBudgetFilter : IBqlTable
		{
            ...
            public abstract class amountToInvoiceTotal : PX.Data.IBqlField
            {
            }
            [PXDBBaseCury]
        ...
        public class DefaultFromTemplateSettings
		{
			...
			public static DefaultFromTemplateSettings Default
			{
				get { return new DefaultFromTemplateSettings() { CopyProperties = true, CopyTasks = true, CopyBudget = true,
					CopyAttributes =true, CopyRecurring=true, CopyEmployees=true, CopyEquipment=true, CopyNotification=true, CopyAccountMapping=true }; }
			}
