...
namespace PX.Objects.CS
{
	...
	public class FeaturesSet : IBqlTable
	{
		...
		public abstract class centralizedPeriodsManagement : IBqlField { }
		...
		[PXUIEnabled(typeof(Where<FeaturesSet.branch, Equal<True>>))]
		...
		public abstract class customerDiscounts : PX.Data.IBqlField { }
		...
		#endregion
		#region Retainage
		public abstract class retainage : IBqlField { }
		
		[Feature(false, typeof(FeaturesSet.financialAdvanced), DisplayName = "Retainage Support")]
		[FeatureRestrictor(typeof(Select<AP.APInvoice, Where<AP.APInvoice.isRetainageDocument, Equal<True>, Or<AP.APInvoice.retainageApply, Equal<True>>>>))]
		[FeatureRestrictor(typeof(Select<AR.ARInvoice, Where<AR.ARInvoice.isRetainageDocument, Equal<True>, Or<AR.ARInvoice.retainageApply, Equal<True>>>>))]
		...
		#endregion
		#region DeviceHub
		public abstract class deviceHub : PX.Data.IBqlField
		{
		}
		...
		public abstract class gDPRCompliance : IBqlField
		{
        ...
        public abstract class secureBusinessDate : PX.Data.IBqlField
	    {
	    }
        ...
        [Feature(typeof(FeaturesSet.distributionModule), null, DisplayName = "Standard Inventory", SyncToParent = true)]
        ...
        [Feature(typeof(FeaturesSet.distributionModule), null, DisplayName = "Advanced Inventory")]
		...
		public abstract class advancedSOInvoices : IBqlField { }

		[Feature(false, typeof(FeaturesSet.distributionAdvanced), DisplayName = "Advanced SO Invoices")]
		...
		public abstract class advancedFulfillment : IBqlField { }
		[Feature(false, typeof(FeaturesSet.distributionAdvanced), DisplayName = "Advanced Fulfillment", Visible = false)]
        ...
        public abstract class caseManagement : PX.Data.IBqlField
	    {
	    }
        ...
        #region SalesQuotes
        public abstract class salesQuotes : PX.Data.IBqlField
        {            
        }
		...
		public abstract class projectAccounting : PX.Data.IBqlField
		{
		}
		...
		#region ChangeOrder
		public abstract class changeOrder : PX.Data.IBqlField
		{
		}
		...
		public abstract class projectQuotes : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region Construction
		public abstract class construction : PX.Data.IBqlField
		{
		}
		...
		public abstract class constructionProjectManagement : PX.Data.IBqlField
		{
		}
		...
		public abstract class procoreIntegration : PX.Data.IBqlField
		{
		}
        ...
        public abstract class manufacturing : IBqlField { }
        ...
        public abstract class manufacturingMRP : IBqlField { }
        ...
        public abstract class manufacturingProductConfigurator : IBqlField { }
        ...
        public abstract class manufacturingEstimating : IBqlField { }
        ...
        public abstract class manufacturingAdvancedPlanning : IBqlField { }
