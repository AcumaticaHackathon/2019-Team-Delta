...
namespace PX.Objects.CS
{
	...
	public class BranchMaint : OrganizationUnitMaintBase<BranchMaint.BranchBAccount, Where<True, Equal<True>>>
	{
		...
		public partial class BranchBAccount : BAccount
		{
			...
			public abstract class branchLogoNameReport : IBqlField { }
			...
			public abstract class organizationLogoNameReport : IBqlField { }
...
#region DefaultPrinter
			...
			[PXPrinterSelector(DisplayName = "Default Printer", Visibility = PXUIVisibility.SelectorVisible, BqlField = typeof(Branch.defaultPrinter))]
		...
		public override void Persist()
		{
			...
			if (requestRelogin && needRefresh)
			{
				...
				if (System.Web.HttpContext.Current != null)
					PXSessionStateStore.StoreCurrentUser(System.Web.HttpContext.Current);
	...
	public partial class CompanyBAccount1099 : IBqlTable
{
	...
	public abstract class logoNameReport : PX.Data.IBqlField { }

	[PXDBString(IsUnicode = true, BqlField = typeof(Organization.logoNameReport))]
	[PXDefault()]
	[PXUIField(DisplayName = "Logo")]
	public virtual String LogoNameReport
	{
		get;
		set;
	}
